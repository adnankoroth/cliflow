// eza completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "field",
        suggestions: [{ name: "all" }, { name: "age" }, { name: "size" }]
      }
    },
    {
      ...
      args: {
        name: "mode",
        suggestions: [{ name: "fixed" }, { name: "gradient" }],
        default: "gradient"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "mode",
        suggestions: [{ name: "off" }, { name: "on" }, { name: "follow" }],
        default: "off"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "field",
        suggestions: [{ name: "modified" }, { name: "changed" }, { name: "accessed" }, { name: "created" }]
      },
      dependsOn: ["-l", "--long"]
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "format",
        suggestions: [{ name: "default" }, { name: "iso" }, { name: "long-iso" }, { name: "relative" }, { name: "+%Y-%m-%d %H:%M" }]
      },
      dependsOn: ["-l", "--long"]
    },
    {
