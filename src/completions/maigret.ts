// maigret completion spec for CLIFlow
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "username" }, { name: "yandex_public_id" }, { name: "gaia_id" }, { name: "vk_id" }, { name: "ok_id" }, { name: "wikimapia_uid" }, { name: "steam_id" }, { name: "uidme_uguid" }, { name: "yelp_userid" }],
        default: "username"
      },
    ...
    },
    {
      ...
      args: {
        name: "Type",
        suggestions: [{ name: "simple" }, { name: "ndjson" }]
      },
      description:
    ...
    },
    {
      ...
      args: {
        name: "Type",
        suggestions: [{ name: "default" }, { name: "data" }]
      },
      description:
