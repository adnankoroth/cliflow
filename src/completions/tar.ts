// tar completion spec for CLIFlow
...
const dumpOptions= [
  ...
  },
  {
    ...
    args: {
      name: "ORDER",
      default: "none",
      suggestions: [{ name: "none" }, { name: "name" }, { name: "inode" }]
    }
  },
  {
    name: "--add-file",
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        ...
        default: "seek",
        isOptional: true,
        suggestions: [{ name: "seek" }, { name: "raw" }]
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "MAJOR[.MINOR]",
        suggestions: [{ name: "0" }, { name: "0.1" }, { name: "1" }]
      }
    },
    {
      name: ["S", "-S", "--sparse"],
    ...
    },
    {
      ...
      args: {
        name: "STYLE",
        suggestions: [{ name: "literal" }, { name: "shell" }, { name: "shell-always" }, { name: "c" }, { name: "c-maybe" }, { name: "escape" }, { name: "locale" }, { name: "clocale" }]
      }
    },
    {
