// tuist completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "format",
            suggestions: [{ name: "dot" }, { name: "png" }, { name: "json" }],
            default: "png"
          }
        },
        {
          ...
          args: {
            name: "format",
            suggestions: [{ name: "dot" }, { name: "neato" }, { name: "twopi" }, { name: "circo" }, { name: "fdp" }, { name: "sfddp" }, { name: "patchwork" }],
            default: "dot"
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "platform",
            suggestions: [{ name: "ios" }, { name: "macos" }, { name: "tvos" }, { name: "watchos" }]
          }
        }
      ]
    },
