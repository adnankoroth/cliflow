// babel completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: { name: "env", suggestions: [{ name: "production" }, { name: "development" }] }
    },
    {
      name: "--root-mode",
    ...
    {
      name: "--source-type",
      args: { name: "type", suggestions: [{ name: "script" }, { name: "module" }] }
    },
    {
      name: "--no-babelrc",
    ...
    },
    {
      ...
      args: { name: "mode", suggestions: [{ name: "true" }, { name: "false" }, { name: "auto" }] }
    },
    {
      name: "--minified",
    ...
    {
      name: ["-s", "--source-maps"],
      args: { name: "mode", suggestions: [{ name: "true" }, { name: "false" }, { name: "inline" }, { name: "both" }] }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "extension",
        suggestions: [{ name: ".es6" }, { name: ".js" }, { name: ".es" }, { name: ".jsx" }, { name: ".mjs" }]
      }
    },
