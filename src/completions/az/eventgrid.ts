// az eventgrid completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "identity",
                suggestions: [{ name: "noidentity" }, { name: "systemassigned" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "input-schema",
                suggestions: [{ name: "cloudeventschemav1_0" }, { name: "customeventschema" }, { name: "eventgridschema" }]
              }
            },
            {
              name: ["--location", "-l"],
            ...
            },
            {
              ...
              args: { name: "sku", suggestions: [{ name: "basic" }, { name: "premium" }] }
            },
            {
              name: "--tags",
              description:
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "endpoint-type",
                    suggestions: [{ name: "azurefunction" }, { name: "eventhub" }, { name: "hybridconnection" }, { name: "servicebusqueue" }, { name: "servicebustopic" }, { name: "storagequeue" }, { name: "webhook" }]
                  }
                },
                {
                  ...
                  args: {
                    name: "event-delivery-schema",
                    suggestions: [{ name: "cloudeventschemav1_0" }, { name: "custominputschema" }, { name: "eventgridschema" }]
                  }
                },
                {
                  name: "--event-ttl",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "deadletter-identity",
                suggestions: [{ name: "systemassigned" }]
              }
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "ChannelNameHeader" }, { name: "SourceEventAttribute" }]
                  }
                },
                {
                  name: "--tags",
                  ...
                  options: [
                    {
                      ...
                      args: {
                        name: "channel-type",
                        suggestions: [{ name: "PartnerDestination" }, { name: "PartnerTopic" }]
                      },
                      isRequired: true
                    },
                    {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "extended-location-type",
                suggestions: [{ name: "customlocation" }]
              }
            },
            {
              name: "--identity",
            ...
            },
            {
              ...
              args: { name: "kind", suggestions: [{ name: "azure" }, { name: "azurearc" }] }
            },
            {
              name: ["--location", "-l"],
              description:
