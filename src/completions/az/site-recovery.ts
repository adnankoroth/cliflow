// az site-recovery completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "job-output-type",
                suggestions: [{ name: "Excel" }, { name: "Json" }, { name: "Xml" }]
              }
            },
            {
              name: "--job-status",
          ...
          options: [
            {
              ...
              args: {
                ...
                suggestions: [{ name: "MigrationComplete" }, { name: "NotSpecified" }]
              }
            },
            {
              name: "--fabric-name",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "Classic" }, { name: "NotApplicable" }, { name: "ResourceManager" }]
              }
            },
            {
              name: "--no-wait",
