// az keyvault completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "encoding", suggestions: [{ name: "DER" }, { name: "PEM" }] }
            },
            {
              name: "--id",
              description:
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "include-pending", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--maxresults",
              description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "resource-type", suggestions: [{ name: "hsm" }] }
        }
      ]
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "bypass", suggestions: [{ name: "AzureServices" }, { name: "None" }] }
        },
        {
          name: "--default-action",
          description: "Default action to apply when no rule matches",
          args: { name: "default-action", suggestions: [{ name: "Allow" }, { name: "Deny" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "no-self-perms", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--no-wait",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "certificate-permissions",
            suggestions: [{ name: "all" }, { name: "backup" }, { name: "create" }, { name: "delete" }, { name: "deleteissuers" }, { name: "get" }, { name: "getissuers" }, { name: "import" }, { name: "list" }, { name: "listissuers" }, { name: "managecontacts" }, { name: "manageissuers" }, { name: "purge" }, { name: "recover" }, { name: "restore" }, { name: "setissuers" }, { name: "update" }]
          }
        },
        {
          ...
          args: {
            name: "key-permissions",
            suggestions: [{ name: "all" }, { name: "backup" }, { name: "create" }, { name: "decrypt" }, { name: "delete" }, { name: "encrypt" }, { name: "get" }, { name: "getrotationpolicy" }, { name: "import" }, { name: "list" }, { name: "purge" }, { name: "recover" }, { name: "release" }, { name: "restore" }, { name: "rotate" }, { name: "setrotationpolicy" }, { name: "sign" }, { name: "unwrapKey" }, { name: "update" }, { name: "verify" }, { name: "wrapKey" }]
          }
        },
        {
          name: "--no-wait",
        ...
        },
        {
          ...
          args: {
            name: "secret-permissions",
            suggestions: [{ name: "all" }, { name: "backup" }, { name: "delete" }, { name: "get" }, { name: "list" }, { name: "purge" }, { name: "recover" }, { name: "restore" }, { name: "set" }]
          }
        },
        {
          name: "--spn",
        ...
        },
        {
          ...
          args: {
            name: "storage-permissions",
            suggestions: [{ name: "all" }, { name: "backup" }, { name: "delete" }, { name: "deletesas" }, { name: "get" }, { name: "getsas" }, { name: "list" }, { name: "listsas" }, { name: "purge" }, { name: "recover" }, { name: "regeneratekey" }, { name: "restore" }, { name: "set" }, { name: "setsas" }, { name: "update" }]
          }
        },
        {
          name: "--upn",
          ...
          options: [
            {
              ...
              args: {
                name: "curve",
                suggestions: [{ name: "Ed25519" }, { name: "P-256" }, { name: "P-256K" }, { name: "P-384" }, { name: "P-521" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "exportable", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--hsm-name",
              description:
            ...
            },
            {
              ...
              args: { name: "immutable", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--kty",
              description:
              ...
              args: {
                name: "kty",
                suggestions: [{ name: "EC" }, { name: "EC-HSM" }, { name: "OKP" }, { name: "OKP-HSM" }, { name: "RSA" }, { name: "RSA-HSM" }, { name: "oct" }, { name: "oct-HSM" }]
              }
            },
            {
              name: ["--name", "-n"],
            ...
            },
            {
              ...
              args: {
                name: "ops",
                suggestions: [{ name: "decrypt" }, { name: "encrypt" }, { name: "export" }, { name: "import" }, { name: "sign" }, { name: "unwrapKey" }, { name: "verify" }, { name: "wrapKey" }]
              }
            },
            {
              name: "--policy",
            ...
            },
            {
              ...
              args: { name: "protection", suggestions: [{ name: "hsm" }, { name: "software" }] }
            },
            {
              name: "--size",
              description:
          ...
          options: [
            {
              ...
              args: {
                name: "algorithm",
                suggestions: [{ name: "A128CBC" }, { name: "A128CBCPAD" }, { name: "A128GCM" }, { name: "A192CBC" }, { name: "A192CBCPAD" }, { name: "A192GCM" }, { name: "A256CBC" }, { name: "A256CBCPAD" }, { name: "A256GCM" }, { name: "RSA-OAEP" }, { name: "RSA-OAEP-256" }, { name: "RSA1_5" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: { name: "data-type", suggestions: [{ name: "base64" }, { name: "plaintext" }] }
            },
            {
              name: "--hsm-name",
              description:
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "kty", suggestions: [{ name: "EC" }, { name: "RSA" }, { name: "oct" }] }
            },
            {
              name: ["--name", "-n"],
              description: "Name of the key. Required if --id is not specified",
          ...
          options: [
            {
              ...
              args: {
                name: "algorithm",
                suggestions: [{ name: "ES256" }, { name: "ES256K" }, { name: "ES384" }, { name: "ES512" }, { name: "EdDSA" }, { name: "PS256" }, { name: "PS384" }, { name: "PS512" }, { name: "RS256" }, { name: "RS384" }, { name: "RS512" }]
              },
              isRequired: true
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "Application" }, { name: "DirectoryObjectOrGroup" }, { name: "DirectoryRoleTemplate" }, { name: "Everyone" }, { name: "ForeignGroup" }, { name: "Group" }, { name: "MSI" }, { name: "ServicePrincipal" }, { name: "Unknown" }, { name: "User" }]
                  }
                },
                {
                  name: "--hsm-name",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "encoding",
                suggestions: [{ name: "ascii" }, { name: "base64" }, { name: "hex" }, { name: "utf-16be" }, { name: "utf-16le" }, { name: "utf-8" }]
              }
            },
            {
              name: "--id",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "target-operation",
                suggestions: [{ name: "download" }, { name: "restore_blob" }, { name: "upload" }]
              }
            }
          ]
        }
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "setting-type",
                suggestions: [{ name: "boolean" }, { name: "string" }]
              }
            }
          ]
        }
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "sas-type",
                    suggestions: [{ name: "account" }, { name: "service" }]
                  },
                  isRequired: true
                },
                {
