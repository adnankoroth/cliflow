// az disk-encryption-set completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "encryption-type",
            suggestions: [{ name: "ConfidentialVmEncryptedWithCustomerKey" }, { name: "EncryptionAtRestWithCustomerKey" }, { name: "EncryptionAtRestWithPlatformAndCustomerKeys" }, { name: "EncryptionAtRestWithPlatformKey" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "mi-system-assigned", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
