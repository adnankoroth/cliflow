// az pipelines completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "detect", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "reason",
                suggestions: [{ name: "all" }, { name: "batchedCI" }, { name: "buildCompletion" }, { name: "checkInShelveset" }, { name: "individualCI" }, { name: "manual" }, { name: "pullRequest" }, { name: "schedule" }, { name: "triggered" }, { name: "userCreated" }, { name: "validateShelveset" }]
              }
            },
            {
              name: "--requested-for",
            ...
            },
            {
              ...
              args: {
                name: "result",
                suggestions: [{ name: "canceled" }, { name: "failed" }, { name: "none" }, { name: "partiallySucceeded" }, { name: "succeeded" }]
              }
            },
            {
              name: "--status",
              ...
              args: {
                name: "status",
                suggestions: [{ name: "all" }, { name: "cancelling" }, { name: "completed" }, { name: "inProgress" }, { name: "none" }, { name: "notStarted" }, { name: "postponed" }]
              }
            },
            {
              name: "--tags",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "repository-type",
                    suggestions: [{ name: "bitbucket" }, { name: "git" }, { name: "github" }, { name: "githubenterprise" }, { name: "svn" }, { name: "tfsgit" }, { name: "tfsversioncontrol" }]
                  }
                },
                {
                  name: "--top",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "repository-type", suggestions: [{ name: "github" }, { name: "tfsgit" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "skip-first-run", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "query-order",
            suggestions: [{ name: "ModifiedAsc" }, { name: "ModifiedDesc" }, { name: "NameAsc" }, { name: "NameDesc" }, { name: "None" }]
          }
        },
        {
          name: "--repository",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "query-order",
                suggestions: [{ name: "Asc" }, { name: "Desc" }, { name: "None" }]
              }
            }
          ]
        },
          ...
          options: [
            {
              ...
              args: { name: "action", suggestions: [{ name: "manage" }, { name: "none" }, { name: "use" }] }
            },
            {
              name: "--detect",
              description: "Automatically detect organization",
            ...
            },
            {
              ...
              args: {
                name: "pool-type",
                suggestions: [{ name: "automation" }, { name: "deployment" }]
              }
            }
          ]
        },
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "artifact-type",
                    suggestions: [{ name: "build" }, { name: "externaltfsbuild" }, { name: "git" }, { name: "github" }, { name: "jenkins" }, { name: "tfvc" }]
                  }
                },
                {
                  name: "--detect",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "query-order",
                suggestions: [{ name: "FinishTimeAsc" }, { name: "FinishTimeDesc" }, { name: "QueueTimeAsc" }, { name: "QueueTimeDesc" }, { name: "StartTimeAsc" }, { name: "StartTimeDesc" }]
              }
            },
            {
              name: "--reason",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "allow-override", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--detect",
              description: "Automatically detect organization",
            ...
            },
            {
              ...
              args: { name: "secret", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--value",
              description:
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "prompt-value", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--secret",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "authorize", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--description",
          ...
          options: [
            {
              ...
              args: {
                name: "action-filter",
                suggestions: [{ name: "manage" }, { name: "none" }, { name: "use" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "query-order", suggestions: [{ name: "Asc" }, { name: "Desc" }] }
            },
            {
              name: "--top",
