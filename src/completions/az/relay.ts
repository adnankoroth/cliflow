// az relay completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Active" }, { name: "Disabled" }, { name: "ReceiveDisabled" }, { name: "SendDisabled" }]
              }
            },
            {
              name: "--subscription",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "relay-type", suggestions: [{ name: "Http" }, { name: "NetTcp" }] }
            },
            {
              name: ["--requires-client-authorization", "-c"],
              description: "Indicates whether client authorization is required",
