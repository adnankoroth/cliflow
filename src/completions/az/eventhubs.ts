// az eventhubs completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "sku", suggestions: [{ name: "Dedicated" }] }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "cleanup-policy",
                suggestions: [{ name: "Compact" }, { name: "Delete" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "enable-capture", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Active" }, { name: "Disabled" }, { name: "SendDisabled" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "encoding", suggestions: [{ name: "Avro" }, { name: "AvroDeflate" }] }
            },
            {
              name: ["--event-hub-name", "--name", "-n"],
              description: "The Event Hub name",
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Active" }, { name: "Creating" }, { name: "Deleting" }, { name: "Disabled" }, { name: "ReceiveDisabled" }, { name: "Renaming" }, { name: "Restoring" }, { name: "SendDisabled" }, { name: "Unknown" }]
              }
            },
            {
              name: "--storage-account",
                  ...
                  options: [
                    {
                      ...
                      args: {
                        name: "key",
                        suggestions: [{ name: "PrimaryKey" }, { name: "SecondaryKey" }]
                      },
                      isRequired: true
                    },
                    {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "enable-kafka", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "Basic" }, { name: "Premium" }, { name: "Standard" }]
              }
            },
            {
              name: "--tags",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "public-network-access",
                suggestions: [{ name: "Disabled" }, { name: "Enabled" }, { name: "SecuredByPerimeter" }]
              }
            },
            {
              name: "--remove",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "is-enabled", suggestions: [{ name: "false" }, { name: "true" }] }
                },
                {
                  name: [
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "default-action",
                    suggestions: [{ name: "Allow" }, { name: "Deny" }]
                  }
                },
                {
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "provisioning-state",
                    suggestions: [{ name: "Canceled" }, { name: "Creating" }, { name: "Deleting" }, { name: "Failed" }, { name: "Succeeded" }, { name: "Updating" }]
                  }
                },
                {
                  name: "--status",
                  ...
                  args: {
                    name: "status",
                    suggestions: [{ name: "Approved" }, { name: "Disconnected" }, { name: "Pending" }, { name: "Rejected" }]
                  }
                }
              ]
            },
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "schema-compatibility",
                    suggestions: [{ name: "Backward" }, { name: "Forward" }, { name: "None" }]
                  }
                },
                {
                  name: "--schema-type",
                  ...
                  args: {
                    name: "schema-type",
                    suggestions: [{ name: "Avro" }, { name: "Unknown" }]
                  }
                }
              ]
            },
