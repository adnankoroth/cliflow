// az bot completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "sku", suggestions: [{ name: "F0" }, { name: "S1" }] }
        },
        {
          name: "--tags",
          description:
      ...
      options: [
        {
          ...
          args: {
            name: "lang",
            suggestions: [{ name: "Csharp" }, { name: "Javascript" }, { name: "Typescript" }]
          },
          isRequired: true
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "version", suggestions: [{ name: "v3" }, { name: "v4" }] }
        }
      ]
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "keep-node-modules", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--proj-file-path",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "msbot", suggestions: [{ name: "false" }, { name: "true" }] }
        }
      ]
    },
    {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "add-disabled", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--disablev1",
              description:
                "If true, v1 protocol will be disabled on the channel",
              args: { name: "disablev1", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--disablev3",
              description:
                "If true, v3 protocol will be disabled on the channel",
              args: { name: "disablev3", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "with-secrets", suggestions: [{ name: "false" }, { name: "true" }] }
            }
          ]
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "is-validated", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--location", "-l"],
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "enable-calling", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--location", "-l"],
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "enable-groups", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
            ...
            },
            {
              ...
              args: { name: "enable-video", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--groups-mode",
