// az batch completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "encryption-key-source",
                suggestions: [{ name: "Microsoft.Batch" }, { name: "Microsoft.KeyVault" }]
              }
            },
            {
              name: "--keyvault",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "profile",
                    suggestions: [{ name: "BatchAccount" }, { name: "NodeManagement" }]
                  }
                }
              ]
            },
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "on-all-tasks-complete",
                suggestions: [{ name: "noaction" }, { name: "terminatejob" }]
              }
            },
            {
              name: "--pool-id",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "node-deallocation-option",
                suggestions: [{ name: "requeue" }, { name: "retaineddata" }, { name: "taskcompletion" }, { name: "terminate" }]
              }
            },
            {
              name: "--node-list",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "node-disable-scheduling-option",
                    suggestions: [{ name: "requeue" }, { name: "taskcompletion" }, { name: "terminate" }]
                  }
                }
              ]
            },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "os-family",
                suggestions: [{ name: "2" }, { name: "3" }, { name: "4" }, { name: "5" }, { name: "6" }]
              }
            },
            {
              name: "--os-version",
            ...
            },
            {
              ...
              args: { name: "policy", suggestions: [{ name: "regional" }, { name: "zonal" }] }
            },
            {
              name: "--resize-timeout",
              description:
            ...
            },
            {
              ...
              args: {
                name: "target-communication",
                suggestions: [{ name: "classic" }, { name: "default" }, { name: "simplified" }]
              }
            },
            {
