// az ad completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "key-type",
                suggestions: [{ name: "AsymmetricX509Cert" }, { name: "Password" }, { name: "Symmetric" }]
              }
            },
            {
              name: "--key-usage",
              ...
              args: { name: "key-usage", suggestions: [{ name: "Sign" }, { name: "Verify" }] }
            },
            {
              name: "--key-value",
              description:
            ...
            },
            {
              ...
              args: {
                name: "sign-in-audience",
                suggestions: [{ name: "AzureADMultipleOrgs" }, { name: "AzureADMyOrg" }, { name: "AzureADandPersonalMicrosoftAccount" }, { name: "PersonalMicrosoftAccount" }]
              }
            },
            {
              name: "--start-date",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "consent-type",
                    suggestions: [{ name: "AllPrincipals" }, { name: "Principal" }]
                  }
                },
                {
                  name: "--principal-id",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "domain-config-type",
                suggestions: [{ name: "FullySynced" }, { name: "ResourceTrusting" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "ldaps", suggestions: [{ name: "Disabled" }, { name: "Enabled" }] }
            },
            {
              name: "--no-wait",
              description:
            ...
            },
            {
              ...
              args: { name: "ntlm-v1", suggestions: [{ name: "Disabled" }, { name: "Enabled" }] }
            },
            {
              name: "--pfx-cert",
              description:
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "Enterprise" }, { name: "Premium" }, { name: "Standard" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "tls-v1", suggestions: [{ name: "Disabled" }, { name: "Enabled" }] }
            }
          ]
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "force", suggestions: [{ name: "false" }, { name: "true" }] }
            }
          ]
        },
        {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "json-auth", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--keyvault",
              description:
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "account-enabled", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--display-name",
              description: "Object's display name or its prefix",
