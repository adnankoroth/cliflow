// az attestation completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "attestation-type",
                suggestions: [{ name: "SGX-IntelSDK" }, { name: "SGX-OpenEnclaveSDK" }, { name: "TPM" }]
              },
              isRequired: true
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "policy-format", suggestions: [{ name: "JWT" }, { name: "Text" }] }
            },
            {
              name: ["--resource-group", "-g"],
              description:
