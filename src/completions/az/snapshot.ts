// az snapshot completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "copy-start", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--disk-access",
          description:
        ...
        },
        {
          ...
          args: { name: "for-upload", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "incremental", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: ["--location", "-l"],
          description:
        ...
        },
        {
          ...
          args: {
            name: "sku",
            suggestions: [{ name: "Premium_LRS" }, { name: "Standard_LRS" }, { name: "Standard_ZRS" }]
          }
        },
        {
          name: "--source",
