// az resource-mover completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "input-type",
                suggestions: [{ name: "MoveResourceId" }, { name: "MoveResourceSourceId" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "move-type",
                suggestions: [{ name: "RegionToRegion" }, { name: "RegionToZone" }]
              }
            },
            {
              name: "--source-region",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "dependency-level",
                suggestions: [{ name: "Descendant" }, { name: "Direct" }]
              }
            },
            {
              name: "--filter",
