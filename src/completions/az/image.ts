// az image completion spec for CLIFlow
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "type",
                    suggestions: [{ name: "file" }, { name: "powershell" }, { name: "shell" }, { name: "windows-restart" }, { name: "windows-update" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "versioning",
                    suggestions: [{ name: "Latest" }, { name: "Source" }]
                  }
                },
                {
                  name: "--vhd-uri",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "kind", suggestions: [{ name: "SourceImage" }] }
                },
                {
                  name: "--no-wait",
                  description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "source-type", suggestions: [{ name: "image" }, { name: "vm" }] }
        },
        {
          name: "--tags",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "zone-resilient", suggestions: [{ name: "false" }, { name: "true" }] }
        }
      ]
    },
    {
