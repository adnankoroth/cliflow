// az cloud completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "profile",
            suggestions: [{ name: "2017-03-09-profile" }, { name: "2018-03-01-hybrid" }, { name: "2019-03-01-hybrid" }, { name: "2020-09-01-hybrid" }, { name: "latest" }]
          }
        },
        {
