// az billing completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "marketplace-purchases",
                suggestions: [{ name: "AllAllowed" }, { name: "NotAllowed" }, { name: "OnlyFreeAllowed" }]
              }
            },
            {
              name: "--profile-name",
            ...
            },
            {
              ...
              args: {
                name: "reservation-purchases",
                suggestions: [{ name: "Allowed" }, { name: "NotAllowed" }]
              }
            },
            {
              name: "--view-charges",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "auto-renew", suggestions: [{ name: "Off" }, { name: "On" }] }
            },
            {
              ...
              args: {
                name: "billing-frequency",
                suggestions: [{ name: "Monthly" }, { name: "OneTime" }, { name: "UsageBased" }]
              }
            },
            {
              name: "--status",
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Active" }, { name: "AutoRenew" }, { name: "Cancelled" }, { name: "Disabled" }, { name: "Expired" }, { name: "Expiring" }, { name: "Inactive" }, { name: "PastDue" }]
              }
            }
          ]
        },
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "subscription-billing-status",
                suggestions: [{ name: "Abandoned" }, { name: "Active" }, { name: "Deleted" }, { name: "Inactive" }, { name: "Warning" }]
              }
            }
          ]
        },
