// az apim completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "api-type",
                suggestions: [{ name: "graphql" }, { name: "http" }, { name: "soap" }, { name: "websocket" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "protocols",
                suggestions: [{ name: "http" }, { name: "https" }, { name: "ws" }, { name: "wss" }]
              }
            },
            {
              name: "--service-url",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "specification-format",
                suggestions: [{ name: "GraphQL" }, { name: "OpenApi" }, { name: "OpenApiJson" }, { name: "Swagger" }, { name: "Wadl" }, { name: "Wsdl" }]
              },
              isRequired: true
            },
            {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "disable-gateway", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "sku-name",
            suggestions: [{ name: "Basic" }, { name: "Consumption" }, { name: "Developer" }, { name: "Isolated" }, { name: "Premium" }, { name: "Standard" }]
          }
        },
        {
          name: "--tags",
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "External" }, { name: "Internal" }, { name: "None" }]
          }
        }
      ]
    },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "state",
                suggestions: [{ name: "notPublished" }, { name: "published" }]
              }
            },
            {
