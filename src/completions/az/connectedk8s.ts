// az connectedk8s completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "azure-hybrid-benefit",
            suggestions: [{ name: "False" }, { name: "NotApplicable" }, { name: "True" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "distribution",
            suggestions: [{ name: "aks" }, { name: "aks_edge_k3s" }, { name: "aks_edge_k8s" }, { name: "aks_engine" }, { name: "aks_management" }, { name: "aks_workload" }, { name: "canonical" }, { name: "capz" }, { name: "eks" }, { name: "generic" }, { name: "gke" }, { name: "k3s" }, { name: "karbon" }, { name: "kind" }, { name: "minikube" }, { name: "openshift" }, { name: "rancher_rke" }, { name: "tkg" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "enable-private-link", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--infrastructure",
          description:
          ...
          args: {
            name: "infrastructure",
            suggestions: [{ name: "LTSCWindows 10 Enterprise LTSC" }, { name: "Windows 10 Enterprise" }, { name: "Windows 10 Enterprise LTSC 2019" }, { name: "Windows 10 Enterprise LTSC 2021" }, { name: "Windows 10 Enterprise N" }, { name: "Windows 10 Enterprise N LTSC 2019" }, { name: "Windows 10 Enterprise N LTSC 2021" }, { name: "Windows 10 IoT Enterprise" }, { name: "Windows 10 IoT Enterprise LTSC 2019" }, { name: "Windows 10 IoT Enterprise LTSC 2021" }, { name: "Windows 10 Pro" }, { name: "Windows 11 Enterprise" }, { name: "Windows 11 Enterprise N" }, { name: "Windows 11 IoT Enterprise" }, { name: "Windows 11 Pro" }, { name: "Windows Server 2019" }, { name: "Windows Server 2019 Datacenter" }, { name: "Windows Server 2019 Standard" }, { name: "Windows Server 2022" }, { name: "Windows Server 2022 Datacenter" }, { name: "Windows Server 2022 Standard" }, { name: "aws" }, { name: "azure" }, { name: "azure_stack_edge" }, { name: "azure_stack_hci" }, { name: "azure_stack_hub" }, { name: "gcp" }, { name: "generic" }, { name: "vsphere" }, { name: "windows_server" }]
          }
        },
        {
          name: "--kube-config",
      ...
      options: [
        {
          ...
          args: {
            name: "features",
            suggestions: [{ name: "azure-rbac" }, { name: "cluster-connect" }, { name: "custom-locations" }]
          },
          isRequired: true
        },
        {
      ...
      options: [
        {
          ...
          args: { name: "auto-upgrade", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--azure-hybrid-benefit",
          description: "Flag to enable/disable Azure Hybrid Benefit feature",
