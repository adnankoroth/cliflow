// az stream-analytics completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "content-storage-policy",
                suggestions: [{ name: "JobStorageAccount" }, { name: "SystemAccount" }]
              }
            },
            {
              name: "--data-locale",
            ...
            },
            {
              ...
              args: { name: "job-type", suggestions: [{ name: "Cloud" }, { name: "Edge" }] }
            },
            {
              name: ["--location", "-l"],
              description:
            ...
            },
            {
              ...
              args: {
                name: "out-of-order-policy",
                suggestions: [{ name: "Adjust" }, { name: "Drop" }]
              }
            },
            {
              ...
              args: {
                name: "output-error-policy",
                suggestions: [{ name: "Drop" }, { name: "Stop" }]
              }
            },
            {
              ...
              args: {
                name: "output-start-mode",
                suggestions: [{ name: "CustomTime" }, { name: "JobStartTime" }, { name: "LastOutputEventTime" }]
              }
            },
            {
