// az security completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "name",
                suggestions: [{ name: "MCAS" }, { name: "Sentinel" }, { name: "WDATP" }, { name: "WDATP_EXCLUDE_LINUX_PUBLIC_PREVIEW" }, { name: "WDATP_UNIFIED_SOLUTION" }]
              },
              isRequired: true
            }
          ]
