// az palo-alto completion spec for CLIFlow
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "log-option",
                    suggestions: [{ name: "INDIVIDUAL_DESTINATION" }, { name: "SAME_DESTINATION" }]
                  }
                },
                {
                  name: "--log-type",
                  ...
                  args: {
                    name: "log-type",
                    suggestions: [{ name: "AUDIT" }, { name: "DECRYPTION" }, { name: "DLP" }, { name: "THREAT" }, { name: "TRAFFIC" }, { name: "WILDFIRE" }]
                  }
                },
                {
                  name: ["--resource-group", "-g"],
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "default-mode",
                    suggestions: [{ name: "FIREWALL" }, { name: "IPS" }, { name: "NONE" }]
                  }
                },
                {
                  name: "--description",
              ...
              options: [
                {
                  ...
                  args: { name: "type", suggestions: [{ name: "feeds" }, { name: "urlCustom" }] },
                  isRequired: true
                },
                {
                  name: "--ids",
              ...
              options: [
                {
                  ...
                  args: {
                    name: "type",
                    suggestions: [{ name: "antiSpyware" }, { name: "antiVirus" }, { name: "dnsSubscription" }, { name: "fileBlocking" }, { name: "ipsVulnerability" }, { name: "urlFiltering" }]
                  },
                  isRequired: true
                },
                {
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "action-type",
                        suggestions: [{ name: "Allow" }, { name: "DenyResetBoth" }, { name: "DenyResetServer" }, { name: "DenySilent" }]
                      }
                    },
                    {
                      name: "--applications",
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "decryption-rule-type",
                        suggestions: [{ name: "None" }, { name: "SSLInboundInspection" }, { name: "SSLOutboundInspection" }]
                      }
                    },
                    {
                      name: "--description",
                    ...
                    },
                    {
                      name: "--protocol",
                      description:
                        "Any, application-default, TCP, UDP:number",
                      args: { name: "protocol" }
                    },
                    {
