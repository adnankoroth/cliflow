// az cloud-service completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "start-cloud-service", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--tags",
          description:
        ...
        },
        {
          ...
          args: {
            name: "upgrade-mode",
            suggestions: [{ name: "Auto" }, { name: "Manual" }, { name: "Simultaneous" }]
          }
        }
      ]
    },
