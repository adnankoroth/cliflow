// az vmss completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "automatic-repairs-action",
            suggestions: [{ name: "Reimage" }, { name: "Replace" }, { name: "Restart" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "enable-spot-restore", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--enable-vtpm",
        ...
        },
        {
          ...
          args: {
            name: "lb-sku",
            suggestions: [{ name: "Basic" }, { name: "Gateway" }, { name: "Standard" }]
          }
        },
        {
          name: "--license-type",
        ...
        },
        {
          ...
          args: { name: "max-surge", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "orchestration-mode",
            suggestions: [{ name: "Flexible" }, { name: "Uniform" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "scale-in-policy",
            suggestions: [{ name: "Default" }, { name: "NewestVM" }, { name: "OldestVM" }]
          }
        },
        {
          name: "--scope",
        ...
        },
        {
          ...
          args: {
            name: "upgrade-policy-mode",
            suggestions: [{ name: "Automatic" }, { name: "Manual" }, { name: "Rolling" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "zones", suggestions: [{ name: "1" }, { name: "2" }, { name: "3" }] }
        }
      ]
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "hibernate", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--instance-ids",
          description:
      ...
      options: [
        {
          ...
          args: { name: "action", suggestions: [{ name: "Resume" }, { name: "Suspend" }] },
          isRequired: true
        },
        {
          name: "--service-name",
          ...
          args: {
            name: "service-name",
            suggestions: [{ name: "AutomaticRepairs" }, { name: "DummyOrchestrationServiceName" }]
          },
          isRequired: true
        },
        {
