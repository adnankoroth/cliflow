// az advisor completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "10" }, { name: "15" }, { name: "20" }, { name: "5" }]
              }
            },
            {
              name: "--remove",
          ...
          options: [
            {
              ...
              args: {
                name: "category",
                suggestions: [{ name: "Cost" }, { name: "HighAvailability" }, { name: "Performance" }, { name: "Security" }]
              }
            },
            {
              name: "--ids",
