// az signalr completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "service-mode",
            suggestions: [{ name: "Classic" }, { name: "Default" }, { name: "Serverless" }]
          }
        },
        {
          name: "--tags",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description:
            "The switch for messaging logs which signalr service will generate or not",
          args: { name: "enable-message-logs", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--force-string",
          description:
