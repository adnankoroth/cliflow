// az footprint completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "operator",
                suggestions: [{ name: "ContainsValue" }, { name: "ContainsValueIgnoreCasing" }, { name: "DoesNotContainValue" }, { name: "DoesNotContainValueIgnoreCasing" }, { name: "IsExactValue" }, { name: "MatchValueIgnoreCasing" }]
              },
              isRequired: true
            },
            {
