// az consumption completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "category", suggestions: [{ name: "cost" }, { name: "usage" }] },
              isRequired: true
            },
            {
              name: ["--end-date", "-e"],
            ...
            },
            {
              ...
              args: {
                name: "time-grain",
                suggestions: [{ name: "annually" }, { name: "monthly" }, { name: "quarterly" }]
              },
              isRequired: true
            },
            {
              ...
              options: [
                {
                  ...
                  args: { name: "grain", suggestions: [{ name: "daily" }, { name: "monthly" }] },
                  isRequired: true
                },
                {
                  name: "--reservation-order-id",
