// az appconfig completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "disable-local-auth", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          ...
          options: [
            {
              ...
              args: { name: "auth-mode", suggestions: [{ name: "key" }, { name: "login" }] }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "fields",
                suggestions: [{ name: "conditions" }, { name: "description" }, { name: "key" }, { name: "label" }, { name: "last_modified" }, { name: "locked" }, { name: "name" }, { name: "state" }]
              }
            },
            {
              name: "--key",
          ...
          options: [
            {
              ...
              args: {
                name: "destination",
                suggestions: [{ name: "appconfig" }, { name: "appservice" }, { name: "file" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: { name: "dest-auth-mode", suggestions: [{ name: "key" }, { name: "login" }] }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "format",
                suggestions: [{ name: "json" }, { name: "properties" }, { name: "yaml" }]
              }
            },
            {
              name: "--key",
            ...
            },
            {
              ...
              args: {
                name: "naming-convention",
                suggestions: [{ name: "camel" }, { name: "hyphen" }, { name: "pascal" }, { name: "underscore" }]
              }
            },
            {
              name: "--path",
            ...
            },
            {
              ...
              args: {
                name: "profile",
                suggestions: [{ name: "appconfig/default" }, { name: "appconfig/kvset" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "import-mode",
                suggestions: [{ name: "all" }, { name: "ignore-match" }]
              }
            },
            {
              name: "--label",
            ...
            },
            {
              ...
              args: { name: "src-auth-mode", suggestions: [{ name: "key" }, { name: "login" }] }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "fields",
                suggestions: [{ name: "content_type" }, { name: "etag" }, { name: "key" }, { name: "label" }, { name: "last_modified" }, { name: "locked" }, { name: "tags" }, { name: "value" }]
              }
            },
            {
              name: "--key",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "composition-type",
                suggestions: [{ name: "key" }, { name: "key_label" }]
              }
            },
            {
              name: "--connection-string",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "fields",
                suggestions: [{ name: "composition_type" }, { name: "created" }, { name: "etag" }, { name: "expires" }, { name: "filters" }, { name: "items_count" }, { name: "name" }, { name: "retention_period" }, { name: "size" }, { name: "status" }, { name: "tags" }]
              }
            },
            {
              name: ["--name", "-n"],
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "archived" }, { name: "failed" }, { name: "provisioning" }, { name: "ready" }]
              }
            },
            {
              name: ["--top", "-t"],
