// az deployment completion spec for CLIFlow
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "Create" }, { name: "Delete" }, { name: "Deploy" }, { name: "Ignore" }, { name: "Modify" }, { name: "NoChange" }, { name: "Unsupported" }]
          }
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "FullResourcePayloads" }, { name: "ResourceIdOnly" }]
          }
        }
      ]
    },
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "mode", suggestions: [{ name: "Complete" }, { name: "Incremental" }] }
            },
            {
              name: ["--name", "-n"],
              description: "The deployment name",
