// az cdn completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "min-tls-version",
                suggestions: [{ name: "1.0" }, { name: "1.2" }, { name: "none" }]
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "no-http", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--no-https",
              description:
                "Indicates whether HTTPS traffic is not allowed on the endpoint. Default is to allow HTTPS traffic",
              args: { name: "no-https", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--no-wait",
              description:
            ...
            },
            {
              ...
              args: {
                name: "query-string-caching",
                suggestions: [{ name: "BypassCaching" }, { name: "IgnoreQueryString" }, { name: "NotSet" }, { name: "UseQueryString" }]
              }
            },
            {
              name: "--tags",
              ...
              options: [
                {
                  ...
                  args: {
                    name: "action-name",
                    suggestions: [{ name: "CacheExpiration" }, { name: "CacheKeyQueryString" }, { name: "ModifyRequestHeader" }, { name: "ModifyResponseHeader" }, { name: "OriginGroupOverride" }, { name: "UrlRedirect" }, { name: "UrlRewrite" }]
                  },
                  isRequired: true
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "cache-behavior",
                    suggestions: [{ name: "BypassCache" }, { name: "Override" }, { name: "SetIfMissing" }]
                  }
                },
                {
                  name: "--cache-duration",
                ...
                },
                {
                  ...
                  args: {
                    name: "query-string-behavior",
                    suggestions: [{ name: "Exclude" }, { name: "ExcludeAll" }, { name: "Include" }, { name: "IncludeAll" }]
                  }
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "transform",
                    suggestions: [{ name: "Lowercase" }, { name: "Uppercase" }]
                  }
                }
              ]
            },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "probe-method", suggestions: [{ name: "GET" }, { name: "HEAD" }] }
            },
            {
              name: "--probe-path",
              description:
            ...
            },
            {
              ...
              args: { name: "probe-protocol", suggestions: [{ name: "HTTP" }, { name: "HTTPS" }] }
            }
          ]
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "Custom_Verizon" }, { name: "Premium_Verizon" }, { name: "StandardPlus_955BandWidth_ChinaCdn" }, { name: "StandardPlus_AvgBandWidth_ChinaCdn" }, { name: "StandardPlus_ChinaCdn" }, { name: "Standard_955BandWidth_ChinaCdn" }, { name: "Standard_Akamai" }, { name: "Standard_AvgBandWidth_ChinaCdn" }, { name: "Standard_ChinaCdn" }, { name: "Standard_Microsoft" }, { name: "Standard_Verizon" }]
              }
            },
            {
              name: "--tags",
