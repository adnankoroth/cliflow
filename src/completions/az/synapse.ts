// az synapse completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "type", suggestions: [{ name: "Managed" }, { name: "SelfHosted" }] },
              isRequired: true
            },
            {
              name: "--workspace-name",
            ...
            },
            {
              ...
              args: {
                name: "compute-type",
                suggestions: [{ name: "ComputeOptimized" }, { name: "General" }, { name: "MemoryOptimized" }]
              }
            },
            {
              name: "--core-count",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "key-name", suggestions: [{ name: "authKey1" }, { name: "authKey2" }] }
            },
            {
              name: ["--name", "-n"],
              description: "The integration runtime name",
          ...
          options: [
            {
              ...
              args: { name: "auto-update", suggestions: [{ name: "Off" }, { name: "On" }] },
              isRequired: true
            },
            {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "default-principals-modification-kind",
                    suggestions: [{ name: "None" }, { name: "Replace" }, { name: "Union" }]
                  }
                },
                {
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "blob-storage-event-type",
                        suggestions: [{ name: "Microsoft.Storage.BlobCreated" }, { name: "Microsoft.Storage.BlobRenamed" }]
                      }
                    },
                    {
                      name: "--consumer-group",
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "data-format",
                        suggestions: [{ name: "APACHEAVRO" }, { name: "AVRO" }, { name: "CSV" }, { name: "JSON" }, { name: "MULTIJSON" }, { name: "ORC" }, { name: "PARQUET" }, { name: "PSV" }, { name: "RAW" }, { name: "SCSV" }, { name: "SINGLEJSON" }, { name: "SOHSV" }, { name: "TSV" }, { name: "TSVE" }, { name: "TXT" }, { name: "W3CLOGFILE" }]
                      }
                    },
                    {
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "compression",
                        suggestions: [{ name: "GZip" }, { name: "None" }]
                      }
                    },
                    {
                      name: "--consumer-group",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "principal-type",
                    suggestions: [{ name: "App" }, { name: "Group" }, { name: "User" }]
                  }
                },
                {
                  name: "--role",
                  ...
                  args: {
                    name: "role",
                    suggestions: [{ name: "Admin" }, { name: "Ingestor" }, { name: "Monitor" }, { name: "UnrestrictedViewer" }, { name: "User" }, { name: "Viewer" }]
                  }
                },
                {
                  name: "--tenant-id",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "role",
                    suggestions: [{ name: "AllDatabasesAdmin" }, { name: "AllDatabasesViewer" }]
                  }
                },
                {
                  name: "--tenant-id",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "executor-size",
                suggestions: [{ name: "Large" }, { name: "Medium" }, { name: "Small" }]
              }
            },
            {
              name: "--folder-path",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "is-recovery", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--parameters",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "is-recursive", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--yes", "-y"],
              description: "Do not prompt for confirmation"
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "Group" }, { name: "ServicePrincipal" }, { name: "User" }]
                  }
                },
                {
                  name: "--assignment-id",
                ...
                },
                {
                  ...
                  args: {
                    name: "item-type",
                    suggestions: [{ name: "bigDataPools" }, { name: "credentials" }, { name: "integrationRuntimes" }, { name: "linkedServices" }]
                  }
                },
                {
                  name: "--scope",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "is-built-in", suggestions: [{ name: "false" }, { name: "true" }] }
                }
              ]
            },
            {
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "language",
                    suggestions: [{ name: "CSharp" }, { name: "PySpark" }, { name: "Python" }, { name: "Scala" }, { name: "Spark" }, { name: "SparkDotNet" }]
                  }
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "node-size",
                    suggestions: [{ name: "Large" }, { name: "Medium" }, { name: "None" }, { name: "Small" }, { name: "XLarge" }, { name: "XXLarge" }, { name: "XXXLarge" }]
                  },
                  isRequired: true
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "node-size-family",
                    suggestions: [{ name: "HardwareAcceleratedFPGA" }, { name: "HardwareAcceleratedGPU" }, { name: "MemoryOptimized" }, { name: "None" }]
                  }
                },
                {
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "package-action",
                    suggestions: [{ name: "Add" }, { name: "Remove" }]
                  }
                },
                {
                  name: ["--resource-group", "-g"],
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "language",
                    suggestions: [{ name: "CSharp" }, { name: "PySpark" }, { name: "Python" }, { name: "SQL" }, { name: "Scala" }, { name: "Spark" }, { name: "SparkDotNet" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "storage-type", suggestions: [{ name: "GRS" }, { name: "LRS" }] }
                },
                {
                  name: "--tags",
                  description:
              ...
              options: [
                {
                  ...
                  args: {
                    name: "client",
                    suggestions: [{ name: "ado.net" }, { name: "jdbc" }, { name: "odbc" }, { name: "php" }, { name: "php_pdo" }]
                  },
                  isRequired: true
                },
                {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "result-limit", suggestions: [{ name: "-1" }, { name: "5000" }] }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "repository-type",
                suggestions: [{ name: "AzureDevOpsGit" }, { name: "GitHub" }]
              }
            },
            {
              name: "--root-folder",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "uami-action",
                suggestions: [{ name: "Add" }, { name: "Remove" }, { name: "Set" }]
              }
            },
            {
              name: "--uami-id",
