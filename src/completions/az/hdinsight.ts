// az hdinsight completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "type",
                suggestions: [{ name: "CustomApplication" }, { name: "RServer" }]
              }
            },
            {
              name: "--vnet-name",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "type", suggestions: [{ name: "Load" }, { name: "Schedule" }] },
              isRequired: true
            },
            {
              name: "--days",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: "--autoscale-type",
          description: "The autoscale type",
          args: { name: "autoscale-type", suggestions: [{ name: "Load" }, { name: "Schedule" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "cluster-tier", suggestions: [{ name: "Premium" }, { name: "Standard" }] }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "encryption-algorithm",
            suggestions: [{ name: "RSA-OAEP" }, { name: "RSA-OAEP-256" }, { name: "RSA1_5" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "minimal-tls-version", suggestions: [{ name: "1.2" }] }
        },
        {
          name: "--no-validation-timeout",
          description:
        ...
        },
        {
          ...
          args: {
            name: "workernode-data-disk-storage-account-type",
            suggestions: [{ name: "premium_lrs" }, { name: "standard_lrs" }]
          }
        },
        {
