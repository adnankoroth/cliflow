// az adp completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "type",
            suggestions: [{ name: "Microsoft.AutonomousDevelopmentPlatform/accounts" }, { name: "Microsoft.AutonomousDevelopmentPlatform/workspaces" }]
          },
          isRequired: true
        }
      ]
