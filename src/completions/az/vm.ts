// az vm completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "authentication-type",
            suggestions: [{ name: "all" }, { name: "password" }, { name: "ssh" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "disk-controller-type", suggestions: [{ name: "NVMe" }, { name: "SCSI" }] }
        },
        {
          name: "--edge-zone",
        ...
        },
        {
          ...
          args: { name: "enable-agent", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--enable-auto-update",
          description:
            "Indicate whether Automatic Updates is enabled for the Windows virtual machine",
          args: { name: "enable-auto-update", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--enable-hibernation",
          description:
            "The flag that enable or disable hibernation capability on the VM",
          args: { name: "enable-hibernation", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          ...
          args: { name: "enable-hotpatching", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--enable-secure-boot",
          description: "Enable secure boot",
          args: { name: "enable-secure-boot", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--enable-vtpm",
          description: "Enable vTPM",
          args: { name: "enable-vtpm", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          ...
          args: { name: "encryption-at-host", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          ...
          args: { name: "ephemeral-os-disk", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "CacheDisk" }, { name: "ResourceDisk" }]
          }
        },
        {
          ...
          args: {
            name: "eviction-policy",
            suggestions: [{ name: "Deallocate" }, { name: "Delete" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "license-type",
            suggestions: [{ name: "None" }, { name: "RHEL_BASE" }, { name: "RHEL_BASESAPAPPS" }, { name: "RHEL_BASESAPHA" }, { name: "RHEL_BYOS" }, { name: "RHEL_ELS_6" }, { name: "RHEL_EUS" }, { name: "RHEL_SAPAPPS" }, { name: "RHEL_SAPHA" }, { name: "SLES" }, { name: "SLES_BYOS" }, { name: "SLES_HPC" }, { name: "SLES_SAP" }, { name: "SLES_STANDARD" }, { name: "UBUNTU" }, { name: "UBUNTU_PRO" }, { name: "Windows_Client" }, { name: "Windows_Server" }]
          }
        },
        {
          name: ["--location", "-l"],
        ...
        },
        {
          ...
          args: { name: "nsg-rule", suggestions: [{ name: "NONE" }, { name: "RDP" }, { name: "SSH" }] }
        },
        {
          ...
          args: {
            name: "os-disk-caching",
            suggestions: [{ name: "None" }, { name: "ReadOnly" }, { name: "ReadWrite" }]
          }
        },
        {
          ...
          args: {
            name: "os-disk-delete-option",
            suggestions: [{ name: "Delete" }, { name: "Detach" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "os-disk-security-encryption-type",
            suggestions: [{ name: "DiskWithVMGuestState" }, { name: "VMGuestStateOnly" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "patch-mode",
            suggestions: [{ name: "AutomaticByOS" }, { name: "AutomaticByPlatform" }, { name: "ImageDefault" }, { name: "Manual" }]
          }
        },
        {
          name: "--plan-name",
        ...
        },
        {
          ...
          args: { name: "priority", suggestions: [{ name: "Low" }, { name: "Regular" }, { name: "Spot" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "public-ip-sku", suggestions: [{ name: "Basic" }, { name: "Standard" }] }
        },
        {
          name: "--role",
        ...
        },
        {
          ...
          args: {
            name: "security-type",
            suggestions: [{ name: "ConfidentialVM" }, { name: "Standard" }, { name: "TrustedLaunch" }]
          }
        },
        {
          name: "--size",
        ...
        },
        {
          ...
          args: { name: "specialized", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "ultra-ssd-enabled", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "zone", suggestions: [{ name: "1" }, { name: "2" }, { name: "3" }] }
        }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "reboot-setting",
            suggestions: [{ name: "Always" }, { name: "IfRequired" }, { name: "Never" }]
          },
          isRequired: true
        },
        {
          ...
          args: {
            name: "classifications-to-include-linux",
            suggestions: [{ name: "Critical" }, { name: "Other" }, { name: "Security" }]
          }
        },
        {
          ...
          args: {
            name: "classifications-to-include-win",
            suggestions: [{ name: "Critical" }, { name: "Definition" }, { name: "FeaturePack" }, { name: "Security" }, { name: "ServicePack" }, { name: "Tools" }, { name: "UpdateRollUp" }, { name: "Updates" }]
          }
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "zone", suggestions: [{ name: "false" }, { name: "true" }] }
        }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: "--security-type",
          description: "Specify the security type of the virtual machine",
          args: { name: "security-type", suggestions: [{ name: "TrustedLaunch" }] }
        },
        {
          name: "--set",
          description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "PremiumV2_LRS" }, { name: "Premium_LRS" }, { name: "Premium_ZRS" }, { name: "StandardSSD_LRS" }, { name: "StandardSSD_ZRS" }, { name: "Standard_LRS" }, { name: "UltraSSD_LRS" }]
              }
            },
            {
              name: "--subscription",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "volume-type", suggestions: [{ name: "ALL" }, { name: "DATA" }, { name: "OS" }] }
            }
          ]
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "auto-replace", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--license-type",
              description:
              ...
              args: {
                name: "license-type",
                suggestions: [{ name: "None" }, { name: "Windows_Server_Hybrid" }, { name: "Windows_Server_Perpetual" }]
              }
            },
            {
              name: ["--location", "-l"],
          ...
          options: [
            {
              ...
              args: {
                name: "expand",
                suggestions: [{ name: "instanceView" }, { name: "userData" }]
              }
            },
            {
              name: ["--host-group-name", "--host-group"],
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "architecture", suggestions: [{ name: "Arm64" }, { name: "x64" }] }
            },
            {
              name: "--edge-zone",
              description: "The name of edge zone",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "async-execution", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--command-id",
