// az networkcloud completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "cluster-type",
                suggestions: [{ name: "MultiRack" }, { name: "SingleRack" }]
              },
              isRequired: true
            },
            {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "privilege-level",
                    suggestions: [{ name: "Standard" }, { name: "Superuser" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "privilege-level",
                    suggestions: [{ name: "Administrator" }, { name: "ReadOnly" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "mode",
                    suggestions: [{ name: "NotApplicable" }, { name: "System" }, { name: "User" }]
                  },
                  isRequired: true
                },
                {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "ip-allocation-type",
                suggestions: [{ name: "DualStack" }, { name: "IPV4" }, { name: "IPV6" }]
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "boot-method", suggestions: [{ name: "BIOS" }, { name: "UEFI" }] }
            },
            {
              name: "--generate-ssh-keys",
              description:
            ...
            },
            {
              ...
              args: { name: "vm-device-model", suggestions: [{ name: "T1" }, { name: "T2" }] }
            },
            {
