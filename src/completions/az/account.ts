// az account completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "offer-type",
            suggestions: [{ name: "MS-AZR-0017P" }, { name: "MS-AZR-0148P" }, { name: "MS-AZR-USGOV-0015P" }, { name: "MS-AZR-USGOV-0017P" }, { name: "MS-AZR-USGOV-0148P" }]
          },
          isRequired: true
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "resource-type",
            suggestions: [{ name: "aad-graph" }, { name: "arm" }, { name: "batch" }, { name: "data-lake" }, { name: "media" }, { name: "ms-graph" }, { name: "oss-rdbms" }]
          }
        },
        {
          name: "--scope",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "workload",
                suggestions: [{ name: "DevTest" }, { name: "Production" }]
              }
            }
          ]
        },
          ...
          options: [
            {
              ...
              args: {
                name: "lock-type",
                suggestions: [{ name: "CanNotDelete" }, { name: "ReadOnly" }]
              },
              isRequired: true
            },
            {
