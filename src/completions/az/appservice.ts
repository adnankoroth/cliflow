// az appservice completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "front-end-sku", suggestions: [{ name: "I1" }, { name: "I2" }, { name: "I3" }] }
            },
            {
            ...
            },
            {
              ...
              args: { name: "kind", suggestions: [{ name: "ASEv2" }, { name: "ASEv3" }] }
            },
            {
              name: ["--location", "-l"],
              description:
            ...
            },
            {
              ...
              args: {
                name: "os-preference",
                suggestions: [{ name: "Linux" }, { name: "Windows" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "elastic-scale", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--force-string",
              description:
