// az peering completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "validation-state",
                suggestions: [{ name: "Approved" }, { name: "Failed" }, { name: "None" }, { name: "Pending" }]
              }
            }
          ]
        },
          ...
          options: [
            {
              ...
              args: { name: "kind", suggestions: [{ name: "Direct" }, { name: "Exchange" }] },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "direct-peering-type",
                suggestions: [{ name: "Cdn" }, { name: "Edge" }, { name: "Internal" }, { name: "Ix" }, { name: "IxRs" }, { name: "Transit" }]
              }
            }
          ]
        }
