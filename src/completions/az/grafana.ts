// az grafana completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "role",
                suggestions: [{ name: "Admin" }, { name: "Editor" }, { name: "Viewer" }]
              }
            },
            {
              name: "--time-to-live",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "components",
            suggestions: [{ name: "annotations" }, { name: "dashboards" }, { name: "datasources" }, { name: "folders" }, { name: "snapshots" }]
          }
        },
        {
          name: ["--directory", "-d"],
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "remap-data-sources", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: ["--resource-group", "-g"],
          description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "skip-verify", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--smtp",
          description: "Allow Grafana to send email",
          args: { name: "smtp", suggestions: [{ name: "Disabled" }, { name: "Enabled" }] }
        },
        {
          ...
          args: {
            name: "start-tls-policy",
            suggestions: [{ name: "MandatoryStartTLS" }, { name: "NoStartTLS" }, { name: "OpportunisticStartTLS" }]
          }
        },
        {
          name: "--tags",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "overwrite", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--resource-group", "-g"],
              description:
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "dry-run", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--folders-to-exclude", "-e"],
              description: "Folders to exclude in backup or sync",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "is-disabled", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--resource-group", "-g"],
              description:
