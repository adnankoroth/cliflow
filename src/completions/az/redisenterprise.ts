// az redisenterprise completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "sku",
            suggestions: [{ name: "EnterpriseFlash_F1500" }, { name: "EnterpriseFlash_F300" }, { name: "EnterpriseFlash_F700" }, { name: "Enterprise_E10" }, { name: "Enterprise_E100" }, { name: "Enterprise_E20" }, { name: "Enterprise_E200" }, { name: "Enterprise_E400" }, { name: "Enterprise_E5" }, { name: "Enterprise_E50" }]
          },
          isRequired: true
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "client-protocol",
            suggestions: [{ name: "Encrypted" }, { name: "Plaintext" }]
          }
        },
        {
          ...
          args: {
            name: "clustering-policy",
            suggestions: [{ name: "EnterpriseCluster" }, { name: "OSSCluster" }]
          }
        },
        {
          ...
          args: {
            name: "eviction-policy",
            suggestions: [{ name: "AllKeysLFU" }, { name: "AllKeysLRU" }, { name: "AllKeysRandom" }, { name: "NoEviction" }, { name: "VolatileLFU" }, { name: "VolatileLRU" }, { name: "VolatileRandom" }, { name: "VolatileTTL" }]
          }
        },
        {
          name: "--group-nickname",
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "systemAssignedIdentity" }, { name: "userAssignedIdentity" }]
          }
        },
        {
