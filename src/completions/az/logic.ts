// az logic completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "state",
                suggestions: [{ name: "Completed" }, { name: "Deleted" }, { name: "Disabled" }, { name: "Enabled" }, { name: "NotSpecified" }, { name: "Suspended" }]
              }
            },
            {
              name: "--tags",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "map-type",
                    suggestions: [{ name: "Liquid" }, { name: "NotSpecified" }, { name: "Xslt" }, { name: "Xslt20" }, { name: "Xslt30" }]
                  },
                  isRequired: true
                },
                {
