// az kusto completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "Dev(No SLA)_Standard_D11_v2" }, { name: "Dev(No SLA)_Standard_E2a_v4" }, { name: "Standard_D11_v2" }, { name: "Standard_D12_v2" }, { name: "Standard_D13_v2" }, { name: "Standard_D14_v2" }, { name: "Standard_DS13_v2+1TB_PS" }, { name: "Standard_DS13_v2+2TB_PS" }, { name: "Standard_DS14_v2+3TB_PS" }, { name: "Standard_DS14_v2+4TB_PS" }, { name: "Standard_E16a_v4" }, { name: "Standard_E16as_v4+3TB_PS" }, { name: "Standard_E16as_v4+4TB_PS" }, { name: "Standard_E2a_v4" }, { name: "Standard_E4a_v4" }, { name: "Standard_E8a_v4" }, { name: "Standard_E8as_v4+1TB_PS" }, { name: "Standard_E8as_v4+2TB_PS" }, { name: "Standard_L16s" }, { name: "Standard_L4s" }, { name: "Standard_L8s" }]
              },
              isRequired: true
            },
            {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "database-routing",
                    suggestions: [{ name: "Multi" }, { name: "Single" }]
                  }
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "compression", suggestions: [{ name: "GZip" }, { name: "None" }] }
                },
                {
                  name: "--consumer-group",
                  description: "The event hub consumer group",
