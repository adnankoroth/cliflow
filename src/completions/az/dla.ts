// az dla completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "tier",
                suggestions: [{ name: "Commitment_100000AUHours" }, { name: "Commitment_10000AUHours" }, { name: "Commitment_1000AUHours" }, { name: "Commitment_100AUHours" }, { name: "Commitment_500000AUHours" }, { name: "Commitment_50000AUHours" }, { name: "Commitment_5000AUHours" }, { name: "Commitment_500AUHours" }, { name: "Consumption" }]
              }
            }
          ]
        },
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "result",
                suggestions: [{ name: "Cancelled" }, { name: "Failed" }, { name: "None" }, { name: "Succeeded" }]
              }
            },
            {
              name: "--state",
              ...
              args: {
                name: "state",
                suggestions: [{ name: "Accepted" }, { name: "Compiling" }, { name: "Ended" }, { name: "New" }, { name: "Paused" }, { name: "Queued" }, { name: "Running" }, { name: "Scheduling" }, { name: "Starting" }, { name: "WaitingForCapacity" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "compile-mode",
                suggestions: [{ name: "Full" }, { name: "Semantic" }, { name: "SingleBox" }]
              }
            },
            {
              name: "--compile-only",
