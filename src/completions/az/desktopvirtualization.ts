// az desktopvirtualization completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "application-group-type",
                suggestions: [{ name: "Desktop" }, { name: "RemoteApp" }]
              },
              isRequired: true
            },
            {
          ...
          options: [
            {
              ...
              args: {
                name: "host-pool-type",
                suggestions: [{ name: "BYODesktop" }, { name: "Personal" }, { name: "Pooled" }]
              },
              isRequired: true
            },
            {
              ...
              args: {
                name: "load-balancer-type",
                suggestions: [{ name: "BreadthFirst" }, { name: "DepthFirst" }, { name: "Persistent" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "Desktop" }, { name: "None" }, { name: "RailApplications" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "personal-desktop-assignment-type",
                suggestions: [{ name: "Automatic" }, { name: "Direct" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "sso-secret-type",
                suggestions: [{ name: "Certificate" }, { name: "CertificateInKeyVault" }, { name: "SharedKey" }, { name: "SharedKeyInKeyVault" }]
              }
            },
            {
