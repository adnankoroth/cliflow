// az webapp completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "action",
                suggestions: [{ name: "AllowAnonymous" }, { name: "LoginWithAzureActiveDirectory" }, { name: "LoginWithFacebook" }, { name: "LoginWithGoogle" }, { name: "LoginWithMicrosoftAccount" }, { name: "LoginWithTwitter" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "token-store", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "multicontainer-config-type",
            suggestions: [{ name: "COMPOSE" }, { name: "KUBE" }]
          }
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "ignore-stack", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: ["--name", "-n"],
        ...
        },
        {
          ...
          args: { name: "restart", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: ["--slot", "-s"],
          description:
        ...
        },
        {
          ...
          args: {
            name: "type",
            suggestions: [{ name: "ear" }, { name: "jar" }, { name: "lib" }, { name: "startup" }, { name: "static" }, { name: "war" }, { name: "zip" }]
          }
        }
      ]
    },
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "os-type", suggestions: [{ name: "linux" }, { name: "windows" }] }
        }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "sku",
            suggestions: [{ name: "B1" }, { name: "B2" }, { name: "B3" }, { name: "D1" }, { name: "F1" }, { name: "FREE" }, { name: "I1" }, { name: "I1v2" }, { name: "I2" }, { name: "I2v2" }, { name: "I3" }, { name: "I3v2" }, { name: "I4v2" }, { name: "I5v2" }, { name: "I6v2" }, { name: "P0V3" }, { name: "P1MV3" }, { name: "P1V2" }, { name: "P1V3" }, { name: "P2MV3" }, { name: "P2V2" }, { name: "P2V3" }, { name: "P3MV3" }, { name: "P3V2" }, { name: "P3V3" }, { name: "P4MV3" }, { name: "P5MV3" }, { name: "S1" }, { name: "S2" }, { name: "S3" }, { name: "SHARED" }, { name: "WS1" }, { name: "WS2" }, { name: "WS3" }]
          }
        },
        {
          name: "--subscription",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description:
            "Redirect all traffic made to an app using HTTP to HTTPS",
          args: { name: "https-only", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--ids",
          description:
        ...
        },
        {
          ...
          args: { name: "ttl-in-seconds", suggestions: [{ name: "false" }, { name: "true" }] }
        }
      ]
    },
    {
          ...
          options: [
            {
              ...
              args: { name: "always-on", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "ftps-state",
                suggestions: [{ name: "AllAllowed" }, { name: "Disabled" }, { name: "FtpsOnly" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "http20-enabled", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--ids",
              description:
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "action", suggestions: [{ name: "Allow" }, { name: "Deny" }] }
                },
                {
                  name: "--description",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "db-type",
                    suggestions: [{ name: "LocalMySql" }, { name: "MySql" }, { name: "PostgreSql" }, { name: "SqlAzure" }]
                  }
                },
                {
                  name: ["--slot", "-s"],
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "retain-one", suggestions: [{ name: "false" }, { name: "true" }] }
                },
                {
                  name: "--retention",
                  description:
              ...
              options: [
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "ApiHub" }, { name: "Custom" }, { name: "DocDb" }, { name: "EventHub" }, { name: "MySql" }, { name: "NotificationHub" }, { name: "PostgreSQL" }, { name: "RedisCache" }, { name: "SQLAzure" }, { name: "SQLServer" }, { name: "ServiceBus" }]
                  }
                },
                {
                  name: "--ids",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "ssl-type", suggestions: [{ name: "IP" }, { name: "SNI" }] },
                  isRequired: true
                },
                {
                  name: "--hostname",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "storage-type",
                    suggestions: [{ name: "AzureBlob" }, { name: "AzureFiles" }]
                  },
                  isRequired: true
                },
                {
          ...
          options: [
            {
              ...
              args: {
                name: "target-type",
                suggestions: [{ name: "appconfig" }, { name: "confluent-cloud" }, { name: "cosmos-cassandra" }, { name: "cosmos-gremlin" }, { name: "cosmos-mongo" }, { name: "cosmos-sql" }, { name: "cosmos-table" }, { name: "eventhub" }, { name: "keyvault" }, { name: "mysql" }, { name: "mysql-flexible" }, { name: "postgres" }, { name: "postgres-flexible" }, { name: "redis" }, { name: "redis-enterprise" }, { name: "servicebus" }, { name: "signalr" }, { name: "sql" }, { name: "storage-blob" }, { name: "storage-file" }, { name: "storage-queue" }, { name: "storage-table" }, { name: "webpubsub" }]
              }
            }
          ]
        },
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "java" }, { name: "nodejs" }, { name: "none" }, { name: "python" }]
                  }
                },
                {
                  name: "--connection",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "go" }, { name: "java" }, { name: "none" }, { name: "python" }, { name: "springBoot" }]
                  }
                },
                {
                  name: "--connection",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "go" }, { name: "java" }, { name: "nodejs" }, { name: "none" }, { name: "python" }, { name: "springBoot" }]
                  }
                },
                {
                  name: "--connection",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "java" }, { name: "nodejs" }, { name: "none" }, { name: "php" }, { name: "python" }]
                  }
                },
                {
                  name: "--connection",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "go" }, { name: "java" }, { name: "nodejs" }, { name: "none" }, { name: "springBoot" }]
                  }
                },
                {
                  name: "--connection",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "java" }, { name: "nodejs" }, { name: "none" }, { name: "python" }, { name: "springBoot" }]
                  }
                },
                {
                  name: "--connection",
              ...
              options: [
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "go" }, { name: "java" }, { name: "kafka-springBoot" }, { name: "nodejs" }, { name: "none" }, { name: "python" }, { name: "springBoot" }]
                  }
                },
                {
                  name: "--connection",
              ...
              options: [
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "django" }, { name: "dotnet" }, { name: "go" }, { name: "java" }, { name: "nodejs" }, { name: "none" }, { name: "php" }, { name: "python" }, { name: "ruby" }, { name: "springBoot" }]
                  }
                },
                {
                  name: "--config-connstr",
              ...
              options: [
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "none" }]
                  }
                },
                {
                  name: "--connection",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "client-type",
                    suggestions: [{ name: "dotnet" }, { name: "java" }, { name: "nodejs" }, { name: "none" }, { name: "php" }, { name: "python" }, { name: "ruby" }, { name: "springBoot" }]
                  }
                },
                {
                  name: "--connection",
              ...
              options: [
                {
                  ...
                  args: { name: "enable-cd", suggestions: [{ name: "false" }, { name: "true" }] },
                  isRequired: true
                },
                {
                  name: "--ids",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "action",
                    suggestions: [{ name: "preview" }, { name: "reset" }, { name: "swap" }]
                  }
                },
                {
                  name: "--ids",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "repository-type",
                    suggestions: [{ name: "externalgit" }, { name: "git" }, { name: "github" }, { name: "localgit" }, { name: "mercurial" }]
                  }
                },
                {
                  name: ["--resource-group", "-g"],
          ...
          options: [
            {
              ...
              args: {
                name: "application-logging",
                suggestions: [{ name: "azureblobstorage" }, { name: "filesystem" }, { name: "off" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "docker-container-logging",
                suggestions: [{ name: "filesystem" }, { name: "off" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "level",
                suggestions: [{ name: "error" }, { name: "information" }, { name: "verbose" }, { name: "warning" }]
              }
            },
            {
              name: ["--name", "-n"],
