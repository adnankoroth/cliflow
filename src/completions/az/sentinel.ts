// az sentinel completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "kind",
                suggestions: [{ name: "APIKey" }, { name: "Basic" }, { name: "OAuth2" }]
              }
            },
            {
              name: "--output-stream",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "kind", suggestions: [{ name: "Activity" }, { name: "Expansion" }] }
            }
          ]
        },
        {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "kind", suggestions: [{ name: "Activity" }] }
                }
              ]
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "classification",
                suggestions: [{ name: "BenignPositive" }, { name: "FalsePositive" }, { name: "TruePositive" }, { name: "Undetermined" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "classification-reason",
                suggestions: [{ name: "InaccurateData" }, { name: "IncorrectAlertLogic" }, { name: "SuspiciousActivity" }, { name: "SuspiciousButExpected" }]
              }
            },
            {
              name: "--description",
            ...
            },
            {
              ...
              args: {
                name: "severity",
                suggestions: [{ name: "High" }, { name: "Informational" }, { name: "Low" }, { name: "Medium" }]
              }
            },
            {
              name: "--status",
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Active" }, { name: "Closed" }, { name: "New" }]
              }
            },
            {
              name: "--title",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "kind",
                suggestions: [{ name: "AnalyticsRule" }, { name: "AnalyticsRuleTemplate" }, { name: "AutomationRule" }, { name: "AzureFunction" }, { name: "DataConnector" }, { name: "DataType" }, { name: "HuntingQuery" }, { name: "InvestigationQuery" }, { name: "LogicAppsCustomConnector" }, { name: "Parser" }, { name: "Playbook" }, { name: "PlaybookTemplate" }, { name: "Solution" }, { name: "Watchlist" }, { name: "WatchlistTemplate" }, { name: "Workbook" }, { name: "WorkbookTemplate" }]
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "repo-type", suggestions: [{ name: "DevOps" }, { name: "Github" }] }
            },
            {
              name: "--repository",
              description:
            ...
            },
            {
              ...
              args: { name: "version", suggestions: [{ name: "V1" }, { name: "V2" }] }
            }
          ]
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "source-type",
                suggestions: [{ name: "Local file" }, { name: "Remote storage" }]
              }
            },
            {
              name: "--tenant-id",
