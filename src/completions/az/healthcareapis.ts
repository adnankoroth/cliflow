// az healthcareapis completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "kind",
                suggestions: [{ name: "fhir" }, { name: "fhir-R4" }, { name: "fhir-Stu3" }]
              },
              isRequired: true
            },
            {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "default",
                    suggestions: [{ name: "no-version" }, { name: "versioned" }, { name: "versioned-update" }]
                  }
                },
                {
                  name: "--etag",
                ...
                },
                {
                  name: "--kind",
                  description: "The kind of the service",
                  args: { name: "kind", suggestions: [{ name: "fhir-R4" }, { name: "fhir-Stu3" }] }
                },
                {
                  name: ["--location", "-l"],
                  description:
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        ...
                        suggestions: [{ name: "Create" }, { name: "Lookup" }]
                      },
                      isRequired: true
                    },
                    {
