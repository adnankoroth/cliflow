// az elastic-san completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "encryption",
                suggestions: [{ name: "EncryptionAtRestWithCustomerManagedKey" }, { name: "EncryptionAtRestWithPlatformKey" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "protocol-type", suggestions: [{ name: "Iscsi" }, { name: "None" }] }
            }
          ]
        },
        {
