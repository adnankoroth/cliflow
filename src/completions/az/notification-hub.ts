// az notification-hub completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "policy-key",
                suggestions: [{ name: "Primary Key" }, { name: "Secondary Key" }]
              },
              isRequired: true
            },
            {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "notification-format",
            suggestions: [{ name: "apple" }, { name: "baidu" }, { name: "gcm" }, { name: "template" }, { name: "windows" }, { name: "windowsphone" }]
          },
          isRequired: true
        },
        {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "sku", suggestions: [{ name: "Basic" }, { name: "Free" }, { name: "Standard" }] },
              isRequired: true
            },
            {
              name: ["--location", "-l"],
