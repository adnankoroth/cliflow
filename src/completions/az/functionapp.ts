// az functionapp completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "functions-version", suggestions: [{ name: "2" }, { name: "3" }, { name: "4" }] }
        },
        {
          name: "--https-only",
          description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "overwrite-yaml", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--project-name",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "key-type",
                suggestions: [{ name: "functionKeys" }, { name: "masterKey" }, { name: "systemKeys" }]
              },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "is-linux", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--location", "-l"],
              description:
