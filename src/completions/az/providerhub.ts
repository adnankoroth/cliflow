// az providerhub completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "message-scope",
                suggestions: [{ name: "NotSpecified" }, { name: "RegisteredSubscriptions" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "notification-mode",
                suggestions: [{ name: "EventHub" }, { name: "NotSpecified" }, { name: "WebHook" }]
              }
            }
          ]
        },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "opt-in-headers",
                suggestions: [{ name: "ClientGroupMembership" }, { name: "NotSpecified" }, { name: "SignedAuxiliaryTokens" }, { name: "SignedUserToken" }, { name: "UnboundedClientGroupMembership" }]
              }
            },
            {
              name: [
            ...
            },
            {
              ...
              args: {
                name: "resource-access-policy",
                suggestions: [{ name: "AcisActionAllowed" }, { name: "AcisReadAllowed" }, { name: "NotSpecified" }]
              }
            },
            {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "CascadeDeleteAll" }, { name: "CascadeDeleteProxyOnlyChildren" }, { name: "NotSpecified" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "is-pure-proxy", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "marketplace-type",
                suggestions: [{ name: "AddOn" }, { name: "Bypass" }, { name: "NotSpecified" }, { name: "Store" }]
              }
            },
            {
              name: "--opt-in-headers",
            ...
            },
            {
              ...
              args: {
                name: "regionality",
                suggestions: [{ name: "Global" }, { name: "NotSpecified" }, { name: "Regional" }]
              }
            },
            {
              name: ["--required-features-policy", "--req-features-policy"],
