// az devops completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "use-git-aliases", suggestions: [{ name: "false" }, { name: "true" }] }
        }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "encoding",
            suggestions: [{ name: "ascii" }, { name: "utf-16be" }, { name: "utf-16le" }, { name: "utf-8" }]
          }
        },
        {
          name: "--http-method",
          ...
          args: {
            name: "http-method",
            suggestions: [{ name: "DELETE" }, { name: "GET" }, { name: "HEAD" }, { name: "OPTIONS" }, { name: "PATCH" }, { name: "POST" }, { name: "PUT" }]
          }
        },
        {
          name: "--in-file",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "source-control", suggestions: [{ name: "git" }, { name: "tfvc" }] }
            },
            {
              name: "--visibility",
              description: "Project visibility",
              args: { name: "visibility", suggestions: [{ name: "private" }, { name: "public" }] }
            }
          ]
        },
        {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "state-filter",
                suggestions: [{ name: "all" }, { name: "createPending" }, { name: "deleted" }, { name: "deleting" }, { name: "new" }, { name: "unchanged" }, { name: "wellFormed" }]
              }
            },
            {
              name: "--top",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "scope",
                    suggestions: [{ name: "organization" }, { name: "project" }]
                  }
                }
              ]
            },
                ...
                },
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "relationship",
                        suggestions: [{ name: "memberof" }, { name: "members" }]
                      }
                    }
                  ]
                },
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "merge", suggestions: [{ name: "false" }, { name: "true" }] }
                },
                {
                  name: ["--organization", "--org"],
                  description:
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "enable-for-all", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--organization", "--org"],
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "license-type",
                suggestions: [{ name: "advanced" }, { name: "earlyAdopter" }, { name: "express" }, { name: "professional" }, { name: "stakeholder" }]
              },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "wiki-type",
                suggestions: [{ name: "codewiki" }, { name: "projectwiki" }]
              }
            },
            {
              name: ["--version", "-v"],
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "scope", suggestions: [{ name: "organization" }, { name: "project" }] }
            }
          ]
        },
        {
