// az policy completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "Default" }, { name: "DoNotEnforce" }]
              }
            },
            {
              name: "--identity-scope",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "compliance-state",
                suggestions: [{ name: "Compliant" }, { name: "NonCompliant" }, { name: "Unknown" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "resource-discovery-mode",
                suggestions: [{ name: "ExistingNonCompliant" }, { name: "ReEvaluateCompliance" }]
              }
            },
            {
              name: ["--resource-group", "-g"],
