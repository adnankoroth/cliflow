// az dedicated-hsm completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "sku",
            suggestions: [{ name: "SafeNet Luna Network HSM A790" }, { name: "payShield10K_LMK1_CPS250" }, { name: "payShield10K_LMK1_CPS2500" }, { name: "payShield10K_LMK1_CPS60" }, { name: "payShield10K_LMK2_CPS250" }, { name: "payShield10K_LMK2_CPS2500" }, { name: "payShield10K_LMK2_CPS60" }]
          }
        },
        {
          name: "--stamp-id",
