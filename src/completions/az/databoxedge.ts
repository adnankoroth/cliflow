// az databoxedge completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "EP2_128_1T4_Mx1_W" }, { name: "EP2_256_2T4_W" }, { name: "EP2_64_1VPU_W" }, { name: "Edge" }, { name: "EdgeMR_Mini" }, { name: "EdgePR_Base" }, { name: "EdgePR_Base_UPS" }, { name: "EdgeP_Base" }, { name: "EdgeP_High" }, { name: "GPU" }, { name: "Gateway" }, { name: "Management" }, { name: "RCA_Large" }, { name: "RCA_Small" }, { name: "RDC" }, { name: "TCA_Large" }, { name: "TCA_Small" }, { name: "TDC" }, { name: "TEA_1Node" }, { name: "TEA_1Node_Heater" }, { name: "TEA_1Node_UPS" }, { name: "TEA_1Node_UPS_Heater" }, { name: "TEA_4Node_Heater" }, { name: "TEA_4Node_UPS_Heater" }, { name: "TMA" }]
              }
            },
            {
              name: "--status",
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Disconnected" }, { name: "Maintenance" }, { name: "NeedsAttention" }, { name: "Offline" }, { name: "Online" }, { name: "PartiallyDisconnected" }, { name: "ReadyToSetup" }]
              }
            },
            {
              name: "--tags",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Arriving" }, { name: "AwaitingFulfilment" }, { name: "AwaitingPreparation" }, { name: "AwaitingReturnShipment" }, { name: "AwaitingShipment" }, { name: "CollectedAtMicrosoft" }, { name: "Declined" }, { name: "Delivered" }, { name: "LostDevice" }, { name: "ReplacementRequested" }, { name: "ReturnInitiated" }, { name: "Shipped" }, { name: "ShippedBack" }, { name: "Untracked" }]
              },
              isRequired: true
            },
            {
