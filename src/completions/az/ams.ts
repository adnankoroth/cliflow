// az ams completion spec for CLIFlow
              ...
              options: [
                {
                  ...
                  args: {
                    name: "storage-auth",
                    suggestions: [{ name: "ManagedIdentity" }, { name: "System" }]
                  },
                  isRequired: true
                },
                {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "permissions",
                suggestions: [{ name: "Read" }, { name: "ReadWrite" }, { name: "ReadWriteDelete" }]
              }
            },
            {
              name: ["--resource-group", "-g"],
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "priority",
                suggestions: [{ name: "High" }, { name: "Low" }, { name: "Normal" }]
              }
            },
            {
              name: ["--resource-group", "-g"],
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "streaming-protocol",
                suggestions: [{ name: "FragmentedMP4" }, { name: "RTMP" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "stream-options",
                suggestions: [{ name: "Default" }, { name: "LowLatency" }, { name: "LowLatencyV2" }]
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "insights-to-extract",
                suggestions: [{ name: "AllInsights" }, { name: "AudioInsightsOnly" }, { name: "VideoInsightsOnly" }]
              }
            },
            {
              name: "--on-error",
              ...
              args: {
                name: "on-error",
                suggestions: [{ name: "ContinueJob" }, { name: "StopProcessingJob" }]
              }
            },
            {
