// az repos completion spec for CLIFlow
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "blocking", suggestions: [{ name: "false" }, { name: "true" }] },
                  isRequired: true
                },
                {
                  name: "--branch",
                ...
                },
                {
                  ...
                  args: {
                    name: "branch-match-type",
                    suggestions: [{ name: "exact" }, { name: "prefix" }]
                  }
                },
                {
                  name: "--detect",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "draft", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "abandoned" }, { name: "active" }, { name: "all" }, { name: "completed" }]
              }
            },
            {
              name: ["--target-branch", "-t"],
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "vote",
                suggestions: [{ name: "approve" }, { name: "approve-with-suggestions" }, { name: "reject" }, { name: "reset" }, { name: "wait-for-author" }]
              },
              isRequired: true
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              description:
                "Set the pull request to complete automatically when all policies have passed and the source branch can be merged into the target branch",
              args: { name: "auto-complete", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--bypass-policy",
              description:
                "Bypass required policies (if any) and completes the pull request once it can be merged",
              args: { name: "bypass-policy", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--bypass-policy-reason",
              description: "Reason for bypassing the required policies",
            ...
            },
            {
              ...
              description:
                "Squash the commits in the source branch when merging into the target branch",
              args: { name: "squash", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--status",
              ...
              args: {
                name: "status",
                suggestions: [{ name: "abandoned" }, { name: "active" }, { name: "completed" }]
              }
            },
            {
              name: "--title",
