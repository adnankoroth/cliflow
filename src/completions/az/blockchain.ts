// az blockchain completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "protocol",
                suggestions: [{ name: "Corda" }, { name: "NotSpecified" }, { name: "Parity" }, { name: "Quorum" }]
              }
            },
            {
              name: "--sku",
              description: "The Sku of the blockchain member",
              args: { name: "sku", suggestions: [{ name: "Basic" }, { name: "Standard" }] }
            },
            {
              name: "--tags",
              description:
