// az backup completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "backup-management-type",
                suggestions: [{ name: "AzureIaasVM" }, { name: "AzureStorage" }, { name: "AzureWorkload" }, { name: "MAB" }]
              },
              isRequired: true
            },
            {
          ...
          options: [
            {
              ...
              args: {
                name: "workload-type",
                suggestions: [{ name: "MSSQL" }, { name: "SAPASE" }, { name: "SAPHANA" }, { name: "SAPHanaDatabase" }, { name: "SQLDataBase" }]
              },
              isRequired: true
            },
            {
              ...
              args: {
                name: "backup-management-type",
                suggestions: [{ name: "AzureIaasVM" }, { name: "AzureStorage" }, { name: "AzureWorkload" }]
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "workload-type",
                suggestions: [{ name: "AzureFileShare" }, { name: "MSSQL" }, { name: "SAPHANA" }, { name: "SAPHanaDatabase" }, { name: "SQLDataBase" }, { name: "VM" }]
              }
            }
          ]
        },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "operation",
                suggestions: [{ name: "Backup" }, { name: "ConfigureBackup" }, { name: "DeleteBackupData" }, { name: "DisableBackup" }, { name: "Restore" }]
              }
            },
            {
              name: "--start-date",
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Cancelled" }, { name: "Completed" }, { name: "CompletedWithWarnings" }, { name: "Failed" }, { name: "InProgress" }]
              }
            },
            {
              name: "--use-secondary-region",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "move-to-archive-tier",
                suggestions: [{ name: "All" }, { name: "Disabled" }, { name: "Enabled" }]
              }
            },
            {
              ...
              args: {
                name: "policy-sub-type",
                suggestions: [{ name: "Enhanced" }, { name: "Standard" }]
              }
            },
            {
              name: "--workload-type",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "protectable-item-type",
                suggestions: [{ name: "HANAInstance" }, { name: "SAPHanaDatabase" }, { name: "SAPHanaSystem" }, { name: "SQLAG" }, { name: "SQLDatabase" }, { name: "SQLInstance" }]
              }
            },
            {
              name: "--server-name",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "disk-list-setting",
                suggestions: [{ name: "exclude" }, { name: "include" }, { name: "resetexclusionsettings" }]
              }
            },
            {
              name: "--diskslist",
          ...
          options: [
            {
              ...
              args: {
                name: "restore-mode",
                suggestions: [{ name: "AlternateWorkloadRestore" }, { name: "OriginalWorkloadRestore" }, { name: "RestoreAsFiles" }]
              },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "target-tier", suggestions: [{ name: "VaultArchive" }] }
            },
            {
              name: "--tier",
              ...
              args: {
                name: "tier",
                suggestions: [{ name: "Snapshot" }, { name: "SnapshotAndVaultArchive" }, { name: "SnapshotAndVaultStandard" }, { name: "VaultArchive" }, { name: "VaultStandard" }, { name: "VaultStandardRehydrated" }]
              }
            },
            {
              name: "--use-secondary-region",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              description:
                "The destination/target tier to which a particular recovery point has to be moved",
              args: { name: "destination-tier", suggestions: [{ name: "VaultArchive" }] },
              isRequired: true
            },
            {
              name: ["--item-name", "-i"],
            ...
            },
            {
              ...
              args: { name: "source-tier", suggestions: [{ name: "VaultStandard" }] },
              isRequired: true
            },
            {
              name: ["--vault-name", "-v"],
          ...
          options: [
            {
              ...
              args: {
                name: "resolve-conflict",
                suggestions: [{ name: "Overwrite" }, { name: "Skip" }]
              },
              isRequired: true
            },
            {
              ...
              args: {
                name: "restore-mode",
                suggestions: [{ name: "AlternateLocation" }, { name: "OriginalLocation" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "source-file-type",
                suggestions: [{ name: "Directory" }, { name: "File" }]
              }
            },
            {
              name: "--subscription",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "rehydration-priority",
                suggestions: [{ name: "High" }, { name: "Standard" }]
              }
            },
            {
              name: "--use-secondary-region",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "target-zone", suggestions: [{ name: "1" }, { name: "2" }, { name: "3" }] }
            },
            {
              name: "--use-secondary-region",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "classic-alerts",
                suggestions: [{ name: "Disable" }, { name: "Enable" }]
              }
            },
            {
              ...
              args: {
                name: "cross-subscription-restore-state",
                suggestions: [{ name: "Disable" }, { name: "Enable" }, { name: "PermanentlyDisable" }]
              }
            },
            {
              ...
              options: [
                {
                  ...
                  args: {
                    name: "backup-storage-redundancy",
                    suggestions: [{ name: "GeoRedundant" }, { name: "LocallyRedundant" }, { name: "ZoneRedundant" }]
                  }
                },
                {
                  name: "--classic-alerts",
                ...
                },
                {
                  ...
                  args: {
                    name: "soft-delete-feature-state",
                    suggestions: [{ name: "AlwaysOn" }, { name: "Disable" }, { name: "Enable" }]
                  }
                },
                {
                  name: "--subscription",
