// az sig completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "permissions",
            suggestions: [{ name: "Community" }, { name: "Groups" }, { name: "Private" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "soft-delete", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--tags",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "shared-to", suggestions: [{ name: "tenant" }] }
        }
      ]
    },
    {
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "expand", suggestions: [{ name: "ReplicationStatus" }] }
                },
                {
                  name: [
                    "--gallery-application-version-name",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "os-state",
                suggestions: [{ name: "Generalized" }, { name: "Specialized" }]
              }
            },
            {
              name: "--plan-name",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "replication-mode",
                suggestions: [{ name: "Full" }, { name: "Shallow" }]
              }
            },
            {
