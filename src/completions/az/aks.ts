// az aks completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "auto-upgrade-channel",
            suggestions: [{ name: "node-image" }, { name: "none" }, { name: "patch" }, { name: "rapid" }, { name: "stable" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "azure-keyvault-kms-key-vault-network-access",
            suggestions: [{ name: "Private" }, { name: "Public" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "gpu-instance-profile",
            suggestions: [{ name: "MIG1g" }, { name: "MIG2g" }, { name: "MIG3g" }, { name: "MIG4g" }, { name: "MIG7g" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "k8s-support-plan",
            suggestions: [{ name: "AKSLongTermSupport" }, { name: "KubernetesOfficial" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "load-balancer-sku",
            suggestions: [{ name: "basic" }, { name: "standard" }]
          }
        },
        {
          name: ["--location", "-l"],
        ...
        },
        {
          ...
          args: { name: "network-dataplane", suggestions: [{ name: "azure" }, { name: "cilium" }] }
        },
        {
          name: "--network-plugin",
          ...
          args: {
            name: "network-plugin",
            suggestions: [{ name: "azure" }, { name: "kubenet" }, { name: "none" }]
          }
        },
        {
          name: "--network-plugin-mode",
          description: "The network plugin mode to use",
          args: { name: "network-plugin-mode", suggestions: [{ name: "overlay" }] }
        },
        {
          name: "--network-policy",
        ...
        },
        {
          ...
          args: {
            name: "node-os-upgrade-channel",
            suggestions: [{ name: "NodeImage" }, { name: "None" }, { name: "Unmanaged" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "node-osdisk-type",
            suggestions: [{ name: "Ephemeral" }, { name: "Managed" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "os-sku",
            suggestions: [{ name: "AzureLinux" }, { name: "CBLMariner" }, { name: "Mariner" }, { name: "Ubuntu" }]
          }
        },
        {
          name: "--outbound-type",
          ...
          args: {
            name: "outbound-type",
            suggestions: [{ name: "loadBalancer" }, { name: "managedNATGateway" }, { name: "userAssignedNATGateway" }, { name: "userDefinedRouting" }]
          }
        },
        {
          name: "--pod-cidr",
        ...
        },
        {
          ...
          args: { name: "tier", suggestions: [{ name: "free" }, { name: "premium" }, { name: "standard" }] }
        },
        {
          name: "--vm-set-type",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "endpoint",
            suggestions: [{ name: "None" }, { name: "Private" }, { name: "Public" }]
          }
        },
        {
          name: ["--space", "-s"],
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "schedule-type",
                suggestions: [{ name: "AbsoluteMonthly" }, { name: "Daily" }, { name: "RelativeMonthly" }, { name: "Weekly" }]
              }
            },
            {
              name: "--start-date",
          ...
          options: [
            {
              ...
              args: {
                name: "ingress-gateway-type",
                suggestions: [{ name: "External" }, { name: "Internal" }]
              },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "mode", suggestions: [{ name: "System" }, { name: "User" }] }
            },
            {
              name: "--no-wait",
              description:
            ...
            },
            {
              ...
              args: {
                name: "os-sku",
                suggestions: [{ name: "AzureLinux" }, { name: "CBLMariner" }, { name: "Mariner" }, { name: "Ubuntu" }, { name: "Windows2019" }, { name: "Windows2022" }]
              }
            },
            {
              name: "--os-type",
            ...
            },
            {
              ...
              args: { name: "priority", suggestions: [{ name: "Regular" }, { name: "Spot" }] }
            },
            {
