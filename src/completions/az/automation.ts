// az automation completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "sku", suggestions: [{ name: "Basic" }, { name: "Free" }] }
            },
            {
              name: "--tags",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "type",
                suggestions: [{ name: "Graph" }, { name: "GraphPowerShell" }, { name: "GraphPowerShellWorkflow" }, { name: "PowerShell" }, { name: "PowerShellWorkflow" }, { name: "Python2" }, { name: "Python3" }, { name: "Script" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: { name: "log-progress", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--log-verbose",
              description: "Verbose log option of the runbook",
              args: { name: "log-verbose", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--tags",
              description:
