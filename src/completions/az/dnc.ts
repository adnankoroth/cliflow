// az dnc completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "purpose", suggestions: [{ name: "prod" }, { name: "test" }] }
            },
            {
              name: "--tags",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "kind", suggestions: [{ name: "Kubernetes" }] }
            },
            {
              name: ["--location", "-l"],
              description: "Location of the resource",
            ...
            },
            {
              ...
              args: { name: "type", suggestions: [{ name: "None" }, { name: "SystemAssigned" }] }
            }
          ]
        },
        {
