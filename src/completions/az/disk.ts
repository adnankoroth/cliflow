// az disk completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "accelerated-network", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--architecture",
        ...
        },
        {
          ...
          args: {
            name: "data-access-auth-mode",
            suggestions: [{ name: "AzureActiveDirectory" }, { name: "None" }]
          }
        },
        {
          name: "--disk-access",
        ...
        },
        {
          ...
          args: { name: "enable-bursting", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          ...
          args: {
            name: "encryption-type",
            suggestions: [{ name: "EncryptionAtRestWithCustomerKey" }, { name: "EncryptionAtRestWithPlatformAndCustomerKeys" }, { name: "EncryptionAtRestWithPlatformKey" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "hyper-v-generation", suggestions: [{ name: "V1" }, { name: "V2" }] }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "network-access-policy",
            suggestions: [{ name: "AllowAll" }, { name: "AllowPrivate" }, { name: "DenyAll" }]
          }
        },
        {
          name: "--no-wait",
        ...
        },
        {
          ...
          args: { name: "performance-plus", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "security-type",
            suggestions: [{ name: "ConfidentialVM_DiskEncryptedWithCustomerKey" }, { name: "ConfidentialVM_DiskEncryptedWithPlatformKey" }, { name: "ConfidentialVM_VMGuestStateOnlyEncryptedWithPlatformKey" }, { name: "Standard" }, { name: "TrustedLaunch" }]
          }
        },
        {
          name: ["--size-gb", "-z"],
        ...
        },
        {
          ...
          args: { name: "support-hibernation", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--tags",
          description:
        ...
        },
        {
          ...
          args: {
            name: "upload-type",
            suggestions: [{ name: "Upload" }, { name: "UploadWithSecurityData" }]
          }
        },
        {
          name: "--zone",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "access-level", suggestions: [{ name: "Read" }, { name: "Write" }] }
        },
        {
          name: "--ids",
          description:
