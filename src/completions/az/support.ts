// az support completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "contact-method", suggestions: [{ name: "email" }, { name: "phone" }] },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "severity",
                suggestions: [{ name: "critical" }, { name: "highestcriticalimpact" }, { name: "minimal" }, { name: "moderate" }]
              },
              isRequired: true
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "status", suggestions: [{ name: "closed" }, { name: "open" }] }
            }
          ]
        },
        {
