// az maintenance completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "maintenance-scope",
                suggestions: [{ name: "Extension" }, { name: "Host" }, { name: "InGuestPatch" }, { name: "OSImage" }, { name: "Resource" }, { name: "SQLDB" }, { name: "SQLManagedInstance" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "visibility", suggestions: [{ name: "Custom" }, { name: "Public" }] }
            }
          ]
        },
        {
