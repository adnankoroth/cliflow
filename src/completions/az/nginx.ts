// az nginx completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "provisioning-state",
                suggestions: [{ name: "Accepted" }, { name: "Canceled" }, { name: "Creating" }, { name: "Deleted" }, { name: "Deleting" }, { name: "Failed" }, { name: "NotSpecified" }, { name: "Succeeded" }, { name: "Updating" }]
              }
            },
            {
              name: "--sku",
