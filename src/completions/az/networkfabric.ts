// az networkfabric completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "configuration-type",
                suggestions: [{ name: "File" }, { name: "Inline" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: { name: "default-action", suggestions: [{ name: "Deny" }, { name: "Permit" }] }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "nfc-sku",
                suggestions: [{ name: "Basic" }, { name: "HighPerformance" }, { name: "Standard" }]
              }
            },
            {
              name: "--no-wait",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "peering-option",
                suggestions: [{ name: "OptionA" }, { name: "OptionB" }]
              },
              isRequired: true
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "state", suggestions: [{ name: "Disable" }, { name: "Enable" }] }
            },
            {
              name: "--subscription",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "extension", suggestions: [{ name: "NPB" }, { name: "NoExtension" }] }
            },
            {
              name: "--import-route-policy",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "use-option-b", suggestions: [{ name: "False" }, { name: "True" }] },
              isRequired: true
            },
            {
              name: "--egress-acl-id",
            ...
            },
            {
              ...
              args: { name: "nni-type", suggestions: [{ name: "CE" }, { name: "NPB" }] }
            },
            {
              name: "--no-wait",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "address-family-type",
                suggestions: [{ name: "IPv4" }, { name: "IPv6" }]
              }
            },
            {
              name: "--annotation",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "polling-type", suggestions: [{ name: "Pull" }, { name: "Push" }] }
            },
            {
              name: "--tags",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "polling-interval",
                suggestions: [{ name: "120" }, { name: "30" }, { name: "60" }, { name: "90" }]
              }
            },
            {
              name: "--tags",
