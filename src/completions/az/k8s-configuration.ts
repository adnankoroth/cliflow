// az k8s-configuration completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "cluster-type",
            suggestions: [{ name: "connectedClusters" }, { name: "managedClusters" }, { name: "provisionedClusters" }]
          },
          isRequired: true
        },
        {
        ...
        },
        {
          ...
          args: { name: "scope", suggestions: [{ name: "cluster" }, { name: "namespace" }] },
          isRequired: true
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "kind", suggestions: [{ name: "azblob" }, { name: "bucket" }, { name: "git" }] }
            },
            {
              name: "--known-hosts",
              description:
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              name: "--bucket-insecure",
              description: "Communicate with a bucket without TLS",
              args: { name: "bucket-insecure", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--bucket-name",
              description: "Name of the S3 bucket to sync",
            ...
            },
            {
              ...
              description:
                "Suspend the reconciliation of the source and kustomizations associated with this configuration",
              args: { name: "suspend", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--tag",
              description:
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "object-kind",
                    suggestions: [{ name: "Bucket" }, { name: "GitRepository" }, { name: "HelmChart" }, { name: "HelmRelease" }, { name: "HelmRepository" }, { name: "Kustomization" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "prune", suggestions: [{ name: "false" }, { name: "true" }] }
                },
                {
                  name: "--retry-interval",
                  description:
