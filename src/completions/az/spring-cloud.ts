// az spring-cloud completion spec for CLIFlow
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "type",
                        suggestions: [{ name: "ApacheSkyWalking" }, { name: "AppDynamics" }, { name: "ApplicationInsights" }, { name: "Dynatrace" }, { name: "ElasticAPM" }, { name: "NewRelic" }]
                      },
                      isRequired: true
                    },
                    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "build-pool-size",
            suggestions: [{ name: "S1" }, { name: "S2" }, { name: "S3" }, { name: "S4" }, { name: "S5" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "sku",
            suggestions: [{ name: "Basic" }, { name: "Enterprise" }, { name: "Standard" }]
          }
        },
        {
          name: "--tags",
