// az dataprotection completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "datasource-type",
                suggestions: [{ name: "AzureBlob" }, { name: "AzureDatabaseForPostgreSQL" }, { name: "AzureDisk" }, { name: "AzureKubernetesService" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "secret-store-type",
                suggestions: [{ name: "AzureKeyVault" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "conflict-policy", suggestions: [{ name: "Patch" }, { name: "Skip" }] }
            },
            {
              name: "--excluded-namespaces",
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "RestoreWithVolumeData" }, { name: "RestoreWithoutVolumeData" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "protection-status",
                suggestions: [{ name: "ProtectionConfigured" }, { name: "ProtectionError" }]
              }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "validation-type",
                suggestions: [{ name: "DeepValidation" }, { name: "ShallowValidation" }]
              }
            },
            {
              name: "--vault-name",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "operation", suggestions: [{ name: "Backup" }, { name: "Restore" }] },
              isRequired: true
            },
            {
              ...
              args: {
                name: "permissions-scope",
                suggestions: [{ name: "Resource" }, { name: "ResourceGroup" }, { name: "Subscription" }]
              },
              isRequired: true
            },
            {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "source-datastore",
                    suggestions: [{ name: "ArchiveStore" }, { name: "OperationalStore" }, { name: "VaultStore" }]
                  },
                  isRequired: true
                },
                {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "Days" }, { name: "Months" }, { name: "Weeks" }, { name: "Years" }]
                  },
                  isRequired: true
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "copy-option",
                    suggestions: [{ name: "CopyOnExpiryOption" }, { name: "CustomCopyOption" }, { name: "ImmediateCopyOption" }]
                  }
                },
                {
              ...
              options: [
                {
                  ...
                  args: {
                    name: "name",
                    suggestions: [{ name: "Daily" }, { name: "Default" }, { name: "Monthly" }, { name: "Weekly" }, { name: "Yearly" }]
                  },
                  isRequired: true
                },
                {
              ...
              options: [
                {
                  ...
                  args: {
                    name: "absolute-criteria",
                    suggestions: [{ name: "AllBackup" }, { name: "FirstOfDay" }, { name: "FirstOfMonth" }, { name: "FirstOfWeek" }, { name: "FirstOfYear" }]
                  },
                  isRequired: true
                }
              ]
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "months-of-year",
                    suggestions: [{ name: "April" }, { name: "August" }, { name: "December" }, { name: "February" }, { name: "January" }, { name: "July" }, { name: "June" }, { name: "March" }, { name: "May" }, { name: "November" }, { name: "October" }, { name: "September" }]
                  }
                },
                {
                  name: "--weeks-of-month",
                  ...
                  args: {
                    name: "weeks-of-month",
                    suggestions: [{ name: "First" }, { name: "Fourth" }, { name: "Last" }, { name: "Second" }, { name: "Third" }]
                  }
                }
              ]
            },
              ...
              options: [
                {
                  ...
                  args: {
                    name: "name",
                    suggestions: [{ name: "Daily" }, { name: "Monthly" }, { name: "Weekly" }, { name: "Yearly" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "interval-type",
                    suggestions: [{ name: "Daily" }, { name: "Hourly" }, { name: "Weekly" }]
                  },
                  isRequired: true
                },
                {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "Disabled" }, { name: "Enabled" }, { name: "PermanentlyDisabled" }]
              }
            },
            {
              name: "--e-tag",
            ...
            },
            {
              ...
              args: {
                name: "immutability-state",
                suggestions: [{ name: "Disabled" }, { name: "Locked" }, { name: "Unlocked" }]
              }
            },
            {
              name: ["--location", "-l"],
            ...
            },
            {
              ...
              args: {
                name: "soft-delete-state",
                suggestions: [{ name: "AlwaysOn" }, { name: "Off" }, { name: "On" }]
              }
            },
            {
              name: "--tags",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "operation",
                suggestions: [{ name: "OnDemandBackup" }, { name: "Restore" }, { name: "ScheduledBackup" }]
              }
            },
            {
              name: "--resource-groups",
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Completed" }, { name: "Failed" }, { name: "InProgress" }]
              }
            },
            {
              name: "--subscriptions",
          ...
          options: [
            {
              ...
              args: {
                name: "resource-type",
                suggestions: [{ name: "Microsoft.RecoveryServices/vaults" }]
              },
              isRequired: true
            },
            {
