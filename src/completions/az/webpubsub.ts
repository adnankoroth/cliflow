// az webpubsub completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              description:
                "Set if anonymous connections are allowed for this hub. True means allow and False means deny",
              args: { name: "allow-anonymous", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--event-handler",
              description:
          ...
          options: [
            {
              ...
              args: {
                name: "key-type",
                suggestions: [{ name: "primary" }, { name: "salt" }, { name: "secondary" }]
              },
              isRequired: true
            },
            {
          ...
          options: [
            {
              ...
              args: {
                name: "allow",
                suggestions: [{ name: "ClientConnection" }, { name: "RESTAPI" }, { name: "ServerConnection" }, { name: "Trace" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "public-network", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: ["--resource-group", "-g"],
              description:
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "permission",
                    suggestions: [{ name: "joinLeaveGroup" }, { name: "sendToGroup" }]
                  },
                  isRequired: true
                },
                {
