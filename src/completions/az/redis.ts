// az redis completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "vm-size",
            suggestions: [{ name: "c0" }, { name: "c1" }, { name: "c2" }, { name: "c3" }, { name: "c4" }, { name: "c5" }, { name: "c6" }, { name: "p1" }, { name: "p2" }, { name: "p3" }, { name: "p4" }, { name: "p5" }]
          },
          isRequired: true
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "ManagedIdentity" }, { name: "SAS" }]
          }
        },
        {
          name: "--file-format",
      ...
      options: [
        {
          ...
          args: {
            name: "reboot-type",
            suggestions: [{ name: "AllNodes" }, { name: "PrimaryNode" }, { name: "SecondaryNode" }]
          },
          isRequired: true
        },
        {
