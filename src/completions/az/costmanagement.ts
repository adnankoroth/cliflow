// az costmanagement completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "timeframe",
                suggestions: [{ name: "BillingMonthToDate" }, { name: "Custom" }, { name: "MonthToDate" }, { name: "TheLastBillingMonth" }, { name: "TheLastMonth" }, { name: "WeekToDate" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "recurrence",
                suggestions: [{ name: "Annually" }, { name: "Daily" }, { name: "Monthly" }, { name: "Weekly" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "schedule-status",
                suggestions: [{ name: "Active" }, { name: "Inactive" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "type",
                suggestions: [{ name: "ActualCost" }, { name: "AmortizedCost" }, { name: "Usage" }]
              }
            }
          ]
        },
