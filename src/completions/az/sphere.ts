// az sphere completion spec for CLIFlow
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "debug-mode", suggestions: [{ name: "false" }, { name: "true" }] }
                },
                {
                  name: ["--device", "-d"],
                  description:
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "type",
                    suggestions: [{ name: "ApplicationDevelopment" }, { name: "FieldServicing" }]
                  }
                }
              ]
            },
              ...
              options: [
                {
                  ...
                  args: {
                    name: "state",
                    suggestions: [{ name: "DeviceComplete" }, { name: "Module1Complete" }]
                  },
                  isRequired: true
                },
                {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "No3rdPartyAppUpdates" }, { name: "UpdateAll" }]
              }
            },
            {
              name: ["--os-feed", "-f"],
              description: "The OS feed type to use for OS updates",
              args: { name: "os-feed", suggestions: [{ name: "Retail" }, { name: "RetailEval" }] }
            },
            {
