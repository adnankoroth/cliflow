// az sf completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "failure-action",
                suggestions: [{ name: "Manual" }, { name: "Rollback" }]
              }
            },
            {
              name: "--force-restart",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "vm-os",
                suggestions: [{ name: "UbuntuServer1604" }, { name: "WindowsServer1709" }, { name: "WindowsServer1709withContainers" }, { name: "WindowsServer1803withContainers" }, { name: "WindowsServer1809withContainers" }, { name: "WindowsServer2012R2Datacenter" }, { name: "WindowsServer2016Datacenter" }, { name: "WindowsServer2016DatacenterwithContainers" }, { name: "WindowsServer2019Datacenter" }, { name: "WindowsServer2019DatacenterwithContainers" }]
              }
            },
            {
              name: "--parameter-file",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "durability-level",
                    suggestions: [{ name: "Bronze" }, { name: "Gold" }, { name: "Silver" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "reliability-level",
                    suggestions: [{ name: "Bronze" }, { name: "Gold" }, { name: "Platinum" }, { name: "Silver" }]
                  },
                  isRequired: true
                },
                {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "upgrade-mode",
                suggestions: [{ name: "Monitored" }, { name: "UnmonitoredAuto" }]
              }
            },
            {
              name: "--upgrade-timeout",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "Wave0" }, { name: "Wave1" }, { name: "Wave2" }]
              }
            },
            {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "access", suggestions: [{ name: "allow" }, { name: "deny" }] }
                },
                {
                  name: "--description",
                ...
                },
                {
                  ...
                  args: {
                    name: "direction",
                    suggestions: [{ name: "inbound" }, { name: "outbound" }]
                  }
                },
                {
                  name: "--name",
                ...
                },
                {
                  ...
                  args: {
                    name: "protocol",
                    suggestions: [{ name: "ah" }, { name: "any" }, { name: "esp" }, { name: "http" }, { name: "https" }, { name: "icmp" }, { name: "tcp" }, { name: "udp" }]
                  }
                },
                {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "data-disk-type",
                suggestions: [{ name: "Premium_LRS" }, { name: "StandardSSD_LRS" }, { name: "Standard_LRS" }]
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "state", suggestions: [{ name: "Stateful" }, { name: "Stateless" }] },
              isRequired: true
            },
            {
              name: [
            ...
            },
            {
              ...
              args: {
                name: "default-move-cost",
                suggestions: [{ name: "High" }, { name: "Low" }, { name: "Medium" }, { name: "Zero" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "partition-scheme",
                suggestions: [{ name: "Named" }, { name: "Singleton" }, { name: "UniformInt64Range" }]
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "partition-scheme",
                suggestions: [{ name: "named" }, { name: "singleton" }, { name: "uniformInt64" }]
              }
            },
            {
              name: ["--target-replica-set-size", "--target-replica"],
