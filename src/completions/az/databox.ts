// az databox completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "DataBox" }, { name: "DataBoxCustomerDisk" }, { name: "DataBoxDisk" }, { name: "DataBoxHeavy" }]
              },
              isRequired: true
            },
            {
              ...
              args: {
                name: "transfer-type",
                suggestions: [{ name: "ExportFromAzure" }, { name: "ImportToAzure" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "kek-type",
                suggestions: [{ name: "CustomerManaged" }, { name: "MicrosoftManaged" }]
              }
            },
            {
              name: "--kek-url",
            ...
            },
            {
              ...
              args: {
                name: "transfer-configuration-type",
                suggestions: [{ name: "TransferAll" }, { name: "TransferUsingFilter" }]
              }
            },
            {
