// az scenario completion spec for CLIFlow
      ...
      options: [
        {
          ...
          args: { name: "match-rule", suggestions: [{ name: "all" }, { name: "and" }, { name: "or" }] }
        },
        {
          name: "--scope",
          description:
          ...
          args: { name: "scope", suggestions: [{ name: "all" }, { name: "command" }, { name: "scenario" }] }
        },
        {
          name: "--top",
          description:
