// az partnercenter completion spec for CLIFlow
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "type",
                    suggestions: [{ name: "AzureApplication" }, { name: "AzureConsultingService" }, { name: "AzureContainer" }, { name: "AzureDynamics365BusinessCentral" }, { name: "AzureDynamics365ForCustomerEngagement" }, { name: "AzureDynamics365ForOperations" }, { name: "AzureIoTEdgeModule" }, { name: "AzureManagedService" }, { name: "AzurePowerBIApp" }, { name: "AzurePowerBIVisual" }, { name: "AzureThirdPartyVirtualMachine" }, { name: "SoftwareAsAService" }]
                  },
                  isRequired: true
                },
                {
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "target",
                    suggestions: [{ name: "draft" }, { name: "live" }, { name: "preview" }]
                  },
                  isRequired: true
                }
              ]
                  ...
                  subcommands: [
                    {
                      ...
                      options: [
                        ...
                        },
                        {
                          ...
                          args: {
                            name: "type",
                            suggestions: [{ name: "AzureLogoLarge" }, { name: "AzureLogoMedium" }, { name: "AzureLogoSmall" }, { name: "AzureLogoWide" }, { name: "Image" }, { name: "Video" }]
                          },
                          isRequired: true
                        },
                        {
