// az k8s-extension completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "cluster-type",
            suggestions: [{ name: "appliances" }, { name: "connectedClusters" }, { name: "managedClusters" }, { name: "provisionedClusters" }]
          },
          isRequired: true
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "cluster-type",
                suggestions: [{ name: "appliances" }, { name: "connectedClusters" }, { name: "managedClusters" }]
              },
              isRequired: true
            },
            {
