// az afd completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "certificate-type",
                suggestions: [{ name: "AzureFirstPartyManagedCertificate" }, { name: "CustomerCertificate" }, { name: "ManagedCertificate" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "minimum-tls-version",
                suggestions: [{ name: "TLS10" }, { name: "TLS12" }]
              },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "name-reuse-scope",
                suggestions: [{ name: "NoReuse" }, { name: "ResourceGroupReuse" }, { name: "SubscriptionReuse" }, { name: "TenantReuse" }]
              }
            },
            {
              name: "--tags",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "granularity",
                    suggestions: [{ name: "P1D" }, { name: "PT1H" }, { name: "PT5M" }]
                  },
                  isRequired: true
                },
                {
                  ...
                  args: {
                    name: "metrics",
                    suggestions: [{ name: "clientRequestBandwidth" }, { name: "clientRequestCount" }, { name: "clientRequestTraffic" }, { name: "originRequestBandwidth" }, { name: "originRequestTraffic" }, { name: "totalLatency" }]
                  },
                  isRequired: true
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "group-by",
                    suggestions: [{ name: "cacheStatus" }, { name: "country" }, { name: "customDomain" }, { name: "httpStatusCode" }, { name: "protocol" }]
                  }
                }
              ]
            }
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "metrics",
                    suggestions: [{ name: "clientRequestCount" }, { name: "clientRequestTraffic" }, { name: "errorCount" }, { name: "hitCount" }, { name: "missCount" }, { name: "userErrorCount" }]
                  },
                  isRequired: true
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "rankings",
                    suggestions: [{ name: "browser" }, { name: "countryOrRegion" }, { name: "referrer" }, { name: "url" }, { name: "userAgent" }]
                  },
                  isRequired: true
                },
                {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "probe-protocol",
                suggestions: [{ name: "Http" }, { name: "Https" }, { name: "NotSet" }]
              },
              isRequired: true
            },
            {
              ...
              args: {
                name: "probe-request-type",
                suggestions: [{ name: "GET" }, { name: "HEAD" }, { name: "NotSet" }]
              },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "Premium_AzureFrontDoor" }, { name: "Standard_AzureFrontDoor" }]
              },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "forwarding-protocol",
                suggestions: [{ name: "HttpOnly" }, { name: "HttpsOnly" }, { name: "MatchRequest" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "query-string-caching-behavior",
                suggestions: [{ name: "IgnoreQueryString" }, { name: "IgnoreSpecifiedQueryStrings" }, { name: "IncludeSpecifiedQueryStrings" }, { name: "UseQueryString" }]
              }
            },
            {
              name: "--rule-sets",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              description:
                "Indicates whether caching is enanbled on that route",
              args: { name: "enable-caching", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
              name: "--enable-compression",
              description:
          ...
          options: [
            {
              ...
              args: {
                name: "action-name",
                suggestions: [{ name: "ModifyRequestHeader" }, { name: "ModifyResponseHeader" }, { name: "RouteConfigurationOverride" }, { name: "UrlRedirect" }, { name: "UrlRewrite" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "cache-behavior",
                suggestions: [{ name: "HonorOrigin" }, { name: "OverrideAlways" }, { name: "OverrideIfOriginMissing" }]
              }
            },
            {
              name: "--cache-duration",
            ...
            },
            {
              ...
              args: {
                name: "header-action",
                suggestions: [{ name: "Append" }, { name: "Delete" }, { name: "Overwrite" }]
              }
            },
            {
              name: "--header-name",
            ...
            },
            {
              ...
              args: {
                name: "match-processing-behavior",
                suggestions: [{ name: "Continue" }, { name: "Stop" }]
              }
            },
            {
              name: "--match-values",
            ...
            },
            {
              ...
              args: {
                name: "match-variable",
                suggestions: [{ name: "ClientPort" }, { name: "Cookies" }, { name: "HostName" }, { name: "HttpVersion" }, { name: "IsDevice" }, { name: "PostArgs" }, { name: "QueryString" }, { name: "RemoteAddress" }, { name: "RequestBody" }, { name: "RequestHeader" }, { name: "RequestMethod" }, { name: "RequestScheme" }, { name: "RequestUri" }, { name: "ServerPort" }, { name: "SocketAddr" }, { name: "SslProtocol" }, { name: "UrlFileExtension" }, { name: "UrlFileName" }, { name: "UrlPath" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "redirect-protocol",
                suggestions: [{ name: "Http" }, { name: "Https" }, { name: "MatchRequest" }]
              }
            },
            {
              name: "--redirect-type",
              ...
              args: {
                name: "redirect-type",
                suggestions: [{ name: "Found" }, { name: "Moved" }, { name: "PermanentRedirect" }, { name: "TemporaryRedirect" }]
              }
            },
            {
              name: "--selector",
            ...
            },
            {
              ...
              args: {
                name: "transforms",
                suggestions: [{ name: "Lowercase" }, { name: "RemoveNulls" }, { name: "Trim" }, { name: "Uppercase" }, { name: "UrlDecode" }, { name: "UrlEncode" }]
              }
            }
          ]
        },
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "metrics",
                    suggestions: [{ name: "clientRequestCount" }]
                  },
                  isRequired: true
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "actions",
                    suggestions: [{ name: "allow" }, { name: "block" }, { name: "log" }, { name: "redirect" }]
                  }
                },
                {
                  name: "--group-by",
                  ...
                  args: {
                    name: "group-by",
                    suggestions: [{ name: "customDomain" }, { name: "httpStatusCode" }]
                  }
                },
                {
                  name: "--rule-types",
                  ...
                  args: {
                    name: "rule-types",
                    suggestions: [{ name: "bot" }, { name: "custom" }, { name: "managed" }]
                  }
                }
              ]
            }
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "rankings",
                    suggestions: [{ name: "action" }, { name: "clientIp" }, { name: "country" }, { name: "ruleGroup" }, { name: "ruleId" }, { name: "ruleType" }, { name: "url" }, { name: "userAgent" }]
                  },
                  isRequired: true
                },
                {
