// az workloads completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "routing-preference",
                suggestions: [{ name: "Default" }, { name: "RouteAll" }]
              }
            },
            {
              name: "--tags",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "database-type", suggestions: [{ name: "DB2" }, { name: "HANA" }] }
        },
        {
          name: "--db-vm-sku",
        ...
        },
        {
          ...
          args: {
            name: "deployment-type",
            suggestions: [{ name: "SingleServer" }, { name: "ThreeTier" }]
          }
        },
        {
          name: "--environment",
          ...
          args: { name: "environment", suggestions: [{ name: "NonProd" }, { name: "Prod" }] }
        },
        {
          name: "--ids",
          description:
        ...
        },
        {
          ...
          args: {
            name: "sap-product",
            suggestions: [{ name: "ECC" }, { name: "Other" }, { name: "S4HANA" }]
          }
        },
        {
          name: "--subscription",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "db-scale-method", suggestions: [{ name: "ScaleUp" }] }
        },
        {
          name: "--deployment-type",
          description: "The deployment type. Eg: SingleServer/ThreeTier",
        ...
        },
        {
          ...
          args: {
            name: "high-availability-type",
            suggestions: [{ name: "AvailabilitySet" }, { name: "AvailabilityZone" }]
          }
        },
        {
          name: "--ids",
