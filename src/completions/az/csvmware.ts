// az csvmware completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: {
                name: "mode",
                suggestions: [{ name: "poweroff" }, { name: "reboot" }, { name: "shutdown" }, { name: "suspend" }]
              },
              isRequired: true
            },
            {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "mode",
                    suggestions: [{ name: "independent_nonpersistent" }, { name: "independent_persistent" }, { name: "persistent" }]
                  }
                },
                {
                  name: "--size",
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "adapter",
                    suggestions: [{ name: "E1000" }, { name: "E1000E" }, { name: "PCNET32" }, { name: "VMXNET" }, { name: "VMXNET2" }, { name: "VMXNET3" }]
                  }
                },
                {
                  name: "--power-on-boot",
