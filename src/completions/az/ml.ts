// az ml completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "status",
                suggestions: [{ name: "Completed" }, { name: "Failed" }, { name: "Finalizing" }, { name: "Preparing" }, { name: "Provisioning" }, { name: "Queued" }, { name: "Running" }, { name: "Starting" }]
              }
            },
            {
              name: "--subscription-id",
