// az cognitiveservices completion spec for CLIFlow
              ...
              options: [
                {
                  ...
                  args: { name: "auto-renew", suggestions: [{ name: "false" }, { name: "true" }] },
                  isRequired: true
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "hosting-model",
                    suggestions: [{ name: "ConnectedContainer" }, { name: "DisconnectedContainer" }, { name: "ProvisionedWeb" }, { name: "Web" }]
                  },
                  isRequired: true
                },
                {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "Manual" }, { name: "Standard" }]
                  }
                },
                {
                  name: ["--sku-name", "--sku"],
              ...
              options: [
                {
                  ...
                  args: { name: "key-name", suggestions: [{ name: "Key1" }, { name: "Key2" }] },
                  isRequired: true
                },
                {
                  name: ["--name", "-n"],
