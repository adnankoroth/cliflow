// az managed-cassandra completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "authentication-method",
                suggestions: [{ name: "Cassandra" }, { name: "None" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "repair-enabled", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "readwrite", suggestions: [{ name: "false" }, { name: "true" }] }
            }
          ]
        },
        {
