// az mobile-network completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "sku",
                suggestions: [{ name: "G0" }, { name: "G1" }, { name: "G10" }, { name: "G2" }, { name: "G3" }, { name: "G4" }, { name: "G5" }]
              },
              isRequired: true
            },
            {
              ...
              args: { name: "core-network-tec", suggestions: [{ name: "5GC" }, { name: "EPC" }] }
            },
            {
              name: "--identity",
              description:
