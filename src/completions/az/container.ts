// az container completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "ip-address", suggestions: [{ name: "Private" }, { name: "Public" }] }
        },
        {
          name: ["--location", "-l"],
          description:
        ...
        },
        {
          ...
          args: { name: "protocol", suggestions: [{ name: "TCP" }, { name: "UDP" }] }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "restart-policy",
            suggestions: [{ name: "Always" }, { name: "Never" }, { name: "OnFailure" }]
          }
        },
        {
          name: "--role",
