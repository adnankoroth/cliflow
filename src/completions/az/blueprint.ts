// az blueprint completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "locks-mode",
                suggestions: [{ name: "AllResourcesDoNotDelete" }, { name: "AllResourcesReadOnly" }, { name: "None" }]
              }
            },
            {
              name: ["--management-group", "-m"],
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "delete-behavior", suggestions: [{ name: "all" }, { name: "none" }] }
            },
            {
              name: ["--management-group", "-m"],
              description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "target-scope",
            suggestions: [{ name: "managementGroup" }, { name: "subscription" }]
          },
          isRequired: true
        },
        {
