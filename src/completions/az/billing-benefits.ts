// az billing-benefits completion spec for CLIFlow
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "applied-scope-type",
                suggestions: [{ name: "ManagementGroup" }, { name: "Shared" }, { name: "Single" }]
              }
            },
            {
              name: "--billing-plan",
              ...
              args: { name: "billing-plan", suggestions: [{ name: "P1M" }] }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "reserved-resource-type",
                suggestions: [{ name: "AVS" }, { name: "AppService" }, { name: "AzureDataExplorer" }, { name: "AzureFiles" }, { name: "BlockBlob" }, { name: "CosmosDb" }, { name: "DataFactory" }, { name: "Databricks" }, { name: "DedicatedHost" }, { name: "ManagedDisk" }, { name: "MariaDb" }, { name: "MySql" }, { name: "NetAppStorage" }, { name: "PostgreSql" }, { name: "RedHat" }, { name: "RedHatOsa" }, { name: "RedisCache" }, { name: "SapHana" }, { name: "SqlAzureHybridBenefit" }, { name: "SqlDataWarehouse" }, { name: "SqlDatabases" }, { name: "SqlEdge" }, { name: "SuseLinux" }, { name: "VMwareCloudSimple" }, { name: "VirtualMachineSoftware" }, { name: "VirtualMachines" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: { name: "term", suggestions: [{ name: "P1Y" }, { name: "P3Y" }, { name: "P5Y" }] }
            }
          ]
        },
        {
