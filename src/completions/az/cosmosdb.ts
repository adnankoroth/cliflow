// az cosmosdb completion spec for CLIFlow
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        ...
                        suggestions: [{ name: "autoscale" }, { name: "manual" }]
                      },
                      isRequired: true
                    }
                  ]
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "FullFidelity" }, { name: "WellDefined" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "backup-policy-type",
            suggestions: [{ name: "Continuous" }, { name: "Periodic" }]
          }
        },
        {
          ...
          args: {
            name: "backup-redundancy",
            suggestions: [{ name: "Geo" }, { name: "Local" }, { name: "Zone" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "continuous-tier",
            suggestions: [{ name: "Continuous30Days" }, { name: "Continuous7Days" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "default-consistency-level",
            suggestions: [{ name: "BoundedStaleness" }, { name: "ConsistentPrefix" }, { name: "Eventual" }, { name: "Session" }, { name: "Strong" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: { name: "enable-free-tier", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
        ...
        },
        {
          ...
          args: { name: "is-restore-request", suggestions: [{ name: "false" }, { name: "true" }] }
        },
        {
          name: "--key-uri",
        ...
        },
        {
          ...
          args: {
            name: "kind",
            suggestions: [{ name: "GlobalDocumentDB" }, { name: "MongoDB" }, { name: "Parse" }]
          }
        },
        {
          name: "--locations",
        ...
        },
        {
          ...
          args: {
            name: "network-acl-bypass",
            suggestions: [{ name: "AzureServices" }, { name: "None" }]
          }
        },
        {
        ...
        },
        {
          ...
          args: {
            name: "server-version",
            suggestions: [{ name: "3.2" }, { name: "3.6" }, { name: "4.0" }, { name: "4.2" }]
          }
        },
        {
      ...
      options: [
        {
          ...
          args: {
            name: "key-kind",
            suggestions: [{ name: "primary" }, { name: "primaryReadonly" }, { name: "secondary" }, { name: "secondaryReadonly" }]
          },
          isRequired: true
        },
        {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "type",
                suggestions: [{ name: "connection-strings" }, { name: "keys" }, { name: "read-only-keys" }]
              }
            }
          ]
        },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "shard-node-ha", suggestions: [{ name: "false" }, { name: "true" }] },
              isRequired: true
            },
            {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "type",
                suggestions: [{ name: "Microsoft.DBforPostgreSQL/serverGroupsv2" }]
              },
              isRequired: true
            }
          ]
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "operation",
                    suggestions: [{ name: "All" }, { name: "Create" }, { name: "Delete" }, { name: "Replace" }, { name: "Update" }]
                  }
                },
                {
                  name: ["--type", "-t"],
                  description: "Trigger type",
                  args: { name: "type", suggestions: [{ name: "Post" }, { name: "Pre" }] }
                }
              ]
            },
            {
