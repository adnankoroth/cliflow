// az servicebus completion spec for CLIFlow
          ...
          options: [
            {
              ...
              args: { name: "config-name", suggestions: [{ name: "$default" }] }
            },
            {
              name: "--ids",
              description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "capacity",
                suggestions: [{ name: "1" }, { name: "16" }, { name: "2" }, { name: "4" }, { name: "8" }]
              }
            },
            {
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "filter-type",
                        suggestions: [{ name: "CorrelationFilter" }, { name: "SqlFilter" }]
                      }
                    },
                    {
                      name: "--label",
