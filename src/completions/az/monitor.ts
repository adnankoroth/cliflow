// az monitor completion spec for CLIFlow
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "no-wait",
                suggestions: [{ name: "0" }, { name: "1" }, { name: "f" }, { name: "false" }, { name: "n" }, { name: "no" }, { name: "t" }, { name: "true" }, { name: "y" }, { name: "yes" }]
              }
            },
            {
              name: ["--resource-group", "-g"],
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "select",
                suggestions: [{ name: "authorization" }, { name: "caller" }, { name: "category" }, { name: "claims" }, { name: "correlationId" }, { name: "description" }, { name: "eventDataId" }, { name: "eventName" }, { name: "eventTimestamp" }, { name: "httpRequest" }, { name: "id" }, { name: "level" }, { name: "operationId" }, { name: "operationName" }, { name: "properties" }, { name: "resourceGroupName" }, { name: "resourceId" }, { name: "resourceProviderName" }, { name: "resourceType" }, { name: "status" }, { name: "subStatus" }, { name: "submissionTimestamp" }, { name: "subscriptionId" }, { name: "tenantId" }]
              }
            },
            {
              name: "--start-time",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "rule-type",
                suggestions: [{ name: "AddActionGroups" }, { name: "RemoveAllActionGroups" }]
              },
              isRequired: true
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "schedule-recurrence-2-type",
                suggestions: [{ name: "Daily" }, { name: "Monthly" }, { name: "Weekly" }]
              }
            },
            {
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "record-types",
                        suggestions: [{ name: "Availability" }, { name: "Event" }, { name: "Exceptions" }, { name: "Messages" }, { name: "Metrics" }, { name: "PageViewPerformance" }, { name: "PageViews" }, { name: "PerformanceCounters" }, { name: "Rdd" }, { name: "Requests" }]
                      },
                      isRequired: true
                    },
                    {
                    ...
                    },
                    {
                      ...
                      args: { name: "dest-type", suggestions: [{ name: "Blob" }] }
                    },
                    {
                      name: "--is-enabled",
                      description:
              ...
              options: [
                {
                  ...
                  args: {
                    name: "type",
                    suggestions: [{ name: "$all" }, { name: "availabilityResults" }, { name: "browserTimings" }, { name: "customEvents" }, { name: "customMetrics" }, { name: "dependencies" }, { name: "exceptions" }, { name: "pageViews" }, { name: "performanceCounters" }, { name: "requests" }, { name: "traces" }]
                  },
                  isRequired: true
                },
                {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "kind", suggestions: [{ name: "multistep" }, { name: "ping" }] }
                },
                {
                  name: ["--location", "-l"],
                  description:
                ...
                },
                {
                  ...
                  args: { name: "ssl-check", suggestions: [{ name: "false" }, { name: "true" }] }
                },
                {
                ...
                },
                {
                  ...
                  args: {
                    name: "web-test-kind",
                    suggestions: [{ name: "multistep" }, { name: "ping" }, { name: "standard" }]
                  }
                }
              ]
            },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "disabled", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "scale-mode",
                suggestions: [{ name: "Disabled" }, { name: "Enabled" }, { name: "ForecastOnly" }]
              }
            },
            {
              name: "--tags",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "types", suggestions: [{ name: "metricsAlert" }] }
        }
      ]
    },
    {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "kind", suggestions: [{ name: "Linux" }, { name: "Windows" }] }
                },
                {
                  name: ["--location", "-l"],
                  description:
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "streams",
                        suggestions: [{ name: "Microsoft-Event" }, { name: "Microsoft-InsightsMetrics" }, { name: "Microsoft-Perf" }, { name: "Microsoft-Syslog" }, { name: "Microsoft-WindowsEvent" }]
                      },
                      isRequired: true
                    },
                    {
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "streams",
                        suggestions: [{ name: "Microsoft-InsightsMetrics" }, { name: "Microsoft-Perf" }]
                      },
                      isRequired: true
                    },
                    {
                  ...
                  options: [
                    {
                      ...
                      args: {
                        name: "facility-names",
                        suggestions: [{ name: "*" }, { name: "auth" }, { name: "authpriv" }, { name: "cron" }, { name: "daemon" }, { name: "kern" }, { name: "local0" }, { name: "local1" }, { name: "local2" }, { name: "local3" }, { name: "local4" }, { name: "local5" }, { name: "local6" }, { name: "local7" }, { name: "lpr" }, { name: "mail" }, { name: "mark" }, { name: "news" }, { name: "syslog" }, { name: "user" }, { name: "uucp" }]
                      },
                      isRequired: true
                    },
                    {
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "streams",
                        suggestions: [{ name: "Microsoft-Syslog" }]
                      },
                      isRequired: true
                    },
                    {
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "log-levels",
                        suggestions: [{ name: "*" }, { name: "Alert" }, { name: "Critical" }, { name: "Debug" }, { name: "Emergency" }, { name: "Error" }, { name: "Info" }, { name: "Notice" }, { name: "Warning" }]
                      }
                    },
                    {
                      name: ["--resource-group", "-g"],
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "streams",
                        suggestions: [{ name: "Microsoft-Event" }, { name: "Microsoft-WindowsEvent" }]
                      },
                      isRequired: true
                    },
                    {
          ...
          subcommands: [
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "billing-type",
                    suggestions: [{ name: "Cluster" }, { name: "Workspaces" }]
                  }
                },
                {
                  name: "--identity-type",
                  ...
                  args: {
                    name: "identity-type",
                    suggestions: [{ name: "None" }, { name: "SystemAssigned" }, { name: "UserAssigned" }]
                  }
                },
                {
                  name: "--key-name",
                ...
                },
                {
                  ...
                  args: {
                    name: "sku-capacity",
                    suggestions: [{ name: "1000" }, { name: "2000" }, { name: "500" }, { name: "5000" }]
                  }
                },
                {
                  name: "--sku-name",
                  ...
                  args: {
                    name: "sku-name",
                    suggestions: [{ name: "CapacityReservation" }]
                  }
                },
                {
                  name: "--tags",
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "100" }, { name: "1000" }, { name: "200" }, { name: "2000" }, { name: "300" }, { name: "400" }, { name: "500" }, { name: "5000" }]
                  }
                },
                {
                  name: "--ingestion-access",
                ...
                },
                {
                  ...
                  args: {
                    name: "sku-name",
                    suggestions: [{ name: "CapacityReservation" }, { name: "Free" }, { name: "LACluster" }, { name: "PerGB2018" }, { name: "PerNode" }, { name: "Premium" }, { name: "Standalone" }, { name: "Standard" }]
                  }
                },
                {
                  name: "--tags",
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "type",
                        suggestions: [{ name: "Alerts" }, { name: "AzureWatson" }, { name: "CustomLogs" }, { name: "Ingestion" }, { name: "Query" }]
                      },
                      isRequired: true
                    },
                    {
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "plan",
                        suggestions: [{ name: "Analytics" }, { name: "Basic" }]
                      }
                    },
                    {
                      name: "--retention-time",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "aggregation",
                suggestions: [{ name: "Average" }, { name: "Count" }, { name: "Maximum" }, { name: "Minimum" }, { name: "None" }, { name: "Total" }]
              }
            },
            {
              name: "--dimension",
                  ...
                  options: [
                    {
                      ...
                      args: {
                        name: "aggregation",
                        suggestions: [{ name: "Average" }, { name: "Count" }, { name: "Maximum" }, { name: "Minimum" }, { name: "Total" }]
                      },
                      isRequired: true
                    },
                    {
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "operator",
                        suggestions: [{ name: "Equals" }, { name: "GreaterOrLessThan" }, { name: "GreaterThan" }, { name: "GreaterThanOrEqual" }, { name: "LessThan" }, { name: "LessThanOrEqual" }, { name: "NotEquals" }]
                      },
                      isRequired: true
                    },
                    {
                      ...
                      args: {
                        name: "type",
                        suggestions: [{ name: "dynamic" }, { name: "static" }]
                      },
                      isRequired: true
                    },
                    {
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "sensitivity",
                        suggestions: [{ name: "High" }, { name: "Low" }, { name: "Medium" }]
                      }
                    },
                    {
                      name: "--since",
              ...
              subcommands: [
                {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        name: "operator",
                        suggestions: [{ name: "Exclude" }, { name: "Include" }]
                      }
                    }
                  ]
                }
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "auto-mitigate", suggestions: [{ name: "false" }, { name: "true" }] }
            },
            {
