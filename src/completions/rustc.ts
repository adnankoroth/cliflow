// rustc completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "edition",
        suggestions: [{ name: "2015" }, { name: "2018" }, { name: "2021" }]
      }
    },
    {
      name: "--emit",
    ...
    },
    {
      ...
      args: {
        name: "format",
        suggestions: [{ name: "human" }, { name: "json" }, { name: "short" }]
      }
    },
    {
      name: "--color",
      ...
      args: {
        name: "color",
        suggestions: [{ name: "auto" }, { name: "always" }, { name: "never" }]
      }
    }
  ]
};
