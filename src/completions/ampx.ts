// ampx completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "format", suggestions: [{ name: "json" }, { name: "dart" }] }
        },
        {
          name: "--outputs-version",
          description: "Version of the configuration",
          args: { name: "version", suggestions: [{ name: "0" }, { name: "1" }] }
        },
        {
          name: "--profile",
        ...
        },
        {
          ...
          args: { name: "boolean", suggestions: [{ name: "true" }, { name: "false" }] }
        },
        {
          name: "--logs-filter",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "format",
                suggestions: [{ name: "modelgen" }, { name: "graphql-codegen" }, { name: "introspection" }]
              }
            },
            {
              name: "--model-target",
              ...
              args: {
                name: "target",
                suggestions: [{ name: "java" }, { name: "swift" }, { name: "javascript" }, { name: "typescript" }, { name: "dart" }]
              }
            },
            {
              ...
              args: {
                name: "target",
                suggestions: [{ name: "javascript" }, { name: "graphql" }, { name: "flow" }, { name: "typescript" }, { name: "angular" }]
              }
            },
            {
              name: "--type-target",
              ...
              args: {
                name: "target",
                suggestions: [{ name: "json" }, { name: "swift" }, { name: "typescript" }, { name: "flow" }, { name: "scala" }, { name: "flow-modern" }, { name: "angular" }]
              }
            },
            {
              name: "--all",
