// gcloud kms completion spec for CLIFlow
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "VERBOSITY",
            description: "String",
            suggestions: [{ name: "debug" }, { name: "info" }, { name: "warning" }, { name: "error" }, { name: "critical" }, { name: "none" }]
          }
        }
      ]
    },
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "IMPORT_METHOD",
                description: "String",
                suggestions: [{ name: "rsa-oaep-3072-sha1-aes-256" }, { name: "rsa-oaep-4096-sha1-aes-256" }]
              },
              priority: 100
            },
            {
            ...
            },
            {
              ...
              args: {
                ...
                description: "String",
                suggestions: [{ name: "software" }, { name: "hsm" }]
              },
              priority: 100
            },
            {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                description: "String",
                suggestions: [{ name: "ec-sign-p256-sha256" }, { name: "ec-sign-p384-sha384" }, { name: "external-symmetric-encryption" }, { name: "google-symmetric-encryption" }, { name: "rsa-decrypt-oaep-2048-sha256" }, { name: "rsa-decrypt-oaep-3072-sha256" }, { name: "rsa-decrypt-oaep-4096-sha256" }, { name: "rsa-decrypt-oaep-4096-sha512" }, { name: "rsa-sign-pkcs1-2048-sha256" }, { name: "rsa-sign-pkcs1-3072-sha256" }, { name: "rsa-sign-pkcs1-4096-sha256" }, { name: "rsa-sign-pkcs1-4096-sha512" }, { name: "rsa-sign-pss-2048-sha256" }, { name: "rsa-sign-pss-3072-sha256" }, { name: "rsa-sign-pss-4096-sha256" }, { name: "rsa-sign-pss-4096-sha512" }]
              }
            },
            {
              name: "--flags-file",
            ...
            },
            {
              ...
              args: {
                name: "PROTECTION_LEVEL",
                description: "String",
                suggestions: [{ name: "software" }, { name: "hsm" }, { name: "external" }]
              }
            },
            {
              name: "--purpose",
              ...
              args: {
                name: "PURPOSE",
                description: "String",
                suggestions: [{ name: "asymmetric-encryption" }, { name: "asymmetric-signing" }, { name: "encryption" }]
              },
              priority: 100
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "ALGORITHM",
                    description: "String",
                    suggestions: [{ name: "ec-sign-p256-sha256" }, { name: "ec-sign-p384-sha384" }, { name: "google-symmetric-encryption" }, { name: "rsa-decrypt-oaep-2048-sha256" }, { name: "rsa-decrypt-oaep-3072-sha256" }, { name: "rsa-decrypt-oaep-4096-sha256" }, { name: "rsa-decrypt-oaep-4096-sha512" }, { name: "rsa-sign-pkcs1-2048-sha256" }, { name: "rsa-sign-pkcs1-3072-sha256" }, { name: "rsa-sign-pkcs1-4096-sha256" }, { name: "rsa-sign-pkcs1-4096-sha512" }, { name: "rsa-sign-pss-2048-sha256" }, { name: "rsa-sign-pss-3072-sha256" }, { name: "rsa-sign-pss-4096-sha256" }, { name: "rsa-sign-pss-4096-sha512" }]
                  },
                  priority: 100
                },
                {
