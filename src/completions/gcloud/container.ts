// gcloud container completion spec for CLIFlow
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      args: {
                        ...
                        description: "String",
                        suggestions: [{ name: "ec-sign-p256-sha256" }, { name: "ec-sign-p384-sha384" }, { name: "ec-sign-p521-sha512" }, { name: "ecdsa-p256-sha256" }, { name: "ecdsa-p384-sha384" }, { name: "ecdsa-p521-sha512" }, { name: "rsa-pss-2048-sha256" }, { name: "rsa-pss-3072-sha256" }, { name: "rsa-pss-4096-sha256" }, { name: "rsa-pss-4096-sha512" }, { name: "rsa-sign-pkcs1-2048-sha256" }, { name: "rsa-sign-pkcs1-3072-sha256" }, { name: "rsa-sign-pkcs1-4096-sha256" }, { name: "rsa-sign-pkcs1-4096-sha512" }]
                      },
                      priority: 100
                    },
                    {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "DISK_TYPE",
                description: "String",
                suggestions: [{ name: "pd-standard" }, { name: "pd-ssd" }, { name: "pd-balanced" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "CHANNEL",
                description: "String",
                suggestions: [{ name: "None" }, { name: "rapid" }, { name: "regular" }, { name: "stable" }]
              }
            },
            {
              name: "--reservation",
            ...
            },
            {
              ...
              args: {
                ...
                description: "String",
                suggestions: [{ name: "any" }, { name: "none" }, { name: "specific" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "GCE_METADATA" }, { name: "GKE_METADATA" }]
              }
            },
            {
              name: "--workload-pool",
