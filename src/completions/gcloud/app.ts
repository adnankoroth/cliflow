// gcloud app completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "LEVEL",
                description: "String",
                suggestions: [{ name: "critical" }, { name: "error" }, { name: "warning" }, { name: "info" }, { name: "debug" }, { name: "any" }]
              }
            },
            {
              name: "--limit",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "SPLIT_BY",
                description: "String",
                suggestions: [{ name: "cookie" }, { name: "ip" }, { name: "random" }]
              }
            },
            {
              name: "--splits",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "INGRESS",
                description: "String",
                suggestions: [{ name: "all" }, { name: "internal-only" }, { name: "internal-and-cloud-load-balancing" }]
              },
              priority: 100
            },
            {
