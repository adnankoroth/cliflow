// gcloud sql completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                description: "String",
                suggestions: [{ name: "MYSQL_5_6" }, { name: "MYSQL_5_7" }, { name: "MYSQL_8_0" }, { name: "POSTGRES_9_6" }, { name: "POSTGRES_10" }, { name: "POSTGRES_11" }, { name: "POSTGRES_12" }, { name: "POSTGRES_13" }, { name: "SQLSERVER_2017_EXPRESS" }, { name: "SQLSERVER_2017_WEB" }, { name: "SQLSERVER_2017_STANDARD" }, { name: "SQLSERVER_2017_ENTERPRISE" }]
              }
            },
            {
              name: "--filter",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "always" }, { name: "never" }, { name: "on-demand" }]
              }
            },
            {
              name: "--assign-ip",
            ...
            },
            {
              ...
              args: {
                ...
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: [{ name: "regional" }, { name: "zonal" }]
              }
            },
            {
              name: "--backup",
            ...
            },
            {
              ...
              args: {
                ...
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: [{ name: "preview" }, { name: "production" }]
              }
            },
            {
              ...
              args: {
                ...
                description: "Googlecloudsdk.calliope.arg_parsers:Parse",
                suggestions: [{ name: "SUN" }, { name: "MON" }, { name: "TUE" }, { name: "WED" }, { name: "THU" }, { name: "FRI" }, { name: "SAT" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "REPLICA_TYPE",
                description: "String",
                suggestions: [{ name: "READ" }, { name: "FAILOVER" }]
              }
            },
            {
              name: "--replication",
              ...
              args: {
                name: "REPLICATION",
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: [{ name: "synchronous" }, { name: "asynchronous" }]
              }
            },
            {
              name: "--require-ssl",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "PRICING_PLAN",
                description: "String",
                suggestions: [{ name: "PER_USE" }, { name: "PACKAGE" }]
              }
            },
            {
              name: "--project",
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            description: "String",
            suggestions: [{ name: "IMMEDIATE" }, { name: "NEXT_AVAILABLE_WINDOW" }, { name: "SPECIFIC_TIME" }]
          },
          priority: 100
        },
        {
