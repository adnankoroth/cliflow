// gcloud ml completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "html" }, { name: "plain-text" }]
              }
            },
            {
              name: "--encoding-type",
              ...
              args: {
                ...
                description:
                  "Googlecloudsdk.command_lib.util.apis.arg_utils:EnumNameToChoice",
                suggestions: [{ name: "none" }, { name: "utf16" }, { name: "utf32" }, { name: "utf8" }]
              }
            },
            {
              name: "--flags-file",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                description:
                  "Googlecloudsdk.command_lib.util.apis.arg_utils:EnumNameToChoice",
                suggestions: [{ name: "amr" }, { name: "amr-wb" }, { name: "encoding-unspecified" }, { name: "flac" }, { name: "linear16" }, { name: "mulaw" }, { name: "ogg-opus" }, { name: "speex-with-header-byte" }]
              }
            },
            {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "REGION",
                description: "String",
                suggestions: [{ name: "asia-east1" }, { name: "europe-west1" }, { name: "us-east1" }, { name: "us-west1" }]
              }
            },
            {
              name: "--segments",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                description:
                  "Googlecloudsdk.command_lib.util.apis.arg_utils:EnumNameToChoice",
                suggestions: [{ name: "frame" }, { name: "shot" }, { name: "shot-and-frame" }]
              }
            },
            {
              name: "--flags-file",
