// gcloud dns completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "nsec" }, { name: "nsec3" }]
              }
            },
            {
              name: "--description",
            ...
            },
            {
              ...
              args: {
                name: "DNSSEC_STATE",
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: [{ name: "off" }, { name: "on" }, { name: "transfer" }]
              }
            },
            {
              name: "--flags-file",
            ...
            },
            {
              ...
              args: {
                name: "KSK_ALGORITHM",
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: [{ name: "ecdsap256sha256" }, { name: "ecdsap384sha384" }, { name: "rsasha1" }, { name: "rsasha256" }, { name: "rsasha512" }]
              }
            },
            {
              name: "--ksk-key-length",
            ...
            },
            {
              ...
              args: {
                name: "VISIBILITY",
                description: "String",
                suggestions: [{ name: "public" }, { name: "private" }]
              }
            },
            {
              name: "--zsk-algorithm",
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "SORT_ORDER",
                    description: "String",
                    suggestions: [{ name: "ascending" }, { name: "descending" }]
                  }
                },
                {
                  name: "--trace-token",
