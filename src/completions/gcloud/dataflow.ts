// gcloud dataflow completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "SDK_LANGUAGE",
                description: "String",
                suggestions: [{ name: "JAVA" }, { name: "PYTHON" }]
              },
              priority: 100
            },
            {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "STATUS",
                description: "String",
                suggestions: [{ name: "active" }, { name: "all" }, { name: "terminated" }]
              }
            },
            {
              name: "--trace-token",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                description: "String",
                suggestions: [{ name: "write-empty" }, { name: "write-truncate" }, { name: "write-append" }]
              }
            },
            {
              name: "--billing-project",
            ...
            },
            {
              ...
              args: {
                ...
                description: "String",
                suggestions: [{ name: "create-if-not-found" }, { name: "fail-if-not-found" }]
              }
            },
            {
              name: "--pubsub-project",
