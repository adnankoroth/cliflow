// gcloud logging completion spec for CLIFlow
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "desc" }, { name: "asc" }]
          }
        },
        {
          name: "--organization",
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "SEVERITY",
            description: "String",
            suggestions: [{ name: "DEFAULT" }, { name: "DEBUG" }, { name: "INFO" }, { name: "NOTICE" }, { name: "WARNING" }, { name: "ERROR" }, { name: "CRITICAL" }, { name: "ALERT" }, { name: "EMERGENCY" }]
          }
        },
        {
          name: "--trace-token",
