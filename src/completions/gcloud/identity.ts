// gcloud identity completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "empty" }, { name: "initial-group-config-unspecified" }, { name: "with-initial-owner" }]
              }
            }
          ],
          args: {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    description:
                      "Googlecloudsdk.command_lib.util.apis.arg_utils:EnumNameToChoice",
                    suggestions: [{ name: "basic" }, { name: "full" }]
                  }
                }
              ]
            },
