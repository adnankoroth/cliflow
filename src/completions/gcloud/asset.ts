// gcloud asset completion spec for CLIFlow
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            description: "String",
            suggestions: [{ name: "PARTITION_KEY_UNSPECIFIED" }, { name: "REQUEST_TIME" }]
          }
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "CONTENT_TYPE",
            description: "String",
            suggestions: [{ name: "resource" }, { name: "iam-policy" }, { name: "org-policy" }, { name: "access-policy" }, { name: "os-inventory" }]
          }
        },
        {
          name: "--flags-file",
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "read-time" }, { name: "request-time" }]
          }
        },
        {
          name: "--per-asset-type",
