// gcloud meta completion spec for CLIFlow
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "MODE",
            description: "String",
            suggestions: [{ name: "ipdb" }, { name: "pdb" }, { name: "pudb" }, { name: "python" }]
          }
        },
        {
          name: "--project",
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "STYLE",
            description: "String",
            suggestions: [{ name: "devsite" }, { name: "html" }, { name: "linter" }, { name: "man" }, { name: "markdown" }, { name: "text" }]
          }
        },
        {
          name: "--trace-token",
