// gcloud functions completion spec for CLIFlow
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "private-ranges-only" }, { name: "all" }]
          }
        },
        {
          name: "--entry-point",
        ...
        },
        {
          ...
          args: {
            ...
            description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
            suggestions: [{ name: "all" }, { name: "internal-only" }, { name: "internal-and-gclb" }]
          }
        },
        {
          name: "--log-http",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "MIN_LOG_LEVEL",
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: [{ name: "debug" }, { name: "info" }, { name: "error" }]
              }
            },
            {
              name: "--page-size",
