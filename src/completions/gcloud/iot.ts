// gcloud iot completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "association-and-device-auth-token" }, { name: "association-only" }, { name: "device-auth-token-only" }]
              }
            },
            {
              name: "--billing-project",
            ...
            },
            {
              ...
              args: {
                name: "DEVICE_TYPE",
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: [{ name: "gateway" }, { name: "non-gateway" }]
              }
            },
            {
              name: "--flags-file",
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "debug" }, { name: "error" }, { name: "info" }, { name: "none" }]
              }
            },
            {
              name: "--metadata",
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "es256" }, { name: "es256-pem" }, { name: "es256-x509-pem" }, { name: "rs256" }, { name: "rsa-pem" }, { name: "rsa-x509-pem" }]
                  },
                  priority: 100
                },
                {
