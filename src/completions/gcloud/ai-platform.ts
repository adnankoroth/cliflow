// gcloud ai-platform completion spec for CLIFlow
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    suggestions: [{ name: "text" }, { name: "tf-record" }, { name: "tf-record-gzip" }]
                  },
                  priority: 100
                },
                {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    ...
                    description:
                      "Googlecloudsdk.calliope.base:_ChoiceValueType",
                    suggestions: [{ name: "basic" }, { name: "basic-gpu" }, { name: "basic-tpu" }, { name: "custom" }, { name: "premium-1" }, { name: "standard-1" }]
                  }
                },
                {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "scikit-learn" }, { name: "tensorflow" }, { name: "xgboost" }]
              }
            },
            {
              name: "--help",
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "REGION",
                description: "String",
                suggestions: [{ name: "asia-east1" }, { name: "asia-northeast1" }, { name: "asia-southeast1" }, { name: "australia-southeast1" }, { name: "europe-west1" }, { name: "europe-west2" }, { name: "europe-west3" }, { name: "europe-west4" }, { name: "northamerica-northeast1" }, { name: "us-central1" }, { name: "us-east1" }, { name: "us-east4" }, { name: "us-west1" }]
              }
            },
            {
              name: "--role",
