// sqlmesh completion spec for CLIFlow
      ...
      options: [
        {
          ...
          args: {
            name: "template",
            suggestions: [{ name: "airflow" }, { name: "dbt" }, { name: "dlt" }, { name: "default" }, { name: "empty" }]
          }
        },
        {
          name: "--dlt-pipeline",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "mode",
            suggestions: [{ name: "upper" }, { name: "lower" }]
          }
        },
        {
          name: "--leading-comma",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "mode",
            suggestions: [{ name: "ide" }, { name: "catalog" }, { name: "docs" }, { name: "plan" }],
            default: "ide"
          }
        }
      ]
