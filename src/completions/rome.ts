// rome completion spec for CLIFlow
  ...
  options: [
    {
      ...
      args: {
        name: "mode",
        suggestions: [{ name: "off" }, { name: "force" }]
      }
    },
    {
      name: "--use-server",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "style",
            suggestions: [{ name: "tabs" }, { name: "space" }]
          }
        },
        {
          name: "--indent-size",
        ...
        },
        {
          ...
          args: {
            name: "style",
            suggestions: [{ name: "single" }, { name: "double" }]
          }
        },
        {
          ...
          args: {
            name: "property",
            suggestions: [{ name: "as-needed" }, { name: "preserve" }]
          }
        },
        {
          name: "--trailing-comma",
          ...
          args: {
            name: "trailing",
            suggestions: [{ name: "all" }, { name: "es5" }, { name: "none" }]
          }
        },
        {
          name: "--semicolons",
          ...
          args: {
            name: "rule",
            suggestions: [{ name: "always" }, { name: "as-needed" }]
          }
        }
      ]
    },
