// lpass completion spec for CLIFlow
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "color",
            suggestions: [{ name: "auto" }, { name: "never" }, { name: "always" }],
            isOptional: true,
            default: "auto"
          }
        }
      ...
      options: [
        {
          ...
          args: {
            name: "sync",
            suggestions: [{ name: "auto" }, { name: "now" }, { name: "no" }],
            isOptional: true,
            default: "auto"
          }
        },
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "amex" }, { name: "bank" }, { name: "credit" }, { name: "database" }, { name: "drivers_license" }, { name: "email" }, { name: "health_insurance" }, { name: "im" }, { name: "mastercard" }, { name: "membership" }, { name: "passport" }, { name: "server" }, { name: "software_license" }, { name: "ssh_key" }, { name: "ssn" }, { name: "visa" }, { name: "wifi" }]
          }
        }
      ],
      args: {
