// micro completion spec for CLIFlow
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { CompletionSpec, Subcommand, Option, Suggestion } from '../types.js';

const boolArgDefaultFalse= {
  name: "bool",
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        ...
        description: "Seconds",
        default: "0",
        suggestions: [{ name: "0" }, { name: "60" }, { name: "120" }, { name: "300" }, { name: "600" }, { name: "1800" }]
      }
    },
    {
      name: "--autosu",
    ...
    },
    {
      ...
      args: {
        ...
        template: "folders",
        suggestions: [{ name: "~/.config/micro.backups" }]
      }
    },
    {
      name: "--basename",
    ...
    },
    {
      ...
      args: {
        name: "encoding",
        default: "utf-8",
        suggestions: [{ name: "utf-8" }], // https://encoding.spec.whatwg.org/#encodings
      }
    },
    {
      name: "--eofnewline",
    ...
    },
    {
      ...
      args: {
        name: "format",
        default: "unix",
        suggestions: [{ name: "unix" }, { name: "dos" }]
      }
    },
    {
      name: "--filetype",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "https://raw.githubusercontent.com/micro-editor/plugin-channel/master/channel.json" }]
      }
    },
    {
      name: "--pluginrepos",
    ...
    },
    {
      ...
      args: {
        name: "margin",
        default: "3",
        suggestions: [{ name: "0" }, { name: "1" }, { name: "2" }, { name: "3" }, { name: "5" }, { name: "10" }]
      }
    },
    {
      name: "--scrollspeed",
    ...
    },
    {
      ...
      args: {
        name: "command",
        default: "sudo",
        suggestions: [{ name: "sudo" }, { name: "doas" }]
      }
    },
    {
      name: "--syntax",
    ...
    },
    {
      ...
      args: {
        name: "size",
        default: "4",
        suggestions: [{ name: "2" }, { name: "4" }, { name: "8" }, { name: "16" }]
      }
    },
    {
      name: "--tabstospaces",
