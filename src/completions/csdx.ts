// csdx completion spec for CLIFlow
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "module",
            suggestions: [{ name: "assets" }, { name: "content-types" }, { name: "entries" }, { name: "environments" }, { name: "extensions" }, { name: "global-fields" }, { name: "labels" }, { name: "locales" }, { name: "webhooks" }, { name: "workflows" }]
          }
        },
        {
          name: "--content-types",
