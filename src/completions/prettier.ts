// prettier completion spec for CLIFlow
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "mode",
        default: "always",
        suggestions: [{ name: "always" }, { name: "avoid" }]
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "mode",
        default: "auto",
        suggestions: [{ name: "auto" }, { name: "off" }]
      }
    },
    {
      name: "--end-of-line",
      ...
      args: {
        name: "choice",
        default: "lf",
        suggestions: [{ name: "lf" }, { name: "crlf" }, { name: "cr" }, { name: "auto" }]
      }
    },
    {
      ...
      args: {
        name: "choice",
        default: "css",
        suggestions: [{ name: "css" }, { name: "strict" }, { name: "ignore" }]
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "parser",
        suggestions: [{ name: "flow" }, { name: "babel" }, { name: "babel-flow" }, { name: "babel-ts" }, { name: "typescript" }, { name: "espree" }, { name: "meriyah" }, { name: "css" }, { name: "less" }, { name: "scss" }, { name: "json" }, { name: "json5" }, { name: "json-stringify" }, { name: "graphql" }, { name: "markdown" }, { name: "mdx" }, { name: "vue" }, { name: "yaml" }, { name: "html" }, { name: "angular" }, { name: "lwc" }]
      }
    },
    {
      name: "--print-width",
    ...
    },
    {
      ...
      args: {
        default: "preserve",
        suggestions: [{ name: "always" }, { name: "never" }, { name: "preserve" }]
      }
    },
    {
      name: "--quote-props",
      ...
      args: {
        name: "when",
        default: "as-needed",
        suggestions: [{ name: "as-needed" }, { name: "consistent" }, { name: "preserve" }]
      }
    },
    {
      name: "--no-semi",
    ...
    },
    {
      ...
      args: {
        name: "type",
        default: "es5",
        suggestions: [{ name: "es5" }, { name: "none" }, { name: "all" }]
      }
    },
    {
      name: "--use-tabs",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "cli-override" }, { name: "file-override" }, { name: "prefer-file" }]
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "level",
        default: "log",
        suggestions: [{ name: "silent" }, { name: "error" }, { name: "warn" }, { name: "log" }, { name: "debug" }]
      }
    },
    {
      name: "--require-pragma",
