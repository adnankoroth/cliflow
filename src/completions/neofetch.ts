// neofetch completion spec for CLIFlow
...
const infoLines = {
  ...
  suggestions: [{ name: "os" }, { name: "host" }, { name: "kernel" }, { name: "uptime" }, { name: "packages" }, { name: "shell" }, { name: "term" }, { name: "cpu" }, { name: "gpu" }, { name: "memory" }, { name: "disk" }, { name: "battery" }, { name: "resolution" }, { name: "wm" }, { name: "de" }, { name: "theme" }, { name: "wm_theme" }, { name: "icons" }]
};
...
const onOffTiny= {
  name: "on/off",
  suggestions: [{ name: "on" }, { name: "off" }, { name: "tiny" }]
};
...
const bar= {
  name: "mode",
  suggestions: [{ name: "bar" }, { name: "infobar" }, { name: "barinfo" }, { name: "off" }]
};
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "type",
        suggestions: [{ name: "current" }, { name: "min" }, { name: "bios" }, { name: "scaling_current" }, { name: "scaling_min" }, { name: "scaling_max" }]
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "type",
        suggestions: [{ name: "logical" }, { name: "physical" }, { name: "off" }]
      }
    },
    {
      name: "--cpu_speed",
    ...
    },
    {
      ...
      args: {
        name: "unit/off",
        suggestions: [{ name: "C" }, { name: "F" }, { name: "off" }]
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "type",
        suggestions: [{ name: "all" }, { name: "dedicated" }, { name: "integrated" }]
      }
    },
    {
      name: "--de_version",
    ...
    },
    {
      ...
      args: {
        name: "disk",
        suggestions: [{ name: "/dev/sd" }, { name: "/dev/nvme" }, { name: "/dev/mmcblk" }, { name: "/dev/mapper" }, { name: "/mnt" }, { name: "/run/media" }]
      },
    ...
    },
    {
      ...
      args: {
        name: "type",
        suggestions: [{ name: "name" }, { name: "mount" }, { name: "dir" }, { name: "none" }]
      }
    },
    {
      name: "--disk_percent",
    ...
    },
    {
      ...
      args: {
        name: "unit",
        suggestions: [{ name: "kib" }, { name: "mib" }, { name: "gib" }]
      }
    },
    {
      name: "--colors",
    ...
    },
    {
      ...
      args: {
        name: "backend",
        suggestions: [{ name: "ascii" }, { name: "caca" }, { name: "chafa" }, { name: "jp2a" }, { name: "iterm2" }, { name: "off" }, { name: "pixterm" }, { name: "pot" }, { name: "sixel" }, { name: "termpix" }, { name: "tycat" }, { name: "w3m" }, { name: "kitty" }]
      }
    },
    {
      name: "--source",
      ...
      args: {
        name: "source",
        suggestions: [{ name: "auto" }, { name: "ascii" }, { name: "wallpaper" }],
        template: "filepaths"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "mode",
        suggestions: [{ name: "normal" }, { name: "fit" }, { name: "fill" }]
      }
    },
    {
      name: "--crop_offset",
      ...
      args: {
        name: "offset",
        suggestions: [{ name: "northwest" }, { name: "north" }, { name: "northeast" }]
      }
    },
    {
      name: "--xoffset",
