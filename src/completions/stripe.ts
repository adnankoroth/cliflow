// stripe completion spec for CLIFlow
...
const globalOptions= [
  ...
  },
  {
    ...
    args: {
      name: "setting",
      suggestions: [{ name: "on" }, { name: "off" }, { name: "auto" }]
    }
  },
  {
    name: "--config",
  ...
  },
  {
    ...
    args: {
      name: "level",
      suggestions: [{ name: "info" }, { name: "debug" }, { name: "warn" }, { name: "error" }]
    }
  },
  {
    name: ["-v", "--version"],
...
const completionSpec= {
  ...
  subcommands: [
      ...
      options: [
        {
          ...
          args: {
            ...
            suggestions: [{ name: "zsh" }, { name: "bash" }]
          }
        }
              ]
    },
    ...
    },
    {
      ...
      args: {
        name: "shortcut",
        suggestions: [{ name: "api" }, { name: "apiref" }, { name: "cliref" }, { name: "dashboard" }, { name: "dashboard/apikeys" }, { name: "dashboard/atlas" }, { name: "dashboard/balance" }, { name: "dashboard/billing" }, { name: "dashboard/connect" }, { name: "dashboard/connect/accounts" }, { name: "dashboard/connect/collected" }, { name: "dashboard/connect/transfers" }, { name: "dashboard/coupons" }, { name: "dashboard/customers" }, { name: "dashboard/developers" }, { name: "dashboard/disputes" }, { name: "dashboard/events" }, { name: "dashboard/invoices" }, { name: "dashboard/logs" }, { name: "dashboard/orders" }, { name: "dashboard/orders/products" }, { name: "dashboard/payments" }, { name: "dashboard/radar" }, { name: "dashboard/radar/list" }, { name: "dashboard/radar/reviews" }, { name: "dashboard/radar/rules" }, { name: "dashboard/settings" }, { name: "dashboard/subscriptions" }, { name: "dashboard/products" }, { name: "dashboard/tax" }, { name: "dashboard/terminal" }, { name: "dashbaord/terminal/hardware/orders" }, { name: "dashboard/terminal/locations" }, { name: "dashboard/topups" }, { name: "dashboard/transactions" }, { name: "dashboard/webhooks" }, { name: "docs" }]
      },
      options: [
        {
          name: "--list",
