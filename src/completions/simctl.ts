// simctl completion spec for CLIFlow
  ...
  subcommands: [
    ...
    },
    {
      ...
      args: [
        {
          name: "type",
          suggestions: [{ name: "devices" }, { name: "deviceTypes" }, { name: "runtimes" }, { name: "pairs" }]
        },
        {
          name: "search term",
          suggestions: [{ name: "available" }]
        }
      ],
      options: [
        {
    ...
    },
    {
      ...
      args: [
        ...
        },
        {
          ...
          suggestions: [{ name: "enable" }, { name: "disable" }]
        }
      ]
    },
    {
    ...
    },
    {
      ...
      args: [
        ...
        },
        {
          name: "action",
          description: "",
          suggestions: [{ name: "grant" }, { name: "revoke" }, { name: "reset" }]
        },
        {
          name: "service",
          description: "",
          suggestions: [{ name: "all" }, { name: "calendar" }, { name: "contacts-limited" }, { name: "contacts" }, { name: "location" }, { name: "location-always" }, { name: "photos-add" }, { name: "photos" }, { name: "media-library" }, { name: "microphone" }, { name: "motion" }, { name: "reminders" }, { name: "siri" }]
        },
        {
