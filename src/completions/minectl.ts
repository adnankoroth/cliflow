// minectl completion spec for CLIFlow
      ...
      options: [
        {
          ...
          args: {
            name: "provider",
            suggestions: [{ name: "civo" }, { name: "scaleway" }, { name: "do" }, { name: "hetzner" }, { name: "linode" }, { name: "ovh" }, { name: "equinix" }, { name: "gce" }, { name: "vultr" }, { name: "azure" }, { name: "oci" }, { name: "ionos" }, { name: "aws" }, { name: "vexxhost" }, { name: "multipass" }, { name: "exoscale" }]
          }
        },
        {
          name: ["--region", "-r"],
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "log-encoding",
        default: "console",
        suggestions: [{ name: "console" }, { name: "json" }]
      }
    },
    {
      name: "--verbose",
      ...
      args: {
        name: "verbose",
        suggestions: [{ name: "debug" }, { name: "info" }, { name: "warn" }, { name: "error" }, { name: "dpanic" }, { name: "panic" }, { name: "fatal" }]
      }
    },
