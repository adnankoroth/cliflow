// pytest completion spec for CLIFlow
  ...
  options: [
    {
      ...
      args: {
        name: "Mode",
        suggestions: [{ name: "plain" }, { name: "rewrite" }]
      }
    },
    {
      name: "--basetemp",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "fd" }, { name: "sys" }, { name: "no" }, { name: "tee-sys" }]
      }
    },
    {
      name: "--code-highlight",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "none" }, { name: "cdiff" }, { name: "ndiff" }, { name: "udiff" }, { name: "only_first_failure" }]
      }
    },
    {
      name: "--doctest-glob",
    ...
    },
    {
      ...
      args: {
        name: "Mode",
        default: "prepend",
        suggestions: [{ name: "prepend" }, { name: "append" }, { name: "importlib" }]
      }
    },
    {
      name: "--junit-xml",
...

    {
      ...
      args: {
        name: "Tests",
        suggestions: [{ name: "all" }, { name: "none" }],
        default: "all"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "Log CLI Level",
        suggestions: [{ name: "CRITICAL" }, { name: "ERROR" }, { name: "WARNING" }, { name: "INFO" }, { name: "DEBUG" }]
      }
    },
    {
      name: "--log-cli-format",
    ...
    },
    {
      ...
      args: {
        name: "mode",
        suggestions: [{ name: "failed" }, { name: "all" }]
      }
    },
    {
      name: "--pdb",
    ...
    },
    {
      ...
      args: {
        name: "chars",
        suggestions: [{ name: "a" }, { name: "A" }, { name: "E" }, { name: "f" }, { name: "N" }, { name: "p" }, { name: "P" }, { name: "s" }, { name: "w" }, { name: "x" }, { name: "X" }],
        default: "fE"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "Capture method",
        suggestions: [{ name: "no" }, { name: "stdout" }, { name: "stderr" }, { name: "log" }, { name: "all" }],
        default: "all"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "auto" }, { name: "long" }, { name: "short" }, { name: "line" }, { name: "native" }, { name: "no" }]
      }
    },
    {
      name: "--trace",
