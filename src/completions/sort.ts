// sort completion spec for CLIFlow
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "output",
        isOptional: true,
        suggestions: [{ name: "silent" }, { name: "quiet" }],
    ...
    },
    {
      ...
      args: {
        name: "type",
        suggestions: [{ name: "general-numeric" }, { name: "human-numeric" }, { name: "month" }, { name: "numeric" }, { name: "random" }]
      },
