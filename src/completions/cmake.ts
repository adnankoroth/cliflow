// cmake completion spec for CLIFlow
...
const completion= {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "format",
                suggestions: [{ name: "7zip" }, { name: "gnutar" }, { name: "pax" }, { name: "paxr" }, { name: "zip" }]
              }
            },
            {
              name: "--mtime",
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "log-level",
        suggestions: [{ name: "ERROR" }, { name: "WARNING" }, { name: "NOTICE" }, { name: "STATUS" }, { name: "VERBOSE" }, { name: "DEBUG" }, { name: "TRACE" }]
      }
    },
    {
      name: "--log-context",
    ...
    },
    {
      ...
      args: {
        name: "format",
        suggestions: [{ name: "human" }, { name: "json-v1" }]
      }
    },
    {
      name: "--trace-source",
    ...
    },
    {
      ...
      args: {
        name: "type",
        isOptional: true,
        suggestions: [{ name: "configure" }, { name: "build" }, { name: "test" }, { name: "all" }]
      }
    }
  ],
  args: {
