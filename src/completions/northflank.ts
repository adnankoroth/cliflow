// northflank completion spec for CLIFlow
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  ...
                  args: { name: "order", suggestions: [{ name: "backward" }, { name: "forward" }] }
                },
                {
                  name: "--textIncludes",
                ...
                },
                {
                  ...
                  args: {
                    name: "output",
                    isOptional: true,
                    suggestions: [{ name: "format" }, { name: "json" }, { name: "yaml" }]
                  }
                },
                {
                  name: ["-h", "--help"],
              ...
              options: [
                ...
                },
                {
                  ...
                  args: {
                    name: "metricTypes",
                    isVariadic: true,
                    suggestions: [{ name: "cpu" }, { name: "memory" }, { name: "networkIngress" }, { name: "networkEgress" }, { name: "tcpConnectionsOpen" }, { name: "diskUsage" }, { name: "requests" }, { name: "http4xxResponses" }, { name: "http5xxResponses" }]
                  }
                },
                {
                  name: "--timestamp",
