// od completion spec for CLIFlow
...
hexadecimal addresses or no address, respectively`,
      args: {
        name: "base",
        suggestions: [{ name: "d" }, { name: "o" }, { name: "x" }, { name: "n" }],
        default: "d"
      }
    },
    {
...
c, [d|o|u|x][C|S|I|L|n], or f[F|D|L|n]. See the man page for meanings`,
      args: {
        name: "type",
        suggestions: [{ name: "a" }, { name: "c" }, { name: "dC" }, { name: "dS" }, { name: "dI" }, { name: "dL" }, { name: "dn" }, { name: "oC" }, { name: "oS" }, { name: "oI" }, { name: "oL" }, { name: "on" }, { name: "uC" }, { name: "uS" }, { name: "uI" }, { name: "uL" }, { name: "un" }, { name: "xC" }, { name: "xS" }, { name: "xI" }, { name: "xL" }, { name: "xn" }, { name: "fF" }, { name: "fD" }, { name: "fL" }, { name: "fn" }]
      }
    },
    {
      name: "-v",
