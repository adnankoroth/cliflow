// shred completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "N",
        suggestions: [{ name: "3" }, { name: "5" }, { name: "7" }],
        default: "3"
      }
    },
    {
      ...
      args: {
        name: "FILE",
        suggestions: [{ name: "/dev/urandom" }, { name: "/dev/random" }],
        default: "/dev/urandom",
        template: "filepaths"
      }
    },
    {
      ...
      args: {
        name: "N",
        suggestions: [{ name: "1K" }, { name: "1M" }, { name: "1G" }]
      }
    },
    {
      name: "--remove",
      ...
      args: {
        ...
        suggestions: [{ name: "unlink" }, { name: "wipe" }, { name: "wipesync" }],
        default: "wipesync"
      }
    },
    {
