// blitz completion spec for CLIFlow
...
const prismaCommands = (prismaSpec).subcommands;
      ...
      args: [
        {
          ...
          suggestions: [{ name: "all" }, { name: "crud" }, { name: "model" }, { name: "pages" }, { name: "queries" }, { name: "query" }, { name: "mutations" }, { name: "mutation" }, { name: "resource" }].map((suggestion) => ({
            name: suggestion,
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "form",
            suggestions: [{ name: "react-final-form" }, { name: "react-hook-form" }, { name: "formik" }]
          }
        },
        {
          name: ["-d", "--dry-run"],
