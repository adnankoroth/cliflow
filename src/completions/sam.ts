// sam completion spec for CLIFlow
...
const containerHostOption= {
  name: "--container-host",
  description: "Host of locally emulated Lambda container",
  args: { name: "text" }
};

const containerHostInterfaceOption= {
...
const dockerVolumeBasedirOption= {
  ...
  subcommands: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: { name: "architecture", suggestions: [{ name: "arm64" }, { name: "x86_64" }] }
        },
        {
          name: ["-l", "--location"],
        ...
        },
        {
          ...
          args: {
            name: "runtime",
            suggestions: [{ name: "dotnet8" }, { name: "dotnet6" }, { name: "go1.x" }, { name: "java17" }, { name: "java11" }, { name: "java8.al2" }, { name: "nodejs20.x" }, { name: "nodejs18.x" }, { name: "nodejs16.x" }, { name: "provided.al2023" }, { name: "provided.al2" }, { name: "provided" }, { name: "python3.12" }, { name: "python3.11" }, { name: "python3.10" }, { name: "python3.9" }, { name: "python3.8" }, { name: "ruby3.2" }]
          }
        },
        {
          name: ["-p", "--package-type"],
          description: "Package type for your app",
          args: { name: "type", suggestions: [{ name: "zip" }, { name: "image" }] }
        },
        {
          name: ["-i", "--base-image"],
          ...
          args: {
            name: "image name",
            suggestions: [{ name: "amazon/dotnet8-base" }, { name: "amazon/dotnet6-base" }, { name: "amazon/go1.x-base" }, { name: "amazon/go-provided.al2-base" }, { name: "amazon/go-provided.al2023-base" }, { name: "amazon/java21-base" }, { name: "amazon/java17-base" }, { name: "amazon/java11-base" }, { name: "amazon/java8.al2-base" }, { name: "amazon/nodejs20.x-base" }, { name: "amazon/nodejs18.x-base" }, { name: "amazon/nodejs16.x-base" }, { name: "amazon/python3.12-base" }, { name: "amazon/python3.11-base" }, { name: "amazon/python3.10-base" }, { name: "amazon/python3.9-base" }, { name: "amazon/python3.8-base" }, { name: "amazon/ruby3.2-base" }]
          }
        },
        {
          ...
          args: {
            name: "manager",
            suggestions: [{ name: "npm" }, { name: "mod" }, { name: "gradle" }, { name: "cli-package" }, { name: "bundler" }, { name: "pip" }, { name: "maven" }]
          }
        },
        {
          name: ["-o", "--output-dir"],
