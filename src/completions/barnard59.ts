// barnard59 completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "level",
        suggestions: [{ name: "NONE" }, { name: "ERROR" }, { name: "WARN" }, { name: "INFO" }, { name: "DEBUG" }, { name: "VERBOSE" }, { name: "ALL" }],
        default: "ERROR"
      }
    },
    {
      ...
      args: {
        name: "exporter",
        suggestions: [{ name: "otlp" }, { name: "none" }],
        default: "none"
      }
    },
    {
