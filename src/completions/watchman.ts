// watchman completion spec for CLIFlow
  ...
  subcommands: [
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "debug" }, { name: "error" }, { name: "off" }]
      }
    },
    {
      name: "log-level",
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "level",
        description: "The log level",
        suggestions: [{ name: "0" }, { name: "1" }, { name: "2" }]
      }
    },
    {
      name: "--pidfile",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "json" }, { name: "bser" }]
      }
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "bser" }, { name: "json" }]
      }
    },
    {
      name: ["-f", "--foreground"],
