// splash completion spec for CLIFlow
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "scale",
        default: "auto",
        suggestions: [{ name: "auto" }, { name: "fill" }, { name: "fit" }, { name: "stretch" }, { name: "center" }]
      }
    },
    {
      name: "--screen",
      ...
      args: {
        name: "screen",
        default: "all",
        suggestions: [{ name: "all" }, { name: "main" }]
      }
    },
    {
      name: ["-s", "--save"],
    ...
    // Image Manipulation
    {
      ...
      args: {
        name: "degrees",
        suggestions: [{ name: "90" }, { name: "180" }, { name: "270" }]
      }
    },
    {
      name: "--colorspace",
      ...
      args: {
        name: "colorspace",
        default: "srgb",
        suggestions: [{ name: "srgb" }, { name: "rgb" }, { name: "cmyk" }, { name: "lab" }, { name: "b-w" }]
      }
    },
    {
      name: "--flip",
    ...
    },
    {
      ...
      args: {
        name: "orientation",
        default: "landscape",
        suggestions: [{ name: "landscape" }, { name: "portrait" }, { name: "squarish" }]
      }
    },
