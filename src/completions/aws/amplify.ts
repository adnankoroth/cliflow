// AMPLIFY service completions for AWS CLI
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { Subcommand } from '../../types.js';

export const amplifySubcommands: Subcommand[] = [
    {
      name: "create-app",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "RELEASE" }, { name: "RETRY" }, { name: "MANUAL" }, { name: "WEB_HOOK" }],
          },
        },
        {
          name: "--job-reason",
