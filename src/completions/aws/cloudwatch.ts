// CLOUDWATCH service completions for AWS CLI
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { Subcommand } from '../../types.js';

export const cloudwatchSubcommands: Subcommand[] = [
    {
      name: "delete-alarms",
      description:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "ConfigurationUpdate" }, { name: "StateUpdate" }, { name: "Action" }],
          },
        },
        {
          name: "--start-date",
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "TimestampDescending" }, { name: "TimestampAscending" }],
          },
        },
        {
          name: "--cli-input-json",
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "list",
            isVariadic: true,
            suggestions: [{ name: "UniqueContributors" }, { name: "MaxContributorValue" }, { name: "SampleCount" }, { name: "Sum" }, { name: "Minimum" }, { name: "Maximum" }, { name: "Average" }],
          },
        },
        {
          name: "--order-by",
          ...
          args: {
            name: "string",
            suggestions: [{ name: "SUM" }, { name: "MAXIMUM" }],
          },
        },
        {
          name: "--cli-input-json",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "ENABLES" }, { name: "DISABLED" }],
          },
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "GreaterThanOrEqualToThreshold" }, { name: "GreaterThanThreshold" }, { name: "LessThanThreshold" }, { name: "LessThanOrEqualToThreshold" }, { name: "LessThanLowerOrGreaterThanUpperThreshold" }, { name: "LessThanLowerThreshold" }, { name: "GreaterThanUpperThreshold" }],
          },
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "breaching" }, { name: "notBreaching" }, { name: "ignore" }, { name: "missing" }],
          },
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "evaluate" }, { name: "ignore" }],
          },
        },
        {
          name: "--metrics",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "opentelemetry0.7" }, { name: "json" }],
          },
        },
        {
          name: "--tags",
