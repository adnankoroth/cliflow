// ACM service completions for AWS CLI
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { Subcommand } from '../../types.js';

export const acmSubcommands: Subcommand[] = [
    {
      ...
      options: [
        {
          ...
          args: {
            name: "list",
            isVariadic: true,
            suggestions: [{ name: "PENDING_VALIDATION" }, { name: "ISSUED" }, { name: "INACTIVE" }, { name: "EXPIRED" }, { name: "VALIDATION_TIMED_OUT" }, { name: "REVOKED" }, { name: "FAILED" }],
          },
        },
        {
          name: "--includes",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "EMAIL" }, { name: "DNS" }],
          },
        },
        {
