// SERVICECATALOG service completions for AWS CLI
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { Subcommand } from '../../types.js';

export const servicecatalogSubcommands: Subcommand[] = [
    {
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "string",
                suggestions: [{ name: "CLOUD_FORMATION_TEMPLATE" }, { name: "MARKETPLACE" }],
              },
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "string",
                suggestions: [{ name: "CLOUD_FORMATION_TEMPLATE" }, { name: "MARKETPLACE_AMI" }, { name: "MARKETPLACE_CAR" }],
              },
            },
          ],
        },
