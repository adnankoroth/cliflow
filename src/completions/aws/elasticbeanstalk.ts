// ELASTICBEANSTALK service completions for AWS CLI
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { Subcommand } from '../../types.js';

export const elasticbeanstalkSubcommands: Subcommand[] = [
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "list",
            suggestions: [{ name: "Status" }, { name: "ApplicationMetrics" }, { name: "InstancesHealth" }],
          },
        },
        {
          name: "--cli-input-json",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "Scheduled" }, { name: "Pending" }, { name: "Running" }, { name: "Unknown" }],
          },
        },
        {
          name: "--cli-input-json",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "TRACE" }, { name: "DEBUG" }, { name: "INFO" }, { name: "WARN" }, { name: "ERROR" }, { name: "FATAL" }],
          },
        },
        {
          name: "--start-time",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "list",
            suggestions: [{ name: "LaunchedAt" }, { name: "System" }, { name: "Deployment" }, { name: "AvailabilityZone" }, { name: "InstanceType" }],
          },
        },
        {
          name: "--next-token",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "string",
            suggestions: [{ name: "tail" }, { name: "bundle" }],
          },
        },
        {
          name: "--cli-input-json",
