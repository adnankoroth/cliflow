// gradle completion spec for CLIFlow
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { CompletionSpec, Subcommand, Option, Suggestion } from '../types.js';

const consoleModeArg= {
  name: "mode",
  default: "auto",
  suggestions: [
    {
...
const sharedOptions= [
  ...
  },
  {
    ...
    args: {
      name: "priority",
      default: "normal",
      suggestions: [{ name: "normal" }, { name: "low" }]
    }
  },
  {
    name: "--profile",
  ...
  },
  {
    ...
    args: {
      name: "level",
      suggestions: [{ name: "quiet" }, { name: "warn" }, { name: "lifecycle" }, { name: "info" }, { name: "debug" }]
    }
  },
  {
    name: ["-q", "--quiet"],
      ...
      options: [
        {
          ...
          args: {
            name: "type",
            default: "basic",
            suggestions: [{ name: "basic" }, { name: "java-library" }, { name: "java-application" }]
          }
        }
              ]
    },
