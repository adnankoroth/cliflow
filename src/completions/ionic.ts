// ionic completion spec for CLIFlow
      ...
      options: [
        {
          ...
          args: {
            name: "engine",
            suggestions: [{ name: "browser" }, { name: "cordova" }]
          }
        },
        {
          name: "--platform",
          ...
          args: {
            name: "platform",
            suggestions: [{ name: "ios" }, { name: "android" }]
          }
        },
        {
          name: "--prod",
      ...
      options: [
        {
          ...
          args: {
            name: "browser",
            suggestions: [{ name: "safari" }, { name: "firefox" }, { name: "google chrome" }]
          }
        }
      ],
      ...
      options: [
        {
          ...
          args: {
            name: "type",
            suggestions: [{ name: "angular" }, { name: "react" }, { name: "vue" }, { name: "custom" }]
          }
        },
        {
          name: ["--force", "-f"],
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "type",
            suggestions: [{ name: "vue" }, { name: "angular" }, { name: "react" }, { name: "ionic-angular" }, { name: "ionic1" }]
          }
        },
        {
          name: "--cordova",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "name",
                suggestions: [{ name: "Android" }, { name: "iOS - Xcode 11 (Preferred)" }, { name: "iOS - Xcode 10" }]
              }
            },
            {
            ...
            },
            {
              ...
              args: {
                name: "name",
                suggestions: [{ name: "aab" }, { name: "apl" }, { name: "ipa" }, { name: "dysm" }]
              }
            },
            {
              name: "--skip-download",
          ...
          args: [
            ...
            },
            {
              ...
              suggestions: [{ name: "debug" }, { name: "release" }, { name: "development" }, { name: "ad-hoc" }, { name: "app-stpre" }, { name: "enterprise" }]
            }
          ],
          ...
          options: [
            {
              ...
              args: {
                name: "type",
                suggestions: [{ name: "ecdsa" }, { name: "ed25519" }, { name: "rsa" }],
                default: "rsa"
              }
            },
            {
      ...
      subcommands: [
        {
          ...
          args: {
            ...
            suggestions: [{ name: "capacitor" }, { name: "cordova" }, { name: "enterprise" }]
          },
          ...
          args: [
            {
              ...
              isOptional: true,
              suggestions: [{ name: "add" }, { name: "remove" }, { name: "update" }, { name: "ls" }, { name: "check" }, { name: "save" }]
            },
            {
              name: "platform",
              description:
          ...
          args: [
            {
              ...
              isOptional: true,
              suggestions: [{ name: "add" }, { name: "remove" }, { name: "ls" }, { name: "save" }]
            },
            {
              name: "plugin",
              description:
