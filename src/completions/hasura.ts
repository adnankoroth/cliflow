// hasura completion spec for CLIFlow
...
const sharedOptions= [
  ...
  },
  {
    ...
    args: {
      name: "string",
      suggestions: [{ name: "DEBUG" }, { name: "INFO" }, { name: "WARN" }, { name: "ERROR" }, { name: "FATAL" }],
      default: "INFO"
    }
  },
  {
...
const adminSecretOption= {
  name: "--admin-secret",
  description: "Admin secret for Hasura GraphQL engine",
  args: stringArg
};

const certificateAuthorityOption= {
  ...
  subcommands: [
    ...
    },
    {
      ...
      args: {
        name: "shell",
        isOptional: true,
        suggestions: [{ name: "bash" }, { name: "zsh" }]
      }
    },
    {
      name: "console",
