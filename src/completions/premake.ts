// premake completion spec for CLIFlow
...
const options= [
  ...
  },
  {
    ...
    args: {
      ...
      suggestions: [{ name: "aix" }, { name: "android" }, { name: "bsd" }, { name: "haiku" }, { name: "hurd" }, { name: "ios" }, { name: "linux" }, { name: "macosx" }, { name: "solaris" }, { name: "windows" }]
    }
  },
  {
    name: "--scripts",
  ...
  },
  {
    ...
    args: {
      ...
      suggestions: [{ name: "clang" }, { name: "gcc" }, { name: "mingw" }]
    }
  },
  {
    name: "--dc",
    ...
    args: {
      ...
      suggestions: [{ name: "dmd" }, { name: "gdc" }, { name: "ldc" }]
    }
  },
  {
    name: "--dotnet",
    ...
    args: {
      ...
      suggestions: [{ name: "mono" }, { name: "msnet" }, { name: "pnet" }]
    }
  }
];
