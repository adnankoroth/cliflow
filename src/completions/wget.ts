// wget completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    {
      name: "--random-wait",
      description: "Wait from 0.5*WAIT.5*WAIT secs between retrievals"
    },
...
//        --random-wait               wait from 0.5*WAIT.5*WAIT secs between retrievals
