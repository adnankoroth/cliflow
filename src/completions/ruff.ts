// ruff completion spec for CLIFlow
...
const checkOptions= [
  ...
  },
  {
    ...
    args: {
      name: "output_format",
      isOptional: true,
      suggestions: [{ name: "concise" }, { name: "full" }, { name: "json" }, { name: "json-lines" }, { name: "junit" }, { name: "grouped" }, { name: "github" }, { name: "gitlab" }, { name: "pylint" }, { name: "rdjson" }, { name: "azure" }, { name: "sarif" }]
    }
  },
  {
    name: ["-o", "--output-file"],
  ...
  },
  {
    ...
    args: {
      name: "target_version",
      isOptional: true,
      suggestions: [{ name: "py37" }, { name: "py38" }, { name: "py39" }, { name: "py310" }, { name: "py311" }, { name: "py312" }, { name: "py313" }]
    }
  },
  {
    name: "--preview",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        args: {
          name: "output-format",
          suggestions: [{ name: "text" }, { name: "json" }]
        }
      }
    ]
  },
    ...
    options: [
      {
        ...
        args: { name: "output-format", suggestions: [{ name: "text" }, { name: "json" }] }
      }
    ]
  },
  {
        ...
        options: [
          {
            ...
            args: {
              name: "DIRECTION",
              suggestions: [{ name: "dependencies" }, { name: "dependents" }]
            }
          },
          {
...
const completion= {
  ...
  options: GlobalOptions.map((option) => ({  isPersistent: true }))
};
