// ansible-lint completion spec for CLIFlow
// Auto-converted from Fig.io spec: https://github.com/withfig/autocomplete
// License: MIT

import { CompletionSpec, Subcommand, Option, Suggestion } from '../types.js';

const shortFormatArg= {
  name: "-f",
  suggestions: [{ name: "rich" }, { name: "plain" }, { name: "md" }],
  default: "rich"
};

const fullFormatArg= {
  name: "-f",
  suggestions: [{ name: "rich" }, { name: "plain" }, { name: "md" }, { name: "json" }, { name: "codeclimate" }, { name: "quiet" }, { name: "pep8" }, { name: "sarif" }],
  default: "rich"
};
