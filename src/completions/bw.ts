// bw completion spec for CLIFlow
...
const completionSpec= {
  ...
  subcommands: [
    ...
    },
    {
      ...
      args: {
        name: "object",
        suggestions: [{ name: "items" }, { name: "folders" }, { name: "collections" }, { name: "org-collections" }, { name: "org-members" }, { name: "organizations" }]
      }
    },
    {
      name: "get",
      ...
      subcommands: [
        {
          ...
          args: {
            name: "object",
            suggestions: [{ name: "item" }, { name: "item.field" }, { name: "item.login" }, { name: "item.login.uri" }, { name: "item.card" }, { name: "item.identity" }, { name: "item.securenote" }, { name: "folder" }, { name: "collection" }, { name: "item-collections" }, { name: "org-collection" }, { name: "send.text" }, { name: "send.file" }]
          }
        },
        {
          name: "attachment",
      ...
      args: [
        {
          name: "object",
          suggestions: [{ name: "item" }, { name: "username" }, { name: "password" }, { name: "uri" }, { name: "totp" }, { name: "exposed" }, { name: "folder" }, { name: "collection" }],
      ...
      args: [
        {
          ...
          suggestions: [{ name: "item" }, { name: "attachment" }, { name: "folder" }, { name: "org-collection" }]
        },
        {
          name: "encodedJson",
      ...
      args: [
        {
          ...
          suggestions: [{ name: "item" }, { name: "item-collections" }, { name: "folder" }, { name: "org-collection" }]
        },
        {
          name: "id",
    ...
    },
    {
      ...
      args: [
        {
          name: "format",
          suggestions: [{ name: "1password1pif" }, { name: "1password1pux" }, { name: "1passwordmaccsv" }, { name: "1passwordwincsv" }, { name: "ascendocsv" }, { name: "avastcsv" }, { name: "avastjson" }, { name: "aviracsv" }, { name: "bitwardencsv" }, { name: "bitwardenjson" }, { name: "blackberrycsv" }, { name: "blurcsv" }, { name: "buttercupcsv" }, { name: "chromecsv" }, { name: "clipperzhtml" }, { name: "codebookcsv" }, { name: "dashlanecsv" }, { name: "dashlanejson" }, { name: "encryptrcsv" }, { name: "enpasscsv" }, { name: "enpassjson" }, { name: "firefoxcsv" }, { name: "fsecurefsk" }, { name: "gnomejson" }, { name: "kasperskytxt" }, { name: "keepass2xml" }, { name: "keepassxcsv" }, { name: "keepercsv" }, { name: "lastpasscsv" }, { name: "logmeoncecsv" }, { name: "meldiumcsv" }, { name: "msecurecsv" }, { name: "mykicsv" }, { name: "nordpasscsv" }, { name: "operacsv" }, { name: "padlockcsv" }, { name: "passboltcsv" }, { name: "passkeepcsv" }, { name: "passmanjson" }, { name: "passpackcsv" }, { name: "passwordagentcsv" }, { name: "passwordbossjson" }, { name: "passworddragonxml" }, { name: "passwordwallettxt" }, { name: "pwsafexml" }, { name: "remembearcsv" }, { name: "roboformcsv" }, { name: "safaricsv" }, { name: "safeincloudxml" }, { name: "saferpasscsv" }, { name: "securesafecsv" }, { name: "splashidcsv" }, { name: "stickypasswordxml" }, { name: "truekeycsv" }, { name: "upmcsv" }, { name: "vivaldicsv" }, { name: "yoticsv" }, { name: "zohovaultcsv" }],
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "format",
            suggestions: [{ name: "csv" }, { name: "json" }, { name: "encrypted_json" }],
      ...
      subcommands: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "send.text" }, { name: "send.file" }]
          }
        },
        {
          name: "get",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "login" }, { name: "logout" }, { name: "lock" }, { name: "unlock" }, { name: "sync" }, { name: "generate" }, { name: "encode" }, { name: "config" }, { name: "update" }, { name: "completion" }, { name: "status" }, { name: "serve" }, { name: "list" }, { name: "get" }, { name: "create" }, { name: "edit" }, { name: "delete" }, { name: "restore" }, { name: "move" }, { name: "confirm" }, { name: "import" }, { name: "export" }, { name: "share" }, { name: "send" }, { name: "receive" }, { name: "device-approval" }],
        isOptional: true
      }
    }
  ],
