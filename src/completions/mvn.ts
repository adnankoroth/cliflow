// mvn completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "color mode",
        suggestions: [{ name: "always" }, { name: "never" }, { name: "auto" }]
      }
    },
    {
  ...
  args: {
    ...
    isVariadic: true,
    suggestions: [{ name: "clean" }, { name: "post-clean" }, { name: "initialize" }, { name: "generate-sources" }, { name: "process-sources" }, { name: "generate-resources" }, { name: "process-resources" }, { name: "compile" }, { name: "process-classes" }, { name: "generate-test-sources" }, { name: "process-test-sources" }, { name: "generate-test-resources" }, { name: "process-test-resources" }, { name: "test-compile" }, { name: "process-test-classes" }, { name: "test" }, { name: "prepare-package" }, { name: "package" }, { name: "pre-integration-test" }, { name: "integration-test" }, { name: "post-integration-test" }, { name: "verify" }, { name: "install" }, { name: "deploy" }, { name: "site" }, { name: "post-site" }, { name: "site-deploy" }]
  }
};
