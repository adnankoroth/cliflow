// sqlfluff completion spec for CLIFlow
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "raw" }, { name: "jinja" }, { name: "python" }, { name: "placeholders" }]
          }
        },
        {
          name: ["--dialect", "-d"],
          ...
          args: {
            ...
            suggestions: [{ name: "ansi" }, { name: "bigquery" }, { name: "exasol" }, { name: "hive" }, { name: "mysql" }, { name: "oracle" }, { name: "postgres" }, { name: "redshift" }, { name: "snowflake" }, { name: "spark3" }, { name: "sqllite" }, { name: "teradata" }, { name: "tsql" }]
          }
        },
        {
          name: ["--format", "-f"],
          ...
          args: {
            name: "format",
            suggestions: [{ name: "human" }, { name: "json" }, { name: "yaml" }, { name: "github-annotation" }, { name: "github-annotation-native" }]
          }
        },
        {
          name: ["--processes", "-p"],
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "templater" }, { name: "lexer" }, { name: "parser" }, { name: "linter" }, { name: "rules" }]
          }
        },
        {
          name: "--encoding",
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "notice" }, { name: "warning" }, { name: "failure" }, { name: "error" }]
          }
        },
        {
