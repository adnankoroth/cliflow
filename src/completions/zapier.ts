// zapier completion spec for CLIFlow
...
const formatFlag= {
  ...
  args: {
    name: "format",
    suggestions: [{ name: "plain" }, { name: "json" }, { name: "raw" }, { name: "row" }, { name: "table" }]
  }
};
const debugFlag= {
  name: ["-d", "--debug"],
  ...
  subcommands: [
      ...
      options: [
        {
          ...
          args: {
            name: "mode",
            suggestions: [{ name: "enabled" }, { name: "anonymous" }, { name: "disabled" }]
          }
        },
        debugFlag
      ]
      ...
      options: [
        {
          ...
          args: {
            name: "template",
            suggestions: [{ name: "basic-auth" }, { name: "callback" }, { name: "custom-auth" }, { name: "digest-auth" }, { name: "dynamic-dropdown" }, { name: "files" }, { name: "minimal" }, { name: "oauth1-trello" }, { name: "oauth2" }, { name: "search-or-create" }, { name: "session-auth" }, { name: "typescript" }]
          }
        },
        debugFlag
      ],
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "status",
            suggestions: [{ name: "any" }, { name: "success" }, { name: "error" }]
          }
        },
        {
          name: ["-t", "--type"],
          ...
          args: {
            name: "type",
            suggestions: [{ name: "console" }, { name: "bundle" }, { name: "http" }]
          }
        },
        {
          name: "--detailed",
    ...
    },
    {
      ...
      args: [
        {
          name: "actionType",
          suggestions: [{ name: "trigger" }, { name: "search" }, { name: "create" }, { name: "resource" }]
        },
        {
          name: "noun"
        }
    ...
    },
    {
      ...
      args: [
        ...
        },
        {
          ...
          suggestions: [{ name: "admin" }, { name: "subscriber" }]
        },
        {
          name: "message",
          description:
