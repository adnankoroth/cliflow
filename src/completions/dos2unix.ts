// dos2unix completion spec for CLIFlow
...
const completionSpec= {
  ...
  description: "DOS to Unix file format converter",
    ...
    },
    {
      ...
      args: {
        name: "CONVMODE",
        suggestions: [{ name: "ascii" }, { name: "7bit" }, { name: "iso" }, { name: "mac" }]
      }
    },
    {
      name: ["-D", "--display-enc"],
      ...
      args: {
        name: "ENCODING",
        suggestions: [{ name: "ansi" }, { name: "unicode" }, { name: "unicodebom" }, { name: "utf8" }, { name: "utf8bom" }]
      }
    },
    {
      name: ["-f", "--force"],
