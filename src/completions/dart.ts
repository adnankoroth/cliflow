      ...
      subcommands: [
        ...
        },
        {
          ...
          options: [
              ...
              args: {
                name: "style",
                suggestions: [{ name: "compact" }, { name: "tree" }, { name: "list" }]
              }
            },
            {
              name: "--dev",
        ...
        },
        {
          ...
          options: [ offline, noOffline, dryRun]
        },
        {
          name: "get",
          ...
          subcommands: [
            {
              ...
              options: [
                  ...
                  args: {
                    name: "source",
                    suggestions: [{ name: "git" }, { name: "hosted" }, { name: "path" }]
                  }
                },
                {
                  name: "--no-executables",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "property",
                suggestions: [{ name: "outdated" }, { name: "null-safety" }]
              }
            },
            {
              name: "--prereleases",
