// railway completion spec for CLIFlow
  ...
  subcommands: [
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "bash" }, { name: "zsh" }, { name: "fish" }, { name: "powershell" }]
      }
    },
    {
      name: "connect",
      ...
      args: {
        ...
        isOptional: true,
        suggestions: [{ name: "postgresql" }, { name: "mysql" }, { name: "redis" }, { name: "mongodb" }]
      }
    },
    {
      name: "delete",
    ...
    },
    {
      ...
      args: {
        ...
        isOptional: true,
        suggestions: [{ name: "production" }, { name: "preview" }]
      }
    },
    {
      name: "help",
