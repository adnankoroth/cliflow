// http completion spec for CLIFlow
  ...
  args: [
    {
      name: "METHOD",
      isOptional: true,
      suggestions: [{ name: "GET" }, { name: "POST" }, { name: "PUT" }, { name: "DELETE" }, { name: "HEAD" }],
      default: "GET",
      description:
...
multipart/form-data request`
    ...
    },
    {
      name: "--pretty",
      args: {
        suggestions: [{ name: "all" }, { name: "colors" }, { name: "format" }, { name: "none" }]
      },
...
and formatting (default for terminal output), "colors", or "format"`
    },
    {
      ...
      args: {
        name: "STYLE",
        suggestions: [{ name: "abap" }, { name: "algol" }, { name: "algol_nu" }, { name: "arduino" }, { name: "auto" }, { name: "autumn" }, { name: "borland" }, { name: "bw" }, { name: "colorful" }, { name: "default" }, { name: "emacs" }, { name: "friendly" }, { name: "fruity" }, { name: "igor" }, { name: "inkpot" }, { name: "lovelace" }, { name: "manni" }, { name: "monokai" }, { name: "murphy" }, { name: "native" }, { name: "paraiso-dark" }, { name: "paraiso-light" }, { name: "pastie" }, { name: "perldoc" }, { name: "rainbow_dash" }, { name: "rrt" }, { name: "sas" }, { name: "solarized" }, { name: "solarized-dark" }, { name: "solarized-light" }, { name: "stata" }, { name: "stata-dark" }, { name: "stata-light" }, { name: "tango" }, { name: "trac" }, { name: "vim" }, { name: "vs" }, { name: "xcode" }],
        default: "auto"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "FORMAT_OPTIONS",
        suggestions: [{ name: "headers.sort:true" }, { name: "json.format:true" }, { name: "json.indent:4" }, { name: "json.sort_keys:true" }]
      },
      isRepeatable: true,
...
for private certs`
    },
    {
      name: "--ssl",
      args: {
        suggestions: [{ name: "ssl2.3" }, { name: "tls1" }, { name: "tls1.1" }, { name: "tls1.2" }]
      },
