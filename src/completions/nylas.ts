// nylas completion spec for CLIFlow
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: [{ name: "account.connected" }, { name: "account.running" }, { name: "account.stopped" }, { name: "account.invalid" }, { name: "account.sync_error" }, { name: "message.created" }, { name: "message.opened" }, { name: "message.updated" }, { name: "message.link_clicked" }, { name: "message.bounced" }, { name: "thread.replied" }, { name: "calendar.created" }, { name: "calendar.updated" }, { name: "calendar.deleted" }, { name: "event.created" }, { name: "event.updated" }, { name: "event.deleted" }, { name: "contact.created" }, { name: "contact.updated" }, { name: "contact.updated" }, { name: "contact.deleted" }, { name: "job.successful" }, { name: "job.failed" }]
              }
            },
            {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "output",
        default: "json",
        suggestions: [{ name: "json" }, { name: "table" }]
      }
    },
    {
      name: "--region",
      ...
      args: {
        name: "region",
        suggestions: [{ name: "us" }, { name: "ireland" }, { name: "canada" }, { name: "australia" }]
      }
    },
    {
      name: "--silent",
