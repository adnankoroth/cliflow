// oh-my-posh completion spec for CLIFlow
...
const format= {
  ...
  args: {
    ...
    suggestions: [{ name: "json" }, { name: "yaml" }, { name: "toml" }]
  }
};
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            ...
            suggestions: [{ name: "zsh" }, { name: "fish" }, { name: "pwsh" }, { name: "powershell" }, { name: "cmd" }, { name: "bash" }, { name: "shell" }]
          }
        },
        {
          name: "--stack-count",
