// ping completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "trafficclass",
        suggestions: [{ name: "BK_SYS" }, { name: "BK" }, { name: "BE" }, { name: "RD" }, { name: "OAM" }, { name: "AV" }, { name: "RV" }, { name: "VI" }, { name: "VO" }, { name: "CTL" }],
        default: "CTL"
      }
    },
    {
      ...
      args: {
        name: "netservicetype",
        suggestions: [{ name: "BK_SYS" }, { name: "BK" }, { name: "BE" }, { name: "RV" }, { name: "AV" }, { name: "RD" }, { name: "OAM" }, { name: "VI" }, { name: "SIG" }, { name: "VO" }]
      }
    },
    {
      name: "-L",
