// prisma completion spec for CLIFlow
      ...
      options: [
        commonOptions,
        {
          ...
          args: {
            ...
            suggestions: [{ name: "PostgreSQL" }, { name: "MySQL" }, { name: "SQLite" }, { name: "SQLServer" }, { name: "MongoDB" }, { name: "CockroachDB" }],
            default: "PostgreSQL"
          }
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "Browser choice",
            suggestions: [{ name: "firefox" }, { name: "chrome" }, { name: "safari" }, { name: "none" }]
          }
        },
        {
          name: ["-n", "--hostname"],
