// lsd completion spec for CLIFlow
...
const completionSpec= {
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "blocks",
        suggestions: [{ name: "permission" }, { name: "user" }, { name: "group" }, { name: "size" }, { name: "date" }, { name: "name" }, { name: "inode" }, { name: "links" }]
      }
    },
    {
      name: "--color",
      ...
      args: {
        name: "color",
        suggestions: [{ name: "always" }, { name: "auto" }, { name: "never" }],
        default: "auto"
      }
    },
    {
      ...
      args: {
        name: "date",
        suggestions: [{ name: "date" }, { name: "relative" }, { name: "+date-time-format" }],
        default: "date"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "group-dirs",
        suggestions: [{ name: "none" }, { name: "first" }, { name: "last" }]
      }
    },
    {
      name: "--icon",
    ...
    },
    {
      ...
      args: {
        name: "icon-theme",
        suggestions: [{ name: "fancy" }, { name: "unicode" }],
        default: "fancy"
      }
    },
    {
    ...
    },
    {
      ...
      args: {
        name: "size",
        suggestions: [{ name: "default" }, { name: "short" }, { name: "bytes" }],
        default: "default"
      }
    },
    {
      ...
      args: {
        name: "WORD",
        suggestions: [{ name: "size" }, { name: "time" }, { name: "version" }, { name: "extension" }]
      }
    }
  ]
};
