// sanity completion spec for CLIFlow
    ...
    },
    {
      ...
      subcommands: [
          ...
          options: [
            {
              ...
              args: { name: "visibility", suggestions: [{ name: "public" }, { name: "private" }] }
            }
          ],
          args: { name: "name" }
        },
        ...
        },
        {
          ...
          args: [
            { name: "dataset" },
            { name: "mode", suggestions: [{ name: "get" }, { name: "set" }] }
          ]
        }
      ]
    },
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "order", suggestions: [{ name: "asc" }, { name: "desc" }] }
            }
          ]
        }
      ]
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "field",
                suggestions: [{ name: "id" }, { name: "name" }, { name: "role" }, { name: "date" }]
              }
            },
            {
              name: "--order",
