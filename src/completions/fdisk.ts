// fdisk completion spec for CLIFlow
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "512" }, { name: "1024" }, { name: "2048" }, { name: "4096" }]
      }
    },
    {
      name: ["--protect-boot", "-B"],
    ...
    },
    {
      ...
      args: {
        name: "mode",
        isOptional: true,
        suggestions: [{ name: "dos" }, { name: "nondos" }]
      }
    },
    {
      name: ["--color", "-L"],
    ...
    },
    {
      ...
      args: {
        ...
        isOptional: true,
        suggestions: [{ name: "yes" }, { name: "no" }, { name: "nonblock" }]
      }
    },
    {
      name: ["--noauto-pt", "-n"],
    ...
    },
    {
      ...
      args: {
        name: "unit",
        isOptional: true,
        suggestions: [{ name: "sectors" }, { name: "cylinders" }]
      }
    },
    {
      name: ["--cylinders", "-C"],
