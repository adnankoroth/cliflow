// pro completion spec for CLIFlow
...
const completionSpec= {
  ...
  subcommands: [
    ...
    },
    {
      ...
      args: {
        name: "service",
        suggestions: [{ name: "cc-eal" }, { name: "cis" }, { name: "esm" }, { name: "fips" }, { name: "fips-updates" }, { name: "livepatch" }, { name: "ros" }, { name: "ros-updates" }]
      }
    },
    {
      name: "enable",
      ...
      options: [
        {
          ...
          requiresSeparator: true,
          args: {
            suggestions: [{ name: "tabular" }, { name: "json" }, { name: "yaml" }]
          }
        },
        {
