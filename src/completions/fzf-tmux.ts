// fzf-tmux completion spec for CLIFlow
  ...
  options: [
    ...
    },
    {
      ...
      args: {
        name: "criteria",
        default: "length",
        suggestions: [{ name: "length" }, { name: "begin" }, { name: "end" }, { name: "index" }]
      }
    },
    {
      name: ["-m", "--multi"],
    ...
    },
    {
      ...
      args: {
        name: "layout",
        default: "default",
        suggestions: [{ name: "default" }, { name: "reverse" }, { name: "reverse-list" }]
      }
    },
    {
      name: "--border",
      ...
      args: {
        ...
        isOptional: true,
        default: "rounded",
        suggestions: [{ name: "rounded" }, { name: "sharp" }, { name: "horizontal" }, { name: "vertical" }, { name: "top" }, { name: "bottom" }, { name: "left" }, { name: "right" }, { name: "none" }]
      }
    },
    {
      name: "--margin",
    ...
    },
    {
      ...
      args: {
        name: "style",
        default: "default",
        suggestions: [{ name: "default" }, { name: "inline" }, { name: "hidden" }]
      }
    },
    {
      name: "--prompt",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "dark" }, { name: "light" }, { name: "16" }, { name: "bw" }]
      }
    },
    {
      name: "--no-bold",
    ...
    },
    {
      ...
      args: {
        ...
        suggestions: [{ name: "up" }, { name: "down" }, { name: "left" }, { name: "right" }, { name: "nowrap" }, { name: "wrap" }, { name: "nocycle" }, { name: "cycle" }, { name: "nofollow" }, { name: "follow" }, { name: "nohidden" }, { name: "hidden" }, { name: "default" }]
      }
    },
    {
      name: ["-q", "--query"],
